...
* Optimize Set.intersect performance symmetry and preserve identity from the first set argument. ([Issue #19139](https://github.com/dotnet/fsharp/issues/19139), [PR #19292](https://github.com/dotnet/fsharp/pull/19292))
...
* Query and quotation fixes change structural equality for tuple keys, expression-tree shapes, and preservation of `IQueryable` providers. See the [compatibility notes](https://fsharp.github.io/fsharp-compiler-docs/release-notes/PENDING_BREAKING_CHANGES.html). ([PR #19243](https://github.com/dotnet/fsharp/pull/19243))
