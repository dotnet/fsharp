...
* The VS project options reactor keeps single-file and script project options in a named record instead of a five-place tuple. ([PR #20455](https://github.com/dotnet/fsharp/pull/20455))
