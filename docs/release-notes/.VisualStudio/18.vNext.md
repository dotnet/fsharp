...
* Find All References classifies the line of each F# reference while it searches, as it does for C# and Visual Basic, instead of asking the F# classification service for every line again after the search.
