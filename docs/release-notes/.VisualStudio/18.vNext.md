...
* Go To All (Ctrl+T) searches the documents Visual Studio marks as priority — the ones the user has open — before the rest of a project, so a search the next keystroke cancels has covered them first. ([PR #20615](https://github.com/dotnet/fsharp/pull/20615))
