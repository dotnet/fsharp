...
* Peek Definition from C# or Visual Basic on an F# symbol shows the F# declaration in place; it used to show the symbol decompiled into C#, while Go To Definition on the same symbol opened the F# file.
