...
* The `AddOpen` code fix no longer suggests the non-generic namespace for a generic type used with type arguments (e.g. `IEnumerator<'t>` now suggests `open System.Collections.Generic` instead of `open System.Collections`). ([Issue #16155](https://github.com/dotnet/fsharp/issues/16155), [PR #20631](https://github.com/dotnet/fsharp/pull/20631))
