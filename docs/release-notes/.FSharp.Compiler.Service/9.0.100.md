...
* Don't rebind the compiler-generated loop variable for `_` in `[|for _ in xs -> …|]` when `xs` is an array. ([Issue #17708](https://github.com/dotnet/fsharp/issues/17708), [PR #17711](https://github.com/dotnet/fsharp/pull/17711))
