...
* Optimize simple mappings in comprehensions when the body of the mapping has `let`-bindings and a single implicit yield. ([PR #17419](https://github.com/dotnet/fsharp/pull/17419))
