...
* Fixes `AttributeTargets` analysis for recursive types. ([Issue #17731](https://github.com/dotnet/fsharp/issues/17731), [PR #17735](https://github.com/dotnet/fsharp/pull/17735))
