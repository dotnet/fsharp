...
* Better ranges for #nowarn error reporting; bring back warnings for --langVerison:80; add warnings under feature flag ([PR #17871(https://github.com/dotnet/fsharp/pull/17871)])
