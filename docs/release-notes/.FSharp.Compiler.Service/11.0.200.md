...
* Transparent compiler: a cached computation that was canceled and restarted no longer takes the result of the canceled run while the new run is still going. ([PR #XXXXX](https://github.com/dotnet/fsharp/pull/XXXXX))
