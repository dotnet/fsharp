...
* Transparent compiler: fix spurious "This expression was expected to have type 'T' but here has type 'T'" errors after the cached result of an earlier file was garbage collected and recomputed while results of later files stayed cached. ([PR #20643](https://github.com/dotnet/fsharp/pull/20643))
