...
* Transparent compiler: a cached computation that was canceled and restarted no longer takes the result of the canceled run while the new run is still going. ([PR #20644](https://github.com/dotnet/fsharp/pull/20644))
