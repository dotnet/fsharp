...
* Harden `<include>` XML documentation external file loading by rejecting DTDs, reusing compiler file-system shims, and preserving whitespace. ([PR #19186](https://github.com/dotnet/fsharp/pull/19186))
* Fix `<include>` XML documentation path comparison to respect case-sensitive filesystems during caching and cycle detection. ([PR #19186](https://github.com/dotnet/fsharp/pull/19186))
