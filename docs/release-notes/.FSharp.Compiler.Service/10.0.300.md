...
* Overload resolution results are now cached, providing significant performance improvements for code with repeated method calls. ([Issue #18807](https://github.com/dotnet/fsharp/issues/18807))
