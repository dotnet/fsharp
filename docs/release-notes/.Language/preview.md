...
* Remove the always-on `OpenTypeDeclaration` language feature flag, since open type declarations have been available since F# 5.0. ([Issue #20148](https://github.com/dotnet/fsharp/issues/20148), [PR #20209](https://github.com/dotnet/fsharp/pull/20209))
