...
REM F# 15.9 revival: skip buildfromsource.cmd in CI -- it tries to dotnet pack
REM FSharp.Compiler.nuget.fsproj which doesn't have pack target wired up cleanly
REM in this snapshot. Per Constraint 4 (no nupkg production for 15.9 servicing),
REM the netstandard FSharp.Compiler nupkg is not part of the VS insertion payload.
