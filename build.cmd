...
if "%BUILD_PROTO%" == "1" (
    ...
    echo %_msbuildexe% proto.proj /t:Build /bl:%~dp0Proto\proto.proj.build.binlog %msbuildflags% %BUILD_DIAG%
         %_msbuildexe% proto.proj /t:Build /bl:%~dp0Proto\proto.proj.build.binlog %msbuildflags% %BUILD_DIAG%
