...
function Make-BootstrapBuild() {
    ...
    Copy-Item "$ArtifactsDir\bin\fslex\$bootstrapConfiguration\$bootstrapTfm" -Destination "$dir\fslex" -Force -Recurse
    Copy-Item "$ArtifactsDir\bin\fsyacc\$bootstrapConfiguration\$bootstrapTfm" -Destination "$dir\fsyacc" -Force  -Recurse
    Copy-Item "$ArtifactsDir\bin\AssemblyCheck\$bootstrapConfiguration\$bootstrapTfm" -Destination "$dir\AssemblyCheck" -Force  -Recurse
