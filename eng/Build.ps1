...
try {
    ...
    if ($testCoreClr) {
        ...
        TestUsingXUnit -testProject "$RepoRoot\tests\FSharp.Compiler.CheckerTests\FSharp.Compiler.CheckerTests.fsproj" -testadapterpath "$ArtifactsDir\bin\FSharp.Compiler.CheckerTests\"
    }
