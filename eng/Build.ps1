...
try {
    ...
    if ($testDesktop -and -not $noVisualStudio) {
        ...
        TestUsingNUnit -testProject "$RepoRoot\tests\FSharp.DependencyManager.Testing\FSharp.DependencyManager.Testing.fsproj" -targetFramework $desktopTargetFramework
