...
The [F# Docs](https://fsharp.github.io/fsharp-compiler-docs/) is essential reading for any larger contributions to the F# compiler codebase. This also hosts the public docs for FSharp.Compiler.Service and all docs content under [docs/](docs/).

The [F# Compiler Guide](https://fsharp.github.io/fsharp-compiler-docs/) is essential reading for any larger contributions to the F# compiler codebase. This also hosts the public docs for FSharp.Compiler.Service and all docs content under [docs/](docs/).
