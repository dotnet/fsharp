...
type internal FSharpImplementInterfaceCodeFixProvider
    ...
    override _.RegisterCodeFixesAsync context : Task =
        asyncMaybe {
            ...
            let! _, fsProject = context.Document.GetFSharpProjectAsync(nameof(FSharpImplementInterfaceCodeFixProvider)) |> liftAsync
            let defines = CompilerEnvironment.GetCompilationDefinesForEditing fsProject.ParsingOptions
