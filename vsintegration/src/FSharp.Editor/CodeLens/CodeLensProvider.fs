...
type internal CodeLensProvider  
    ...
    let addCodeLensProviderOnce wpfView buffer =
        ...
        | None ->
            ...
            let service = FSharpCodeLensService(serviceProvider, workspace, documentId, buffer, checkerProvider, componentModel.GetService(), typeMap, tagger, settings)
    ...
    let addLineLensProviderOnce wpfView buffer =
        ...
        | None ->
            ...
            let service = FSharpCodeLensService(serviceProvider, workspace, documentId, buffer, checkerProvider, componentModel.GetService(), typeMap, LineLensDisplayService(wpfView, buffer), settings)
