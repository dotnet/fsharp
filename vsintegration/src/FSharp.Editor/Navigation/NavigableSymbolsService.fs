...
type internal FSharpNavigableSymbolSource(checkerProvider: FSharpCheckerProvider, serviceProvider: IServiceProvider) =
...
type internal FSharpNavigableSymbolService
    ...
    interface INavigableSymbolSourceProvider with
        member _.TryCreateNavigableSymbolSource(_: ITextView, _: ITextBuffer) =
            new FSharpNavigableSymbolSource(checkerProvider, serviceProvider) :> INavigableSymbolSource