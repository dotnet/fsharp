...
type internal FSharpAddExplicitTypeToParameterRefactoring
    ...
    override _.ComputeRefactoringsAsync context =
        asyncMaybe {
            ...
            let! lexerSymbol = document.TryFindFSharpLexerSymbolAsync(position, SymbolLookupKind.Greedy, false, false, nameof(FSharpAddExplicitTypeToParameterRefactoring)) |> Async.AwaitTask

            let! parseFileResults, checkFileResults = document.GetFSharpParseAndCheckResultsAsync(nameof(FSharpAddExplicitTypeToParameterRefactoring)) |> Async.AwaitTask |> liftAsync
