...
//          let getItems s = 
//              let fs  = project.GetItems(s)
//              [ for f in fs -> mkAbsolute directory f.EvaluatedInclude ]

//          let projectReferences =
//              [  for i in project.GetItems("ProjectReference") do
//                     yield mkAbsolute directory i.EvaluatedInclude
//              ]
...
//        //                 @"..\..\..\..\..\packages\FSharp.Compiler.Service.ProjectCracker.9.0.1\utilities\net45\FSharp.Compiler.Service.ProjectCrackerTool.exe")
        
//        //if not (File.Exists crackerFilename) then failwithf "ProjectCracker exe not found at: %s." crackerFilename
//        //let p = new Process()
...
//        //printfn "Got JSON: %A" json

//        //let ser = new DataContractJsonSerializer(typeof<ProjectOptions>)
//        //let json = ser.ReadObject(p.StandardOutput.BaseStream)
//        //let opts = json :?> ProjectOptions
//        let opts = ProjectCrackerTool.getOptions projectFileName true properties
//#endif
