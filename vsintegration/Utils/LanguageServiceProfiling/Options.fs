...
let FCS (repositoryDir: string) : Options =
    let files =
          [| @"src\fsharp\FSharp.Compiler.Service\obj\Release\FSComp.fs"
             ...
             @"src\fsharp\FSharp.Compiler.Private\ErrorText\sformat.fsi"
             @"src\fsharp\FSharp.Compiler.Private\ErrorText\sformat.fs"
             @"src\fsharp\FSharp.Compiler.Private\ErrorText\sr.fsi"
             @"src\fsharp\FSharp.Compiler.Private\ErrorText\sr.fs"
