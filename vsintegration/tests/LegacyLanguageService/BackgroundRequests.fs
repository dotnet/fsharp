                        ...
                        if containsFreshFullTypeCheck then 
                            for error in typedResults.Errors do
                                ...
                                let sev = 
                                    ...
                                    | FSharpErrorSeverity.Warning -> Microsoft.VisualStudio.LegacyLanguageService.Severity.Warning
                                    | FSharpErrorSeverity.Error -> Microsoft.VisualStudio.LegacyLanguageService.Severity.Error
