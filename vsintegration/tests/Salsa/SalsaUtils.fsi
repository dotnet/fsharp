...
module internal VsOpsUtils =
    ...
    val GetSquiggleAtCursor               : OpenFile -> (Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity * string) option
    val GetSquigglesAtCursor               : OpenFile -> (Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity * string) list
    ...
    val CompleteAtCursorForReason         : OpenFile * Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason -> CompletionItem array
