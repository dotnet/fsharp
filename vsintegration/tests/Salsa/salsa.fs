...
//            Append "    </PropertyGroup>"
        ...
        and internal SimpleOpenFile(project:SimpleOpenProject,filename:string,lines:string array,view:IVsTextView,scanlines:int[],rdtId) = 
            ...
            member file.GetProjectOptionsOfScript() = 
                project.Solution.Vs.LanguageService.FSharpChecker.GetProjectOptionsFromScript(filename, FSharp.Compiler.SourceCodeServices.SourceText.ofString file.CombinedLines, false, System.DateTime(2000,1,1), [| |]) 
