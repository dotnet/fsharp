...
module internal Salsa = 
    ...
    type MSBuildProjectSite(projectfile,configurationFunc,platformFunc) = 
        ...
        let GetFlags() = 
            ...
            | Some flags -> flags
            | _ -> raise Error.Bug
        let changeHandlers =  new System.Collections.Generic.Dictionary<string,Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.AdviseProjectSiteChanges>()
    ...
    /// An error
    [<Sealed>]
    type Error(path: string, subcategory:string, msg: string, context: Microsoft.VisualStudio.TextManager.Interop.TextSpan, sev: Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity) = 
        member e.Path = path
    ...
    and GotoDefnResult = Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.GotoDefinitionResult_DEPRECATED
    ...
    and [<NoEquality; NoComparison>] VsOps = 
        ...
        abstract GetSquiggleAtCursor: OpenFile -> (Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity * string) option
        abstract GetSquigglesAtCursor: OpenFile -> (Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity * string) list
        ...
        abstract CompleteAtCursorForReason: OpenFile * Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason -> CompletionItem[]
    ...
    module GotoDefnResultExtensions = 
        type Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.GotoDefinitionResult_DEPRECATED with
            ...
            member file.GetMatchingBracesForPositionAtCursor() = 
                ...
                [|
                    for o in sink.Braces do
                        match o with
                        | (:? Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BraceMatch_DEPRECATED as m) -> 
                            yield (m.a, m.b)
                        | x -> failwithf "Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BraceMatch expected, but got %A" (if box x = null then "null" else (x.GetType()).FullName)
                |]
