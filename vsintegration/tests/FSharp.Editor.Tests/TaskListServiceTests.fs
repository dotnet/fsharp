...
let private service = new Microsoft.VisualStudio.FSharp.Editor.FSharpTaskListService()
let private ct = CancellationToken.None
let private descriptors = [|"TODO";"HACK"|] |> Array.map (fun s -> s,Unchecked.defaultof<_>)
