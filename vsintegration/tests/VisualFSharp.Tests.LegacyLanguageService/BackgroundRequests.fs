                        ...
                        if containsFreshFullTypeCheck then 
                            for error in typedResults.Errors do
                                ...
                                let sev = 
                                    ...
                                    | FSharpErrorSeverity.Warning -> Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Warning
                                    | FSharpErrorSeverity.Error -> Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Error
