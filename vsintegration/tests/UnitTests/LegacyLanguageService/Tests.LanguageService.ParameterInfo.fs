...
type UsingMSBuild()  = 
    ...
    let GetParamDisplays(methods:Microsoft.VisualStudio.LegacyLanguageService.MethodListForAMethodTip_DEPRECATED) =
    ...
    let AssertEmptyMethodGroup(resultMethodGroup:Microsoft.VisualStudio.LegacyLanguageService.MethodListForAMethodTip_DEPRECATED option) =
        Assert.IsTrue(resultMethodGroup.IsNone, "Expected an empty method group")              
        
    let AssertMethodGroupDesciptionsDoNotContain(methods:Microsoft.VisualStudio.LegacyLanguageService.MethodListForAMethodTip_DEPRECATED, expectNotToBeThere) = 
        for i = 0 to methods.GetCount() - 1 do
    ...
    let AssertMethodGroup(resultMethodGroup:Microsoft.VisualStudio.LegacyLanguageService.MethodListForAMethodTip_DEPRECATED option, expectedParamNamesSet:string list list) =
    ...
    let AssertMethodGroupContain(resultMethodGroup:Microsoft.VisualStudio.LegacyLanguageService.MethodListForAMethodTip_DEPRECATED option, expectedParamNames:string list) = 
        Assert.IsTrue(resultMethodGroup.IsSome, "Expected a method group")
        let resultMethodGroup = resultMethodGroup.Value
        Assert.IsTrue(resultMethodGroup
                          |> GetParamDisplays
