...
type UsingMSBuild() as this  = 
    ...
    let AssertAutoCompleteContains, AssertAutoCompleteContainsNoCoffeeBreak, AutoCompleteInInterfaceFileContains, AssertCtrlSpaceCompleteContains, AssertCtrlSpaceCompleteContainsNoCoffeeBreak = 
        ...
        ((AssertAutoCompleteContains true SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.MemberSelect),
         (AssertAutoCompleteContains false SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.MemberSelect),
         (AssertAutoCompleteContains true SourceFileKind.FSI Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.MemberSelect),
         (AssertAutoCompleteContains true SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.CompleteWord),
         (AssertAutoCompleteContains false SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.CompleteWord))
    
    let AssertCtrlSpaceCompletionListIsEmpty code marker = 
        DoWithAutoComplete true SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.CompleteWord code marker AssertCompListIsEmpty

    let AssertCtrlSpaceCompletionListIsEmptyNoCoffeeBreak code marker = 
        DoWithAutoComplete false SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.CompleteWord code marker AssertCompListIsEmpty

    let AssertAutoCompleteCompletionListIsEmpty code marker = 
        DoWithAutoComplete true SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.MemberSelect code marker AssertCompListIsEmpty

    let AssertAutoCompleteCompletionListIsEmptyNoCoffeeBreak code marker = 
        DoWithAutoComplete false SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.MemberSelect code marker AssertCompListIsEmpty
...
a.
    ...
    member this.``TypeProvider.VisibilityChecksForGeneratedTypes``() = 
        ...
        let check = DoWithAutoCompleteUsingExtraRefs extraRefs true SourceFileKind.FS Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.MemberSelect
...
(*------------------------------------------IDE Query automation start -------------------------------------------------*)
    member private this.AssertAutoCompletionInQuery(fileContent : string list, marker:string,contained:string list) =
        ...
        let gpatcc = GlobalParseAndTypeCheckCounter.StartNew(this.VS)
        MoveCursorToEndOfMarker(file, marker)
        let completions = CompleteAtCursorForReason(file,Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.BackgroundRequestReason.CompleteWord)
