...
type UsingMSBuild() as this = 
    ...
    let AssertSquiggleIsErrorContaining,AssertSquiggleIsWarningContaining, AssertSquiggleIsErrorNotContaining,AssertSquiggleIsWarningNotContaining =         
        ...
        AssertSquiggle Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Error    "Error"    "Warning" AssertContains,
        AssertSquiggle Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Warning  "Warning"  "Error"   AssertContains,
        AssertSquiggle Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Error    "Error"    "Warning" AssertNotContains,
        AssertSquiggle Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Warning  "Warning"  "Error"   AssertNotContains 
    ...
    member private this.TestFsxHashDirectivesAreErrors(mark : string, expectedStr : string) = 
        ...
        match ans with
        | Some(sev,msg) -> 
            AssertEqual(Microsoft.VisualStudio.VisualFSharp.Tests.LegacyLanguageService.Severity.Error,sev)
