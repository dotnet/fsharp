...
type internal SR private() =
    ...
    static member tcAnonRecdCcuMismatch2(a0 : System.String) = (GetStringFunc("tcAnonRecdCcuMismatch2",",,,%s,,,") a0)
    ...
    static member parsInvalidAnonRecdExpr() = (3220, GetStringFunc("parsInvalidAnonRecdExpr",",,,") )
    /// Invalid anonymous record type
    /// (Originally from ..\FSComp.txt:1431)
    static member parsInvalidAnonRecdType() = (3221, GetStringFunc("parsInvalidAnonRecdType",",,,") )
    ...
    static member RunStartupValidation() =
        ...
        ignore(GetString("tcAnonRecdCcuMismatch2"))
