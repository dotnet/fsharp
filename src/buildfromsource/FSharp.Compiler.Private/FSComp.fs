...
type internal SR private() =
    ...
    static member csNullNotNullConstraintInconsistent() = (472, GetStringFunc("csNullNotNullConstraintInconsistent",",,,") )
    /// The constraints 'struct' and 'null' are inconsistent
    /// (Originally from ..\FSComp.txt:313)
    static member csStructNullConstraintInconsistent() = (472, GetStringFunc("csStructNullConstraintInconsistent",",,,") )
    /// The constraints 'delegate' and 'comparison' are inconsistent
    /// (Originally from ..\FSComp.txt:314)
    static member csDelegateComparisonConstraintInconsistent() = (472, GetStringFunc("csDelegateComparisonConstraintInconsistent",",,,") )
    ...
    static member tcNullnessCheckingNotEnabled() = (3247, GetStringFunc("tcNullnessCheckingNotEnabled",",,,") )
