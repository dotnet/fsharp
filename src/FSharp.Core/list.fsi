...
module List = 
    ...
    /// <summary>Returns a new list that contains all pairings of elements from two lists.
    /// 
    /// Time complexity: O(n₁ * n₂) - where n₁ and n₂ are the lengths of the input lists
    ...
    /// <summary>Returns the average of values in a list generated by applying a function to each element of the list.
    /// 
    ...
    /// <summary>For each element of the list, applies the given function. Concatenates all the results and returns the combined list.
    /// 
    /// Time complexity: O(n * m) - where n is the list length and m is the average result length per element
    ...
    /// <summary>Tests if the list contains the specified element.
    /// 
    /// Time complexity: O(n) - requires comparing each element in worst case
    /// Space complexity: O(1)
    /// </summary>
    ///
    ...
    /// <summary>Splits the input list into at most <c>count</c> chunks.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(n)
    /// </summary>
    ...
    /// <summary>Returns the only element of the list.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(1)
    /// </summary>
    ...
    /// <summary>Returns the only element of the list or <c>None</c> if it is empty or contains more than one element.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(1)
    /// </summary>
    ...
    /// <summary>Tests if any element of the list satisfies the given predicate.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(1)
    /// </summary>
    ...
    /// <summary>Tests if all corresponding elements of the collection satisfy the given predicate pairwise.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(1)
    /// </summary>
    ...
    /// <summary>Creates a list by calling the given generator on each index.
    /// 
    /// Time complexity: O(n) - where n is the specified length
    /// Space complexity: O(n)
    /// </summary>
    ///
    ...
    /// <summary>Returns true if the list contains no elements, false otherwise.
    /// 
    /// Time complexity: O(1)
    /// Space complexity: O(1)
    /// </summary>
    ...
    /// The predecessor comes first in the returned pairs.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(n) </summary>
    ///
    ...
    /// <summary>Sorts the given list using <see cref="M:Microsoft.FSharp.Core.Operators.compare"/>.
    /// 
    /// Time complexity: O(n log n) - where n is the list length
    /// Space complexity: O(n)</summary>
    ///
    ...
    /// <summary>Splits a list into two lists, at the given index.
    /// 
    /// Time complexity: O(n) - where n is the index to split at
    /// Space complexity: O(n)</summary>
    ///
    ...
    /// <summary>Returns the sum of the elements in the list.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(1)</summary>
    ///
    ...
    /// <summary>Returns the sum of the results generated by applying the function to each element of the list.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(1)</summary>
    ///
    ...
    /// <summary>Returns the list after removing the first element.
    /// 
    /// Time complexity: O(1)
    /// Space complexity: O(1)</summary>
    ///
    ...
    /// <summary>Returns the first N elements of the list.
    /// 
    /// Time complexity: O(n) - where n is the count to take
    /// Space complexity: O(n)</summary>
    ...
    /// <summary>Builds an array from the given list.
    /// 
    /// Time complexity: O(n) - where n is the list length
    /// Space complexity: O(n)</summary>
    ///
    ...
    /// <summary>Views the given list as a sequence.
    /// 
    /// Time complexity: O(1) - returns a wrapper, not a copy
    /// Space complexity: O(1)</summary>
    ///
    /// <param name="list">The input list.</param>
    ///
    ...
    /// <summary>Returns the transpose of the given sequence of lists.
    /// 
    /// Time complexity: O(n * m) - where n is the number of lists and m is the length of each list
    /// Space complexity: O(n * m)</summary>
    ///
    ...
    /// <summary>Returns at most N elements in a new list.
    /// 
    /// Time complexity: O(n) - where n is the count to truncate to
    /// Space complexity: O(n)</summary>
    ///
