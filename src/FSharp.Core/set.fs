...
module internal SetTree =
    ...
    let partitionWith (comparer1: IComparer<'T1>) (comparer2: IComparer<'T2>) (partitioner: 'T -> Choice<'T1, 'T2>) (t: SetTree<'T>) =
