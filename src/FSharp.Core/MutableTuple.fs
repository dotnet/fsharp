...
/// <exclude />
[<Sealed>]
type AnonymousObject<'T1, 'T2, 'T3, 'T4, 'T5, 'T6>(Item1: 'T1, Item2: 'T2, Item3: 'T3, Item4: 'T4, Item5: 'T5, Item6: 'T6) =
    member _.Item1 = Item1
    member _.Item2 = Item2
    member _.Item3 = Item3
    member _.Item4 = Item4
...
/// <exclude />
[<Sealed>]
type AnonymousObject<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7>(Item1: 'T1, Item2: 'T2, Item3: 'T3, Item4: 'T4, Item5: 'T5, Item6: 'T6, Item7: 'T7) =
    member _.Item1 = Item1
    member _.Item2 = Item2
    member _.Item3 = Item3
    member _.Item4 = Item4
...
/// <exclude />
[<Sealed>]
type AnonymousObject<'T1, 'T2, 'T3, 'T4, 'T5, 'T6, 'T7, 'T8>(Item1: 'T1, Item2: 'T2, Item3: 'T3, Item4: 'T4, Item5: 'T5, Item6: 'T6, Item7: 'T7, Item8: 'T8) =
    member _.Item1 = Item1
    member _.Item2 = Item2
    member _.Item3 = Item3
    member _.Item4 = Item4
