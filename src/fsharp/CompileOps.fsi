...
type TcImports =
    ...
    static member BuildFrameworkTcImports      : CompilationThreadToken * TcConfigProvider * AssemblyResolution list * AssemblyResolution list -> Async<TcGlobals * TcImports>
    static member BuildNonFrameworkTcImports   : CompilationThreadToken * TcConfigProvider * TcGlobals * TcImports * AssemblyResolution list * UnresolvedAssemblyReference list -> Async<TcImports>
    static member BuildTcImports               : CompilationThreadToken * TcConfigProvider -> Async<TcGlobals * TcImports>
