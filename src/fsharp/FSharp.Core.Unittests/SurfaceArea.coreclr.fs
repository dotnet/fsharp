...
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[T,TResult] ToFSharpFunc[T,TResult](System.Func`2[T,TResult])
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[System.Tuple`2[T1,T2],TResult] ToFSharpFunc[T1,T2,TResult](System.Func`3[T1,T2,TResult])
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[System.Tuple`3[T1,T2,T3],TResult] ToFSharpFunc[T1,T2,T3,TResult](System.Func`4[T1,T2,T3,TResult])
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[System.Tuple`4[T1,T2,T3,T4],TResult] ToFSharpFunc[T1,T2,T3,T4,TResult](System.Func`5[T1,T2,T3,T4,TResult])
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[System.Tuple`5[T1,T2,T3,T4,T5],TResult] ToFSharpFunc[T1,T2,T3,T4,T5,TResult](System.Func`6[T1,T2,T3,T4,T5,TResult])
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[System.Tuple`6[T1,T2,T3,T4,T5,T6],TResult] ToFSharpFunc[T1,T2,T3,T4,T5,T6,TResult](System.Func`7[T1,T2,T3,T4,T5,T6,TResult])
Microsoft.FSharp.Core.FuncConvert: Microsoft.FSharp.Core.FSharpFunc`2[System.Tuple`7[T1,T2,T3,T4,T5,T6,T7],TResult] ToFSharpFunc[T1,T2,T3,T4,T5,T6,T7,TResult](System.Func`8[T1,T2,T3,T4,T5,T6,T7,TResult])
