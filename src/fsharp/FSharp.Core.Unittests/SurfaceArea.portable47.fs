...
Microsoft.FSharp.Collections.ISeqModule+Core+FolderWithState`3[T,TResult,TState]: Void StopFurtherProcessing(Int32)
...
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: Boolean Equals(System.Object)
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: Int32 GetHashCode()
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: Int32 Length()
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: Microsoft.FSharp.Collections.SeqComposition.ISeq`1[T] Append(Microsoft.FSharp.Collections.SeqComposition.ISeq`1[T])
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: System.String ToString()
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: System.Type GetType()
Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]: Void .ctor()
...
Microsoft.FSharp.Collections.SeqComposition.Core: Microsoft.FSharp.Collections.SeqComposition.Core+EnumerableBase`1[T]
...
Microsoft.FSharp.Collections.SeqComposition.Folder`2[T,TResult]: Void StopFurtherProcessing(Int32)
Microsoft.FSharp.Collections.SeqComposition.IOutOfBand: Void StopFurtherProcessing(Int32)
Microsoft.FSharp.Collections.SeqComposition.ISeq`1[T]: Microsoft.FSharp.Collections.SeqComposition.ISeq`1[TResult] PushTransform[TResult](Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult])
...
Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult]: Boolean Equals(System.Object)
Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult]: Int32 GetHashCode()
Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult]: Microsoft.FSharp.Collections.SeqComposition.Activity`2[T,V] Compose[V](Microsoft.FSharp.Collections.SeqComposition.IOutOfBand, Int32, Microsoft.FSharp.Collections.SeqComposition.Activity`2[TResult,V])
Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult]: System.String ToString()
Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult]: System.Type GetType()
Microsoft.FSharp.Collections.SeqComposition.TransformFactory`2[T,TResult]: Void .ctor()
