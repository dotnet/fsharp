...
Microsoft.FSharp.Reflection.UnionCaseInfo: System.Type get_DeclaringType()"
        ...
        printfn "Processing %A" file
        printfn "FullName   %A" asm.FullName
        printfn "Location   %A" asm.Location
