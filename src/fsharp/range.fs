...
[<Literal>]
let startColumnMask = 0b0000000000000000000000011111111111111111000000000000000000000000L
[<Literal>]
let endColumnMask =   0b0000001111111111111111100000000000000000000000000000000000000000L
