...
module Seq = 
    ...
    /// <code lang="fsharp">
    /// ([1; 2], [1; 2]) ||> Seq.compareWith (fun a b -> a.CompareTo(b))
    /// </code>
    /// Evaluates to <c>0</c>
    /// </example>
    ///
    ...
    /// <code lang="fsharp">
    /// ([1; 2], [1; 3]) ||> Seq.compareWith (fun a b -> a.CompareTo(b))
    /// </code>
    /// Evaluates to <c>-1</c>
    /// </example>
    ///
    ...
    /// <code lang="fsharp">
    /// ([1; 3], [1; 2]) ||> Seq.compareWith (fun a b -> a.CompareTo(b))
    /// </code>
    /// Evaluates to <c>1</c>
    /// </example>
    ///
    ...
    /// <code lang="fsharp">
    /// ([1; 2], [1]) ||> Seq.compareWith (fun a b -> a.CompareTo(b))
    /// </code>
    /// Evaluates to <c>1</c>
    /// </example>
    ///
    ...
    /// <code lang="fsharp">
    /// ([1], [1; 2]) ||> Seq.compareWith (fun a b -> a.CompareTo(b))
    /// </code>
    /// Evaluates to <c>-1</c>
    /// </example>
