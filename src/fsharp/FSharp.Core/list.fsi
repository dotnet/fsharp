...
module List = 
    ...
    /// The given initial <c>state</c> argument is passed to the element generator. The generator is repeatedly called to build the list until it returns `None`.</summary>
    ///
