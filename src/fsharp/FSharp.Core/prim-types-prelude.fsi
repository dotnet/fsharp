...
namespace Microsoft.FSharp.Core
    ...
    ///
    /// <remarks>This type should only be used when writing F# code that interoperates
    /// with other .NET languages that use Common IL Signature Pointers. Use of this type in F# code may result in
    /// unverifiable code being generated. Because of the rules of Common IL Signature Pointers,
    /// you cannot use this type in generic type parameters, resulting in compiler errors. As a result,
    /// you should convert this type to <see cref="T:Microsoft.FSharp.Core.nativeptr{T}" /> for use in F#.
    /// Note that Common IL Signature Pointers exposed by other .NET languages are converted to
    /// <see cref="T:Microsoft.FSharp.Core.nativeptr{T}" /> automatically by F#, however for other languages
    /// to interpret F# native pointers correctly, you should expose this type instead of <see cref="T:Microsoft.FSharp.Core.nativeptr{T}" />.
