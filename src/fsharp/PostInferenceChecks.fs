              ...
              (// Check the attributes on any enclosing module
               ...
               HasFSharpAttribute cenv.g cenv.g.attrib_ReflectedDefinitionAttribute v.TopValDeclaringEntity.Attribs) then 
                ...
                | None ->
                    ...
                    | None -> v.val_opt_data <- Some { val_compiled_name = None; val_other_range = None; val_const = None; val_defn = Some bindRhs; val_repr_info = None; val_access = TAccess []; val_xmldoc = XmlDoc.Empty; val_member_info = None; val_declaring_entity = ParentNone; val_xmldocsig = System.String.Empty }
                | Some _ -> ()
