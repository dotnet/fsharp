...
type IProjectReference = 
    ...
    abstract EvaluateRawContents : unit -> Async<IRawFSharpAssemblyData option>
    /// Get the logical timestamp that would be the timestamp of the assembly file generated by the project
    abstract GetLogicalTimeStamp : unit -> Async<System.DateTime option>
...
*)
    ...
    static member BuildFrameworkTcImports (ctok, tcConfigP:TcConfigProvider, frameworkDLLs, nonFrameworkDLLs) =
      async {
        ...
        do! frameworkTcImports.DoRegisterAndImportReferencedAssemblies (ctok, tcResolutions.GetAssemblyResolutions())
                ...
                let! fslibCcuInfo =
                  async {
                    ...
                    | Some coreLibraryResolution -> 
                        let! assemblies = frameworkTcImports.RegisterAndImportReferencedAssemblies(ctok, [coreLibraryResolution])
    ...
    static member BuildNonFrameworkTcImports (ctok, tcConfigP:TcConfigProvider, tcGlobals:TcGlobals, baseTcImports, nonFrameworkReferences, knownUnresolved) =
      async {
        ...
        do! tcImports.DoRegisterAndImportReferencedAssemblies(ctok, references)
