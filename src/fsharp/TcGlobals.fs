...
type public TcGlobals(compilingFslib: bool, ilg:ILGlobals, fslibCcu: CcuThunk, directoryToResolveRelativePaths, 
  ...
  let v_cgh_jumptable_info         = makeIntrinsicValRef(fslib_MFStateMachineHelpers_nleref,                   "__compiledStateMachineCode"                       , None                 , None          , [vara],     ([[v_int_ty]; [varaTy]], varaTy))
  let v_cgh_stateMachine_info      = makeIntrinsicValRef(fslib_MFStateMachineHelpers_nleref,                   "__compiledStateMachine"                    , None                 , None          , [vara],     ([[varaTy]], varaTy))
  let v_cgh_stateMachineStruct_info = makeIntrinsicValRef(fslib_MFStateMachineHelpers_nleref,                  "__compiledStateMachineStruct"              , None                 , None          , [vara; varb],     ([[varbTy; varcTy; (v_unit_ty --> vardTy)]], vardTy))
  ...
  let v_cgh_entryPointStaticId_info  = makeIntrinsicValRef(fslib_MFStateMachineHelpers_nleref,                 "__compiledStateMachineEntryPointID"                    , None                 , None          , [vara],     ([[mkMachineFuncTy varaTy]], v_int_ty))
  ...
  member val cgh_entryPointStaticId_vref = ValRefForIntrinsic v_cgh_entryPointStaticId_info
