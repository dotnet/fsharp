...
and typeAEquivAux erasureFlag g aenv ty1 ty2 = 
    ...
    | TType_fun (dtys1, rty1, _), TType_fun (dtys2, retTy2, _) -> // NOTE: nullness annotations are ignored for type equivalence
