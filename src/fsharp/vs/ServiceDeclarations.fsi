...
type internal FSharpDeclarationListInfo =
    ...
    static member internal Create : infoReader:InfoReader * m:range * denv:DisplayEnv * assibility:FSharpAccessibility option * items:CompletionItem list * reactor:IReactorOperations * checkAlive:(unit -> bool) -> FSharpDeclarationListInfo
