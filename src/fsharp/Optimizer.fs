        ...
        | Expr.Quote (quotedExpr, _, true, _, _) ->  // true = isFromQueryExpression
            ...
            | Some (resultExpr, exprIsEnumerableInfo) ->
                let resultExprAfterConvertToResultTy = 
                    ...
                    | Some resultElemTy, None -> mkCallGetQuerySourceAsEnumerable g expr.Range resultElemTy (TType_app(g.tcref_System_Collections_IEnumerable, [], g.knownWithoutNull)) resultExpr
