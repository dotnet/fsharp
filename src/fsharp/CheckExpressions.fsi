...
val MakeAndPublishVal: cenv: TcFileState -> env: TcEnv -> altActualParent: ParentRef * inSig: bool * declKind: DeclKind * vrec: ValRecursiveScopeInfo * vscheme: ValScheme * attrs: Attribs * doc: XmlDoc * konst: Const option * isGeneratedEventVal: bool * valFunctionParameterInfo: ValFunctionParameterInfo -> Val
...
val MakeAndPublishSimpleVals: cenv: TcFileState -> env: TcEnv -> names: NameMap<PrelimValScheme1> -> valFunctionParameterInfo: ValFunctionParameterInfo -> NameMap<(Val * TypeScheme)> * NameMap<Val>
