...
type internal FsiDynamicCompiler
    ...
    let CreateModuleFragment (tcConfigB: TcConfigBuilder, assemblyName, codegenResults) =
        ...
        let attrsStored = storeILCustomAttrs (mkILCustomAttrs codegenResults.ilAssemAttrs)
        mainModule.With(manifest = Some (mainModule.ManifestOfAssembly.With(newCustomAttrsStored = attrsStored)))
