...
type internal FSharpErrorInfo = FSharp.Compiler.SourceCodeServices.FSharpErrorInfo
...
type internal ParseResult = ParsedInput option * FSharp.Compiler.SourceCodeServices.FSharpErrorInfo []
