...
type [<Class>] PaketDependencyManager =
    ...
    member Key: string
    member ResolveDependencies : targetFramework: string * scriptDir: string * mainScriptName: string * scriptName: string * dependencyManagerTextLines: string seq -> string option * string list
