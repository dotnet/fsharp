...
let isStructUnionTy      g ty = ty |> stripTyEqns g |> (function TType_app(tcr,_) -> tcr.IsUnionTycon && tcr.IsFSharpStructOrEnumTycon | _ -> false)
...
let isStructRecdTy       g ty = ty |> stripTyEqns g |> (function TType_app(tcr,_) -> tcr.IsRecordTycon && tcr.IsFSharpStructOrEnumTycon | _ -> false)
