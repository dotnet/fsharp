...
type ValFlags(flags:int64) = 
    ...
    member x.IsExtensionMethod                                  = (flags &&& 0b10000000000000000000L) <> 0L

    member x.WithIsExtensionMethod                      = ValFlags(flags ||| 0b10000000000000000000L)
    ...
    member x.PickledBits = 
        ...
        // Clear the IsExtensionMethod, only used in post inference checks for a defined extension method
...
and [<NoEquality; NoComparison; StructuredFormatDisplay("{DebugText}")>]
    ...
    /// Indiciates if the value is an extension method
    member x.IsExtensionMethod = x.val_flags.IsExtensionMethod
    ...
    member x.SetIsExtensionMethod()                      = x.val_flags <- x.val_flags.WithIsExtensionMethod
