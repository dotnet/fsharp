...
let MakeAndPublishVal cenv env (altActualParent, inSig, declKind, vrec, vscheme, attrs, doc, konst, isGeneratedEventVal, valFunctionParameterInfo) =
    ...
    let vspec = 
        Construct.NewVal
            (logicalName, id.idRange, compiledName, ty, mut,
             ...
             (hasDeclaredTypars || inSig), isGeneratedEventVal, konst, actualParent, valFunctionParameterInfo)
