                                        ...
                                        Microsoft.VisualStudio.LanguageServer.Protocol.Location(
                                            ...
                                            Range = 
                                                Microsoft.VisualStudio.LanguageServer.Protocol.Range(
                                                    Start = Microsoft.VisualStudio.LanguageServer.Protocol.Position(Line = targetRange.StartLine - 1, Character = targetRange.StartColumn),
                                                    End = Microsoft.VisualStudio.LanguageServer.Protocol.Position(Line = targetRange.EndLine - 1, Character = targetRange.EndColumn)
                                                )
                                        )
