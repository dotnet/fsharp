...
val mkClassUnionDef : addMethodGeneratedAttrs:(IMethodDef -> IMethodDef) * addPropertyGeneratedAttrs:(IPropertyDef -> IPropertyDef) * addPropertyNeverAttrs:(IPropertyDef -> IPropertyDef) * addFieldGeneratedAttrs:(IFieldDef -> IFieldDef) * addFieldNeverAttrs:(IFieldDef -> IFieldDef) * mkDebuggerTypeProxyAttribute:(ILType -> IAttribute) -> ilg:ILGlobals -> tref:ILTypeRef -> td:ITypeDef -> cud:IlxUnionInfo -> ITypeDef    
