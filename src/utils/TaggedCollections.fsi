...
namespace Internal.Utilities.Collections.Tagged
    ...
    type internal Set<'T,'ComparerTag> when 'ComparerTag :> IComparer<'T> =
        ...
        /// Build two new sets, one containing the elements for which the given predicate returns <c>true</c>,
        ...
        /// Compares two sets and returns <c>true</c> if they are equal or <c>false</c> otherwise.
        static member Equality : Set<'T,'ComparerTag> * Set<'T,'ComparerTag> -> bool
        
        /// Compares a and b and returns <c>1</c> if a > b, -1 if b < a and <c>0</c> if a = b.       
        ...
        /// Evaluates to <c>true</c> if all elements of the second set are in the first.
        member IsSubsetOf: Set<'T,'ComparerTag> -> bool

        /// Evaluates to <c>true</c> if all elements of the first set are in the second.
    ...
    type internal Map<'Key,'Value,'ComparerTag>  when 'ComparerTag :> IComparer<'Key> =
        ...
        /// Return <c>true</c> if there are no bindings in the map.
        member IsEmpty: bool
        ...
        /// Return <c>true</c> if the given predicate returns true for all of the
        /// bindings in the map. Always returns true if the map is empty.
        member ForAll: ('Key -> 'Value -> bool) -> bool

        /// Return <c>true</c> if the given predicate returns true for one of the
        /// bindings in the map. Always returns false if the map is empty.
        member Exists: ('Key -> 'Value -> bool) -> bool

        /// Build a new map containing the bindings for which the given predicate returns <c>true</c>.
        ...
        /// Build two new maps, one containing the bindings for which the given predicate returns <c>true</c>,
