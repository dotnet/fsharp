        ...
        if ilTypeRef.Scope.IsLocalRef then
            ...
            let ilCtorDef =
                (mkILSimpleStorageCtorWithParamNames(
                    ...
                    None,
                    None
                )).With(customAttrs = mkILCustomAttrs[GetDynamicDependencyAttribute g 0x660 (*Public and NonPublic Fields and Properties*) ilTy])
                    ...
                    | TFSharpRecdRepr _ when not tycon.IsEnumTycon ->
                        ...
                        let ilMethodDef =
                            (mkILSimpleStorageCtorWithParamNames (
                                ...
                                None,
                                eenv.imports
                            )).With(customAttrs = mkILCustomAttrs[GetDynamicDependencyAttribute g 0x660 (*Public and NonPublic Fields and Properties*) ilThisTy])
