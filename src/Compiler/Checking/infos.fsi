...
val ReparentSlotSigToUseMethodTypars: g: TcGlobals -> _m: range -> ovByMethValRef: ValRef -> slotsig: SlotSig -> SlotSig
...
type UnionCaseInfo =
    ...
    member GetTyparInst: _m: range -> TyparInstantiation
