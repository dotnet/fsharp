...
let AddCheckResultsToTcState
    ...
    let tcImplEnv =
        AddLocalRootModuleOrNamespace true TcResultsSink.NoSink tcGlobals amap m tcImplEnv implFileSigType
    ...
    let tcSigEnv =
        if hadSig then
            ...
            AddLocalRootModuleOrNamespace true TcResultsSink.NoSink tcGlobals amap m tcState.tcsTcSigEnv implFileSigType
                ...
                return
                    Finisher(
                        ...
                        (fun tcState ->
                            ...
                            let tcSigEnv =
                                AddLocalRootModuleOrNamespace true TcResultsSink.NoSink tcGlobals amap m tcState.tcsTcSigEnv sigFileType
