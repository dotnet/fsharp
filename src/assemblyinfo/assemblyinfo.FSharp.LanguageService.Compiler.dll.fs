...
[<assembly:AssemblyDescription("FSharp.LanguageService.Compiler.dll")>]
[<assembly:AssemblyCompany("Microsoft Corporation")>]
[<assembly:AssemblyTitle("FSharp.LanguageService.Compiler.dll")>]
...
[<assembly: ProvideCodeBase(CodeBase = @"$PackageFolder$\FSharp.LanguageService.Compiler.dll")>]
