...
let evaluateSession (argv: string[]) =
    ...
    try
        ...
        // Create the console
        and fsiSession: FsiEvaluationSession =
        ...
        | Some pipeName -> FSharp.Compiler.Interactive.Server.startOnBackgroundThread fsiSession fsiConfig pipeName Console.Out Console.Error
        | None -> ()
