...
and 
    ...
    /// Custom modifiers. 
    | Modified of            
          /// <c>true</c> if modifier is "required". 
          bool *                  
...
and [<NoComparison; NoEquality>]
    ...
    { tdKind: ILTypeDefKind;
      ...
      SecurityDecls: ILPermissions;
      /// NOTE: some classes are marked "HasSecurity" even if there are no permissions attached, 
...
/// If you have already loaded a particular version of system runtime assembly you should 
/// reference items via an ILGlobals for that particular version of system runtime assembly 
/// built using mkILGlobals. 
[<NoEquality; NoComparison>]
type ILGlobals = 
    { 
