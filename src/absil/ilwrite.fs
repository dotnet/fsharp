...
let WriteILBinary (outfile, args: options, ilModule, noDebugData) =
    ignore (writeBinaryAndReportMappings (outfile, args.ilg, args.pdbfile,
#if FX_NO_KEY_SIGNING
#else
                                          args.signer, 
#endif
                                          args.fixupOverlappingSequencePoints, args.emitTailcalls, args.showTimes, args.dumpDebugInfo) ilModule noDebugData)
