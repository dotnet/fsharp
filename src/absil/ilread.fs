...
and seekReadTypeDefOrRefAsTypeRef (ctxt: ILMetadataReader) (TaggedIndex(tag, idx) ) =
    ...
    | tag when tag = tdor_TypeSpec -> 
        ...
        ILImplicitTypes.typ_Object.TypeRef
...
and sigptrGetTy (ctxt: ILMetadataReader) numtypars bytes sigptr = 
    let b0, sigptr = sigptrGetByte bytes sigptr
    if b0 = et_OBJECT then ILImplicitTypes.typ_Object, sigptr
    elif b0 = et_STRING then ILImplicitTypes.typ_String, sigptr
    elif b0 = et_I1 then ILImplicitTypes.typ_SByte, sigptr
    elif b0 = et_I2 then ILImplicitTypes.typ_Int16, sigptr
    elif b0 = et_I4 then ILImplicitTypes.typ_Int32, sigptr
    elif b0 = et_I8 then ILImplicitTypes.typ_Int64, sigptr
    elif b0 = et_I then ILImplicitTypes.typ_IntPtr, sigptr
    elif b0 = et_U1 then ILImplicitTypes.typ_Byte, sigptr
    elif b0 = et_U2 then ILImplicitTypes.typ_UInt16, sigptr
    elif b0 = et_U4 then ILImplicitTypes.typ_UInt32, sigptr
    elif b0 = et_U8 then ILImplicitTypes.typ_UInt64, sigptr
    elif b0 = et_U then ILImplicitTypes.typ_UIntPtr, sigptr
    elif b0 = et_R4 then ILImplicitTypes.typ_Single, sigptr
    elif b0 = et_R8 then ILImplicitTypes.typ_Double, sigptr
    elif b0 = et_CHAR then ILImplicitTypes.typ_Char, sigptr
    elif b0 = et_BOOLEAN then ILImplicitTypes.typ_Bool, sigptr
        ...
        ILImplicitTypes.typ_TypedReference, sigptr
