...
2. **Work through "Bug" issues in reverse order, from the oldest open issue.** Read the issue comments and check memory's `comments_made` field. 
...
7. Update memory with comments made and the new cursor position.
