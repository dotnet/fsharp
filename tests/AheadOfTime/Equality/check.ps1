Write-Host "Publish and Execute: net10.0 - Equality"

$build_output = dotnet publish -restore -c release -f:net10.0 $(Join-Path $PSScriptRoot Equality.fsproj)
