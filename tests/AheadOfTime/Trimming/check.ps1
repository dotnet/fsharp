...
# Check net10.0 trimmed assemblies
CheckTrim -root "SelfContained_Trimming_Test" -tfm "net10.0" -outputfile "FSharp.Core.dll" -expected_len 300032

# Check net10.0 trimmed assemblies with static linked FSharpCore
CheckTrim -root "StaticLinkedFSharpCore_Trimming_Test" -tfm "net10.0" -outputfile "StaticLinkedFSharpCore_Trimming_Test.dll" -expected_len 9154048

# Check net10.0 trimmed assemblies with F# metadata resources removed
CheckTrim -root "FSharpMetadataResource_Trimming_Test" -tfm "net10.0" -outputfile "FSharpMetadataResource_Trimming_Test.dll" -expected_len 7601152
