ImplFile
  (ParsedImplFileInput
     ("/root/Pattern/And 02.fs", false, QualifiedNameOfFile Module, [], [],
                                           ...
                                           (LongIdent
                                              (SynLongIdent
                                                 ([System;
                                                  ...
                                                  [(5,32--5,33)], [None; None])),
                                            (5,23--5,55)), (5,22--5,56))],
                                     (5,13--5,56)), (5,12--5,57))], None,
                            (5,6--5,57)), None, Const (Unit, (5,61--5,63)),
                         (5,6--5,63), Yes, { ArrowRange = Some (5,58--5,60)
