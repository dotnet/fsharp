ImplFile
  (ParsedImplFileInput
     ("/root/Member/Do 01.fs", false, QualifiedNameOfFile Module, [], [],
                            ...
                            (None, Do, false, false, [], PreXmlDocEmpty,
                             SynValData
                               (None,
                                ...
                                None, None), Const (Unit, (5,4--5,8)), None,
                             Const (Int32 1, (5,7--5,8)), (5,4--5,8), NoneAtDo,
                             { LeadingKeyword = Do (5,4--5,6)
                               InlineKeyword = None
                               EqualsRange = None })], false, false, (5,4--5,8));
                      LetBindings
                        ([SynBinding
                            (None, Do, false, false, [], PreXmlDocEmpty,
                             SynValData
