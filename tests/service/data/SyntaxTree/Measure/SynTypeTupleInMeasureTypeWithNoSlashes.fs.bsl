ImplFile
  (ParsedImplFileInput
     ("/root/Measure/SynTypeTupleInMeasureTypeWithNoSlashes.fs", false,
      QualifiedNameOfFile SynTypeTupleInMeasureTypeWithNoSlashes, [], [],
      [SynModuleOrNamespace
         ([SynTypeTupleInMeasureTypeWithNoSlashes], false, AnonModule,
          [Types
             ([SynTypeDefn
                 (SynComponentInfo
                    ([{ Attributes =
