              ...
              [SynBinding
                 (None, Normal, false, false, [],
                  ...
                  InterpolatedString
                    ([String ("1 + ", (2,8--2,21));
                      FillExpr
                        (Const (Int32 41, (2,21--2,23)), DotNet (None, None));
                      String (" = ", (2,23--2,32));
                      FillExpr
                        (Const (Int32 6, (2,32--2,33)), DotNet (None, None));
                      String (" * 7", (2,33--2,43))], TripleQuote, (2,8--2,43)),
                  (2,4--2,5), Yes (2,0--2,43), { LeadingKeyword = Let (2,0--2,3)
                                                 InlineKeyword = None
                                                 EqualsRange = Some (2,6--2,7) })],
              (2,0--2,43), { InKeyword = None })], PreXmlDocEmpty, [], None,
          (2,0--2,43), { LeadingKeyword = None })], (true, true),
