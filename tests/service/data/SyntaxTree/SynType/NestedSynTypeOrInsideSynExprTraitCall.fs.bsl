                    ...
                    (TraitCall
                       (Paren
                          (Or
                             (Or
                                (Var
                                   (SynTypar (a, HeadType, false), (2,38--2,40)),
                                 Var
                                   (SynTypar (b, HeadType, false), (2,44--2,46)),
                                 (2,38--2,46), { OrKeyword = (2,41--2,43) }),
                              Var (SynTypar (c, HeadType, false), (2,50--2,52)),
                                     ...
                                     Type
                                       (Var
                                          (SynTypar (b, HeadType, false),
                                           (2,88--2,90)))], (2,83--2,90)),
                                 Var
                                   (SynTypar (c, HeadType, false), (2,94--2,96)),
                                 (2,83--2,96), { ArrowRange = (2,91--2,93) }),
                              SynValInfo
