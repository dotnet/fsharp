                 ...
                 (None, Normal, true, false, [],
                             ...
                             (Typed
                                (Named
                                   (SynIdent (x, None), false, None,
                                    (2,17--2,18)),
                                 Var
                                   (SynTypar (a, HeadType, false), (2,20--2,22)),
                                 (2,17--2,22)), (2,16--2,23))], None,
                        (2,11--2,23)),
                  ...
                  Paren
                    (TraitCall
                       (Paren
                          (Or
                             (Var (SynTypar (a, HeadType, false), (2,33--2,35)),
                              Var (SynTypar (b, HeadType, false), (2,39--2,41)),
                        ...
                        Member
                          (SynValSig
                             ([], SynIdent (op_Implicit, None),
                              ...
                              Fun
                                (Var
                                   (SynTypar (a, HeadType, false), (2,72--2,74)),
                                 Var
                                   (SynTypar (b, HeadType, false), (2,78--2,80)),
                                 (2,72--2,80), { ArrowRange = (2,75--2,77) }),
                              SynValInfo
