                       ...
                       (LongIdent (SynLongIdent ([a], [], [None])),
                        Fun
                          (LongIdent (SynLongIdent ([b], [], [None])),
                           FromParseError (3,16--3,16), (3,12--3,16),
                           { ArrowRange = (3,14--3,16) }), (3,7--3,16),
                        { ArrowRange = (3,9--3,11) }), (3,4--3,18)), None,
                  Const (Unit, (3,19--3,21)), (3,4--3,18), Yes (3,0--3,21),
...
(3,17)-(3,18) parse error Unexpected symbol '=' in type
