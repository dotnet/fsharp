                    ...
                    (Named (SynIdent (b, None), false, None, (3,4--3,5)),
                     Tuple
                       (false,
                        ...
                        (3,8--3,27)), (3,4--3,27)), None,
                  Tuple
                    (false,
                     [Const (Int32 1, (3,30--3,31));
                      Const (String ("", Regular, (3,33--3,35)), (3,33--3,35));
                      Const (Bool false, (3,37--3,42))],
                     [(3,31--3,32); (3,35--3,36)], (3,30--3,42)), (3,4--3,27),
                  Yes (3,0--3,42), { LeadingKeyword = Let (3,0--3,3)
                                     InlineKeyword = None
                                     EqualsRange = Some (3,28--3,29) })],
              (3,0--3,42))], PreXmlDocEmpty, [], None, (2,0--4,0),
