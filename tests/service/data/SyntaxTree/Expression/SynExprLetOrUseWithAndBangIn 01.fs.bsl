                          ...
                          (None, Normal, false, false, [], PreXmlDocEmpty,
                           SynValData
                             (None,
                              ...
                              None),
                           Named (SynIdent (a, None), false, None, (2,9--2,10)),
                          ...
                          (None, Normal, false, false, [], PreXmlDocEmpty,
                           SynValData
                             (None,
                              SynValInfo ([], SynArgInfo ([], false, None)),
                              None),
                           Named (SynIdent (c, None), false, None, (3,9--3,10)),
                          ...
                          (None, Normal, false, false, [], PreXmlDocEmpty,
                           SynValData
                             (None,
                              SynValInfo ([], SynArgInfo ([], false, None)),
                              None),
                           Named (SynIdent (e, None), false, None, (4,9--4,10)),
                           None, Ident f, (4,4--4,14), Yes (4,4--4,14),
                           { LeadingKeyword = AndBang (4,4--4,8)
                             InlineKeyword = None
                             EqualsRange = Some (4,11--4,12)
                             InKeyword = Some (4,15--4,17) })],
                       Const (Unit, (5,4--5,6)), (2,4--5,6)), (1,5--6,1)),
                 (1,0--6,1)), (1,0--6,1))], PreXmlDocEmpty, [], None, (1,0--6,1),
