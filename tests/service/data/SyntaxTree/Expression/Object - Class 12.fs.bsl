ImplFile
  (ParsedImplFileInput
     ("/root/Expression/Object - Class 12.fs", false, QualifiedNameOfFile Module,
      [],
                 ...
                 [Member
                    (SynBinding
                       (None, Normal, false, false, [],
                        ...
                        ArbitraryAfterError ("memberCore1", (4,19--4,19)),
                        (4,12--4,19), NoneAtInvisible,
                        { LeadingKeyword = Member (4,5--4,11)
                          InlineKeyword = None
                          EqualsRange = None }), (4,5--4,19));
                  Member
                    (SynBinding
                       (None, Normal, false, false, [],
...
(4,20)-(5,5) parse error Expecting member body
