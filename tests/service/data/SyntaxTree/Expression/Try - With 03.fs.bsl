ImplFile
  (ParsedImplFileInput
     ("/root/Expression/Try - With 03.fs", false, QualifiedNameOfFile Module, [],
      [],
                 ...
                 (None, Normal, false, false, [],
                  ...
                  TryWith
                    (Const (Int32 1, (4,8--4,9)),
                     [SynMatchClause
                        (Wild (5,9--5,10), None, Const (Int32 2, (6,4--6,5)),
                         (5,9--6,5), Yes, { ArrowRange = Some (5,11--5,13)
                                            BarRange = None })], (4,4--6,5),
                     Yes (4,4--4,7), Yes (5,4--5,8),
                     { TryKeyword = (4,4--4,7)
                       TryToWithRange = (4,4--5,8)
                       WithKeyword = (5,4--5,8)
                       WithToEndRange = (5,4--6,5) }), (3,4--3,5), NoneAtLet,
