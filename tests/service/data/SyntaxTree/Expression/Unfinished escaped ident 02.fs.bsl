ImplFile
  (ParsedImplFileInput
     ("/root/Expression/Unfinished escaped ident 02.fs", false,
                      ...
                      Member
                        (SynBinding
                           (None, Normal, false, false, [],
                            ...
                            LongIdent
                              (SynLongIdent
                                 ([this; ], [(6,15--6,16)], [None; None]), None,
                               None,
                               Pats
                                 [Paren
                                    (Const (Unit, (6,20--6,22)), (6,20--6,22))],
                               None, (6,11--6,22)), None,
                            Const (Unit, (6,25--6,27)), (6,11--6,22),
                            NoneAtInvisible,
                            { LeadingKeyword = Member (6,4--6,10)
                              InlineKeyword = None
                              EqualsRange = Some (6,23--6,24) }), (6,4--6,27))],
                     (4,4--6,27)), [],
                  Some
                    (ImplicitCtor
                       (None, [], SimplePats ([], [], (3,6--3,8)), None,
                        PreXmlDoc ((3,6), FSharp.Compiler.Xml.XmlDocCollector),
                        (3,5--3,6), { AsKeyword = None })), (3,5--6,27),
                  { LeadingKeyword = Type (3,0--3,4)
                    EqualsRange = Some (3,9--3,10)
                    WithKeyword = None })], (3,0--6,27))],
          PreXmlDoc ((1,0), FSharp.Compiler.Xml.XmlDocCollector), [], None,
          (1,0--6,27), { LeadingKeyword = Module (1,0--1,6) })], (true, true),
      { ConditionalDirectives = []
        CodeComments = [] }, set []))

(4,16)-(4,17) parse error This is not a valid identifier
(6,16)-(6,20) parse error This is not a valid identifier
