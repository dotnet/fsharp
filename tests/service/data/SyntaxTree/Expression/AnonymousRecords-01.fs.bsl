      ...
      [SynModuleOrNamespace
         ([AnonymousRecords-01], false, AnonModule,
          [Expr
             (AnonRecd
                (false, None,
                 ...
                 { OpeningBraceRange = (1,0--1,2)
                   WithKeyword = None }), (1,0--1,11));
           Expr
             (AnonRecd
                (true, None,
                 [(SynLongIdent ([Y], [], [None]), Some (2,12--2,13),
                   Const (Int32 2, (2,14--2,15)))], (2,0--2,18),
                 { OpeningBraceRange = (2,7--2,9)
                   WithKeyword = None }), (2,0--2,18));
           Expr
             (AnonRecd
           ...
           Expr
             (AnonRecd
                (false, Some (Null (5,3--5,7), None), [], (5,0--5,10),
                 { OpeningBraceRange = (5,0--5,2)
                   WithKeyword = None }), (5,0--5,10));
           Expr
             (AnonRecd
                (true, Some (Null (6,10--6,14), None), [], (6,0--6,17),
                 { OpeningBraceRange = (6,7--6,9)
                   WithKeyword = None }), (6,0--6,17))], PreXmlDocEmpty, [],
          None, (1,0--6,17), { LeadingKeyword = None })], (true, true),
