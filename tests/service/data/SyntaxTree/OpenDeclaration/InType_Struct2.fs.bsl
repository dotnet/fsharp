ImplFile
  (ParsedImplFileInput
     ("/root/OpenDeclaration/InType_Struct2.fs", false,
      QualifiedNameOfFile InType_Struct2, [],
      [SynModuleOrNamespace
         ([InType_Struct2], false, AnonModule,
          [Types
             ([SynTypeDefn
                 (SynComponentInfo
                    ([{ Attributes =
                     ...
                     [ValField
                        (SynField
                           ([], false, Some a,
                            ...
                            None, (3,4--3,16),
                            { LeadingKeyword = Some (Val (3,4--3,7))
                              MutableKeyword = None }), (3,4--3,16));
                      Open
                        (ModuleOrNamespace
                           (SynLongIdent ([System], [], [None]), (4,9--4,15)),
                         (4,4--4,15));
                      ValField
                        (SynField
                           ([], false, Some b,
