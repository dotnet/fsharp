ImplFile
  (ParsedImplFileInput
     ("/root/OpenDeclaration/InExp_type_do.fs", false,
      QualifiedNameOfFile InExp_type_do, [],
      [SynModuleOrNamespace
         ([InExp_type_do], false, AnonModule,
          [Types
             ([SynTypeDefn
                 (SynComponentInfo
                    ([], None, [], [Foo],
                                  ...
                                  (Type
                                   ...
                                   App
                                     (NonAtomic, false, Ident WriteLine,
                                      ...
                                      (5,8--5,21)))), (2,4--5,21), NoneAtDo,
                             { LeadingKeyword = Do (2,4--2,6)
                               InlineKeyword = None
                               EqualsRange = None })], false, false, (2,4--5,21))],
                     (2,4--5,21)), [],
                  Some
                    (ImplicitCtor
                       (None, [], Const (Unit, (1,8--1,10)), None,
