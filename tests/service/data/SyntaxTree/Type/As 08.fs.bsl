ImplFile
  (ParsedImplFileInput
     ("/root/Type/As 08.fs", false, QualifiedNameOfFile Module, [], [],
...
(3,12)-(5,0) parse error Incomplete structured construct at or before this point in type definition. Expected identifier or other token.
