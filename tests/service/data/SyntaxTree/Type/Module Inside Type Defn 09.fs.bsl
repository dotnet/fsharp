ImplFile
  (ParsedImplFileInput
     ("/root/Type/Module Inside Type Defn 09.fs", false,
                  ...
                  Simple
                    (TypeAbbrev
                       (Ok, LongIdent (SynLongIdent ([C], [], [None])),
                        (14,9--14,10)), (14,9--14,10)), [], None, (14,5--14,10),
                  { LeadingKeyword = Type (14,0--14,4)
                    EqualsRange = Some (14,7--14,8)
                    WithKeyword = None })], (14,0--14,10))],
          PreXmlDoc ((1,0), FSharp.Compiler.Xml.XmlDocCollector), [], None,
          (1,0--14,10), { LeadingKeyword = Module (1,0--1,6) })], (true, true),
