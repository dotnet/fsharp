ImplFile
  (ParsedImplFileInput
     ("/root/Type/Primary ctor 03.fs", false, QualifiedNameOfFile Module, [], [],
...
(3,9)-(5,0) parse error Incomplete structured construct at or before this point in type definition. Expected '=' or other token.
