module MicroPerf.ForLoops.IntegralRanges
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_SByte () =
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_SByte>.StartFinish)>]
    member _.M7 (start, finish) = All.``start..finish``<sbyte> start finish

    [<Benchmark; BenchmarkCategory("SByte", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_SByte>.StartStepFinish)>]
    member _.M8 (start, step, finish) = All.``start..step..finish``<sbyte> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_Byte () =
    member _.StartFinish : obj array seq =
        [
            [|box 0uy; 255uy|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Byte>.StartFinish)>]
    member _.M5 (start, finish) = All.``start..finish``<byte> start finish

    [<Benchmark; BenchmarkCategory("Byte", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Byte>.StartStepFinish)>]
    member _.M6 (start, step, finish) = All.``start..step..finish``<byte> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_Char () =
    member _.StartFinish : obj array seq =
        [
            [|'\000'; '\u7fff'|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Char>.StartFinish)>]
    member _.M7 (start : char) finish = All.``start..finish``<char> start finish

    [<Benchmark; BenchmarkCategory("Char", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Char>.StartStepFinish)>]
    member _.M8 (start : char) step finish = All.``start..step..finish``<char> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_Int16 () =
    member _.StartFinish : obj array seq =
        [
            [|-32768s; 32767s|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Int16>.StartFinish)>]
    member _.M9 (start, finish) = All.``start..finish``<int16> start finish

    [<Benchmark; BenchmarkCategory("Int16", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Int16>.StartStepFinish)>]
    member _.M10 (start, step, finish) = All.``start..step..finish``<int16> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_UInt16 () =
    member _.StartFinish : obj array seq =
        [
            [|box 0us; 32767us|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UInt16>.StartFinish)>]
    member _.M7 (start, finish) = All.``start..finish``<uint16> start finish

    [<Benchmark; BenchmarkCategory("UInt16", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UInt16>.StartStepFinish)>]
    member _.M8 (start, step, finish) = All.``start..step..finish``<uint16> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_Int32 () =
    member _.StartFinish : obj array seq =
        [
            [|-32768; 32767|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Int32>.StartFinish)>]
    member _.M9 (start, finish) = All.``start..finish``<int32> start finish

    [<Benchmark; BenchmarkCategory("Int32", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Int32>.StartStepFinish)>]
    member _.M10 (start, step, finish) = All.``start..step..finish``<int32> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_UInt32 () =
    member _.StartFinish : obj array seq =
        [
            [|0u; 32767u|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UInt32>.StartFinish)>]
    member _.M7 (start, finish) = All.``start..finish``<uint32> start finish

    [<Benchmark; BenchmarkCategory("UInt32", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UInt32>.StartStepFinish)>]
    member _.M9 (start, step, finish) = All.``start..step..finish``<uint32> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_Int64 () =
    member _.StartFinish : obj array seq =
        [
            [|-32768L; 32767L|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Int64>.StartFinish)>]
    member _.M9 (start, finish) = All.``start..finish``<int64> start finish

    [<Benchmark; BenchmarkCategory("Int64", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_Int64>.StartStepFinish)>]
    member _.M10 (start, step, finish) = All.``start..step..finish``<int64> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_UInt64 () =
    member _.StartFinish : obj array seq =
        [
            [|0UL; 32767UL|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UInt64>.StartFinish)>]
    member _.M7 (start, finish) = All.``start..finish``<uint64> start finish

    [<Benchmark; BenchmarkCategory("UInt64", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UInt64>.StartStepFinish)>]
    member _.M8 (start, step, finish) = All.``start..step..finish``<uint64> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_IntPtr () =
    member _.StartFinish : obj array seq =
        [
            [|-32768n; 32767n|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_IntPtr>.StartFinish)>]
    member _.M9 (start, finish) = All.``start..finish``<nativeint> start finish

    [<Benchmark; BenchmarkCategory("IntPtr", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_IntPtr>.StartStepFinish)>]
    member _.M10 (start, step, finish) = All.``start..step..finish``<nativeint> start step finish

[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ForLoops", "IntegralRanges")>]
type ForLoops_IntegralRanges_UIntPtr () =
    member _.StartFinish : obj array seq =
        [
            [|0un; 32767un|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UIntPtr>.StartFinish)>]
    member _.M7 (start, finish) = All.``start..finish``<unativeint> start finish

    [<Benchmark; BenchmarkCategory("UIntPtr", "start..step..finish")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ForLoops_IntegralRanges_UIntPtr>.StartStepFinish)>]
