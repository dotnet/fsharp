module MicroPerf.ComputedCollections.Lists.IntegralRanges
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_SByte () =
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_SByte>.StartFinish)>]
    member _.M7 (start, finish) = All.``[start..finish]``<sbyte> start finish

    [<Benchmark; BenchmarkCategory("SByte", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_SByte>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_Byte () =
    member _.StartFinish : obj array seq =
        [
            [|box 0uy; 255uy|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Byte>.StartFinish)>]
    member _.M5 (start, finish) = All.``[start..finish]``<byte> start finish

    [<Benchmark; BenchmarkCategory("Byte", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Byte>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_Char () =
    member _.StartFinish : obj array seq =
        [
            [|'\000'; '\u7fff'|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Char>.StartFinish)>]
    member _.M7 (start : char) finish = All.``[start..finish]``<char> start finish

    [<Benchmark; BenchmarkCategory("Char", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Char>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_Int16 () =
    member _.StartFinish : obj array seq =
        [
            [|-32768s; 32767s|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Int16>.StartFinish)>]
    member _.M9 (start, finish) = All.``[start..finish]``<int16> start finish

    [<Benchmark; BenchmarkCategory("Int16", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Int16>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_UInt16 () =
    member _.StartFinish : obj array seq =
        [
            [|box 0us; 32767us|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UInt16>.StartFinish)>]
    member _.M7 (start, finish) = All.``[start..finish]``<uint16> start finish

    [<Benchmark; BenchmarkCategory("UInt16", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UInt16>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_Int32 () =
    member _.StartFinish : obj array seq =
        [
            [|-32768; 32767|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Int32>.StartFinish)>]
    member _.M9 (start, finish) = All.``[start..finish]``<int32> start finish

    [<Benchmark; BenchmarkCategory("Int32", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Int32>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_UInt32 () =
    member _.StartFinish : obj array seq =
        [
            [|0u; 32767u|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UInt32>.StartFinish)>]
    member _.M7 (start, finish) = All.``[start..finish]``<uint32> start finish

    [<Benchmark; BenchmarkCategory("UInt32", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UInt32>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_Int64 () =
    member _.StartFinish : obj array seq =
        [
            [|-32768L; 32767L|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Int64>.StartFinish)>]
    member _.M9 (start, finish) = All.``[start..finish]``<int64> start finish

    [<Benchmark; BenchmarkCategory("Int64", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_Int64>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_UInt64 () =
    member _.StartFinish : obj array seq =
        [
            [|0UL; 32767UL|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UInt64>.StartFinish)>]
    member _.M7 (start, finish) = All.``[start..finish]``<uint64> start finish

    [<Benchmark; BenchmarkCategory("UInt64", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UInt64>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_IntPtr () =
    member _.StartFinish : obj array seq =
        [
            [|-32768n; 32767n|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_IntPtr>.StartFinish)>]
    member _.M9 (start, finish) = All.``[start..finish]``<nativeint> start finish

    [<Benchmark; BenchmarkCategory("IntPtr", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_IntPtr>.StartStepFinish)>]
...
[<MemoryDiagnoser; CategoriesColumn; HideColumns("Method"); BenchmarkCategory("ComputedCollections", "Lists", "IntegralRanges")>]
type ComputedCollections_Lists_IntegralRanges_UIntPtr () =
    member _.StartFinish : obj array seq =
        [
            [|0un; 32767un|]
        ]
    ...
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UIntPtr>.StartFinish)>]
    member _.M7 (start, finish) = All.``[start..finish]``<unativeint> start finish

    [<Benchmark; BenchmarkCategory("UIntPtr", "[start..step..finish]")>]
    [<ArgumentsSource(nameof Unchecked.defaultof<ComputedCollections_Lists_IntegralRanges_UIntPtr>.StartStepFinish)>]
