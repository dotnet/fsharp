...
let config configurationName envVars =
    ...
    let fsc_flags = "-r:System.Core -r:netstandard -r:System.Numerics -r:System --nowarn:20 --define:COMPILED"
    let fsi_flags = "-r:System.Core -r:netstandard -r:System.Numerics -r:System --nowarn:20 --define:INTERACTIVE --maxerrors:1 --abortonerror"
