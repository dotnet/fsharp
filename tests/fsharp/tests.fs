...
module CoreTests =
    ...
    // For this, check both with and without legacyemit
    [<Test>]
    let ``printing-default-stdout-50 --langversion:5_0 --legacyemit+`` () =
         printing "--langversion:5.0 --legacyemit+ --debug+ --optimize-" "z.output.test.default.stdout.50.legacyemit.txt" "z.output.test.default.stdout.50.legacyemit.bsl" "z.output.test.default.stderr.legacyemit.txt" "z.output.test.default.stderr.legacyemit.bsl"

    [<Test>]
    let ``printing-default-stdout-50 --langversion:5_0 --legacyemit-`` () =
         printing "--langversion:5.0 --legacyemit- --debug+ --optimize-" "z.output.test.default.stdout.50.legacyemitoff.txt" "z.output.test.default.stdout.50.legacyemitoff.bsl" "z.output.test.default.stderr.legacyemitoff.txt" "z.output.test.default.stderr.legacyemitoff.bsl"
    ...
    [<Test>]
    let ``printing-quiet-stdout --legacyemit+`` () =
    ...
    [<Test>]
    let ``printing-quiet-stdout --legacyemit-`` () =
         printing "--quiet --legacyemit-" "z.output.test.quiet.stdout.txt" "z.output.test.quiet.stdout.bsl" "z.output.test.quiet.stderr.txt" "z.output.test.quiet.stderr.bsl"
