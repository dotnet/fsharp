...
let main _ =
    ...
    0
        ...
        let fsCmpl =
            Compilation.Create(fsharpSource, Exe, options = [|"--langversion:8.0"|], cmplRefs = [csCmpl], name = "Test")
...
let f () =
    CSharpClass.StaticMethod(1, 2)
        ...
        CompilerAssert.CompileWithErrors(fsCmpl, [|
            (FSharpDiagnosticSeverity.Error, 39, (6, 17, 6, 29), "The type 'CSharpClass' does not have a field, property, or member named 'StaticMethod'.")
        |])
...
let f () =
    FSharpClass.StaticMethod(1, 2)
        ...
        CompilerAssert.CompileWithErrors(fsCmpl, [|
            (FSharpDiagnosticSeverity.Error, 39, (11, 17, 11, 29), "The type 'FSharpClass' does not have a field, property, or member named 'StaticMethod'.")
        |])
