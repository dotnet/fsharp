...
neg61.fs(22,13,22,16): typecheck error FS0039: The value or constructor 'zip' is not defined. Maybe you want one of the following: skip, skipWhile, SNI_Packet, id, IChapteredRowset
...
neg61.fs(30,13,30,16): typecheck error FS0039: The value or constructor 'zip' is not defined. Maybe you want one of the following: skip, skipWhile, SNI_Packet, id, IChapteredRowset
...
neg61.fs(56,16,56,19): typecheck error FS0039: The value or constructor 'zip' is not defined. Maybe you want one of the following: skip, skipWhile, SNI_Packet, id, IChapteredRowset
