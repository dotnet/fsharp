...
neg_anon_1.fs(10,27,10,38): typecheck error FS0193: Type constraint mismatch. The type 
    '{| b: int |}'    
...
neg_anon_1.fs(13,27,13,45): typecheck error FS0193: Type constraint mismatch. The type 
    '{| a: int; b: int |}'    
is not compatible with type
    '{| a: int |}'    
