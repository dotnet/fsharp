...
neg45.fs(52,14,52,17): typecheck error FS0039: The field, constructor or member 'Foo' is not defined. Maybe you want one of the following: doSomething, Finalize, ToString, ( |Foo|Bir| ), ReferenceEquals
