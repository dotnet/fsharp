...
neg46.fs(10,8,10,40): typecheck error FS3568: Static bindings cannot be added to extrinsic augmentations. Consider using a 'static member' instead.

neg46.fs(14,8,14,26): typecheck error FS3568: Static bindings cannot be added to extrinsic augmentations. Consider using a 'static member' instead.

neg46.fs(18,8,19,21): typecheck error FS3568: Static bindings cannot be added to extrinsic augmentations. Consider using a 'static member' instead.

neg46.fs(23,8,23,32): typecheck error FS3568: Static bindings cannot be added to extrinsic augmentations. Consider using a 'static member' instead.
