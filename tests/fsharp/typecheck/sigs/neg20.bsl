...
neg20.fs(61,27,61,35): typecheck error FS0001: The type 'B2' is not compatible with the type 'B1'

neg20.fs(62,26,62,33): typecheck error FS0001: The type 'B' is not compatible with the type 'C'
...
neg20.fs(96,26,96,33): typecheck error FS0001: The type 'A' is not compatible with the type 'B'

neg20.fs(99,26,99,33): typecheck error FS0001: The type 'A' is not compatible with the type 'B'
