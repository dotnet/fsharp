...
neg03.fs(148,23,148,26): typecheck error FS0003: This value is of type 'int', which is not a function type. A value is being passed to it as an argument as if it were a function.
