...
neg60.fs(80,22,80,25): typecheck error FS0001: Operator '+' cannot be applied to a tuple type. You may be missing an argument to a function, or the operator may not be in scope. Check that you have opened the correct module or namespace.

neg60.fs(80,19,80,20): typecheck error FS0043: Operator '+' cannot be applied to a tuple type. You may be missing an argument to a function, or the operator may not be in scope. Check that you have opened the correct module or namespace.
