...
type System.SByte with
    ...
    member a.widen () : int16 = int16 a
    [<AllowOverloadByReturnType>]
    member a.widen () : int32 = int32 a
    [<AllowOverloadByReturnType>]
    member a.widen () : int64 = int64 a
    [<AllowOverloadByReturnType>]
    member a.widen () : nativeint = nativeint a
    [<AllowOverloadByReturnType>]
    member a.widen () : single = single a
    [<AllowOverloadByReturnType>]
    member a.widen () : double = double a

type System.Byte with
    [<AllowOverloadByReturnType>]
    member a.widen () : int16 = int16 a
    [<AllowOverloadByReturnType>]
    member a.widen () : uint16 = uint16 a
    [<AllowOverloadByReturnType>]
    member a.widen () : int32 = int32 a
    [<AllowOverloadByReturnType>]
    member a.widen () : uint32 = uint32 a
    [<AllowOverloadByReturnType>]
    member a.widen () : int64 = int64 a
    [<AllowOverloadByReturnType>]
    member a.widen () : uint64 = uint64 a
    [<AllowOverloadByReturnType>]
    member a.widen () : nativeint = nativeint a
    [<AllowOverloadByReturnType>]
    member a.widen () : unativeint = unativeint a
    [<AllowOverloadByReturnType>]
    member a.widen () : single = single a
    [<AllowOverloadByReturnType>]
    member a.widen () : double = double a
...
let inline widen (x: ^T) : ^U = (^T : (member widen : unit -> ^U) (x))
