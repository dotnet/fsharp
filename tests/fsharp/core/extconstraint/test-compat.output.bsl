...
test-compat.fsx(101,22): warning FS0064: This construct causes code to be less generic than indicated by the type annotations. The type variable 'B has been constrained to be type 'TimeSpan'.

test-compat.fsx(99,11): warning FS0064: This construct causes code to be less generic than indicated by the type annotations. The type variable 'C has been constrained to be type 'Complex'.
module TestCompat
...
module CheckNewOverloadsDoneConfusePreviousCode2 = begin
  ...
  val f9 :
    x:System.Numerics.Complex ->
      y:System.TimeSpan -> z:System.Numerics.Complex -> System.Numerics.Complex
end
