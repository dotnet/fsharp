...
test.fsx(71,21,71,23): typecheck error FS3237: Cannot take the address of the value returned from the expression. Assign the returned value to a let-bound value before taking the address.

test.fsx(72,21,72,23): typecheck error FS3237: Cannot take the address of the value returned from the expression. Assign the returned value to a let-bound value before taking the address.

test.fsx(78,21,78,37): typecheck error FS3237: Cannot take the address of the value returned from the expression. Assign the returned value to a let-bound value before taking the address.
...
test.fsx(88,10,88,15): typecheck error FS3239: Byref types are not allowed to have optional type extensions.
