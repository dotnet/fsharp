...
module CheckBoxingSemantics = 
    module StructTest1 = 
        ...
        let x = ref (new Counter())

        let f (x:'a when 'a :> IX) = 
            [ x.ToStringMember(); x.ToStringMember(); x.ToStringMember() ]

        check "vklnvwer0" (f x.Value) ["1"; "1"; "1"]
    ...
    module StructTest2 = 
        ...
        check "vklnvwer0" [ x.contents.ToStringMember(); x.contents.ToStringMember(); x.contents.ToStringMember() ] ["1"; "2"; "3"]
    ...
    module StructTest3 = 
        ...
        let x = Array.init 3 (fun i -> new Counter());
