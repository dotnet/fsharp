...
let _ = test "cewoui2aB" (lazy(f 0)) "0"
let _ = test "cewoui2sB" (lazy(f 0)) "0"
let _ = test "cewoui2dB" (lazy(f 5)) "101"
let _ = test "cewoui2fB" (lazy(f 8)) "1000"
let _ = test "cewoui2gB" (lazy(f 15)) "1111"
let _ = test "cewoui2hB" (lazy(f System.Int32.MinValue)) "10000000000000000000000000000000"
let _ = test "cewoui2jB" (lazy(f 0xffffffff)) "11111111111111111111111111111111"
let _ = test "cewoui2lkB" (lazy(f (System.Int32.MinValue+1))) "10000000000000000000000000000001"
let _ = test "cewoui2lB" (lazy(f System.Int32.MaxValue)) "1111111111111111111111111111111"
let _ = test "cewoui212B" (lazy(f (-1))) "11111111111111111111111111111111"
