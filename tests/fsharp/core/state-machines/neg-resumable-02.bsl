...
neg-resumable-02.fsx(22,9,32,54): ilxgen error FS3512: This state machine is not statically compilable and no alternative is available. A 'let rec' occurred in the resumable code specification. Use an 'if __useResumableCode then <state-machine> else <alternative>' to give an alternative.
