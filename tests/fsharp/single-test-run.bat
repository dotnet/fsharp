...
@echo do :FSC_CORECLR
  ...
  %CLIX% %~d0%~p0..\..\%flavor%\coreclr\Testing\fsharp\core\%TestCaseName%\TestDirectory\corerun.exe %~d0%~p0..\..\%flavor%\coreclr\Testing\fsharp\core\%TestCaseName%\output\test.exe
  dir test.ok > NUL 2>&1 ) || (
