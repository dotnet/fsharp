...
FOR /F "tokens=2* delims=	 " %%A IN ('%REG_SOFTWARE% QUERY "HKLM\Software\Microsoft\Microsoft SDKs\NETFXSDK\4.6\WinSDK-NetFx40Tools" /v InstallationFolder') DO SET CORSDK=%%B
if "%CORSDK%"=="" FOR /F "tokens=2* delims=	 " %%A IN ('%REG_SOFTWARE% QUERY "HKLM\Software\Microsoft\Microsoft SDKs\Windows\v8.1A\WinSDK-NetFx40Tools" /v InstallationFolder') DO SET CORSDK=%%B
if "%CORSDK%"=="" FOR /F "tokens=2* delims=	 " %%A IN ('%REG_SOFTWARE% QUERY "HKLM\Software\Microsoft\Microsoft SDKs\Windows\v8.0A\WinSDK-NetFx40Tools" /v InstallationFolder') DO SET CORSDK=%%B
if "%CORSDK%"=="" FOR /F "tokens=2* delims=	 " %%A IN ('%REG_SOFTWARE% QUERY "HKLM\Software\Microsoft\Microsoft SDKs\Windows\v7.1\WinSDK-NetFx40Tools" /v InstallationFolder') DO SET CORSDK=%%B
if "%CORSDK%"=="" FOR /F "tokens=2* delims=	 " %%A IN ('%REG_SOFTWARE% QUERY "HKLM\Software\Microsoft\Microsoft SDKs\Windows\v7.0A\WinSDK-NetFx40Tools" /v InstallationFolder') DO SET CORSDK=%%B
