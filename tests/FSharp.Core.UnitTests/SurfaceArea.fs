...
Microsoft.FSharp.Core.ExtraTopLevelOperators: T FailWith[T](System.String)
...
Microsoft.FSharp.Control.EventModule: System.Tuple`2[Microsoft.FSharp.Core.FSharpFunc`2[T,Microsoft.FSharp.Core.Unit],Microsoft.FSharp.Control.IEvent`2[Microsoft.FSharp.Control.FSharpHandler`1[T],T]] Create[T]()
...
Microsoft.FSharp.Core.ResultModule: System.Collections.Generic.IEnumerable`1[T] ToSeq[T,TError](Microsoft.FSharp.Core.FSharpResult`2[T,TError])
