...
Microsoft.FSharp.Core.LanguagePrimitives: TResult ExplicitDynamic[T1,TResult](T1)
...
Microsoft.FSharp.Core.LanguagePrimitives: TResult LogicalNotDynamic[T1,TResult](T1)
