...
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: Boolean LessThanBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: Boolean LessThanOrEqualBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T AdditionBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T BitwiseAndBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T BitwiseOrBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T CheckedAdditionBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T CheckedMultiplyBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T CheckedSubtractionBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T CheckedUnaryNegationBuiltIn[T](T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T DivideByIntBuiltIn[T](T, Int32)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T DivisionBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T ExclusiveOrBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T LeftShiftBuiltIn[T](T, Int32)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T LogicalNotBuiltIn[T](T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T ModulusBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T MultiplyBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T RightShiftBuiltIn[T](T, Int32)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T SubtractionBuiltIn[T](T, T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T UnaryNegationBuiltIn[T](T)
Microsoft.FSharp.Core.LanguagePrimitives+BuiltInWitnesses: T2 ExplicitBuiltIn[T1,T2](T1)
