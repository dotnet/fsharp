...
module T_System_Int16 =
    [<CSAttributes.System_Int16(10s, N1 = 10s)>]
    type T1() = class end
    let t1 = (typeof<T1>.GetCustomAttributes(false) |> Array.map (fun x -> x :?> System.Attribute)).[0]
    printfn "%A" t1

    [<CSAttributes.OuterClassWithNestedAttributes.System_Int16(10s, N1 = 10s)>]
    type T2() = class end
    ...
    type A1_System_Int16(typeofResult : System.Type, typedefofResult : System.Type) =
        inherit CSAttributes.System_Int16(10s)
