...
module T_System_String =
    [<CSAttributes.System_String("hello", N1 = "hello")>]
    type T1() = class end
    let t1 = (typeof<T1>.GetCustomAttributes(false) |> Array.map (fun x -> x :?> System.Attribute)).[0]
    printfn "%A" t1

    [<CSAttributes.OuterClassWithNestedAttributes.System_String("hello", N1 = "hello")>]
    type T2() = class end
    ...
    type A1_System_String(typeofResult : System.Type, typedefofResult : System.Type) =
        inherit CSAttributes.System_String("hello")
