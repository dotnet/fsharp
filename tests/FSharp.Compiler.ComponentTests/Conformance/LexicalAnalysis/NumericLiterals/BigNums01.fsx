...
if int32Range <> (-2147483647, FromInt32) then ignore 1

let int64Range      = 9223372036854775807G
if int64Range <> (9223372036854775807L, FromInt64) then ignore 1

let fromStringRange = 12345678901234567890G
if fromStringRange <> ("12345678901234567890", FromString) then ignore 1
