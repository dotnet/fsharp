...
module OperatorNames =
    ...
    [<Theory; FileInlineData("Atat.fsx")>]
    ...
    [<Theory; FileInlineData("AstrSymbOper01.fs")>]
    ...
    [<Theory; FileInlineData("BasicOperatorNames.fs")>]
    ...
    [<Theory; FileInlineData("EqualOperatorsOverloading.fs")>]
    ...
    [<Theory; FileInlineData("E_BasicOperatorNames01.fs")>]
    ...
    [<Theory; FileInlineData("RefAssignment01.fs")>]
