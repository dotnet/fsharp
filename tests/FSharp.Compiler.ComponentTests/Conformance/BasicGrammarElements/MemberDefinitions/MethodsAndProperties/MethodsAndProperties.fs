...
module MemberDefinitions_MethodsAndProperties =
    ...
    let ``E_ActivePatternMember01_fs`` compilation =
        ...
        |> withDiagnostics [
            ...
            (Error 39, Line 21, Col 10, Line 21, Col 13, "The type 'FaaBor' does not have a field, property, or member named 'Foo'.")
        ]
    ...
    let ``E_IndexerNotSpecified01_fs`` compilation =
        ...
        |> shouldFail
        |> withDiagnostics [
            (Error 39, Line 13, Col 9, Line 13, Col 15, "The type 'Foo' does not have a field, property, or member named 'Item'.")
        ]
