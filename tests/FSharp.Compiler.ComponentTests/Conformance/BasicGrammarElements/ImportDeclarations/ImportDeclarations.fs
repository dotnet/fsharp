...
module ImportDeclarations =
    ...
    let ``E_openInTypeDecl_fs`` compilation =
        ...
        |> shouldFail
        |> withDiagnostics [
            (Warning 58, Line 7, Col 5, Line 7, Col 9, "'open' declarations must appear at module level, not inside types.")
    ...
    let ``E_openModInFun_fs`` compilation =
        ...
        |> withDiagnostics [
            ...
            (Warning 58, Line 23, Col 9, Line 23, Col 13, "'open' declarations must appear at module level, not inside types.")
