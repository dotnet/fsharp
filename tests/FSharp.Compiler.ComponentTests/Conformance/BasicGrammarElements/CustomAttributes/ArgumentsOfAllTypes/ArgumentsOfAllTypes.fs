...
module CustomAttributes_ArgumentsOfAllTypes =
    ...
    [<Theory; FileInlineData("System_Int16_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Int32_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Int64_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_UInt16_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_UInt32_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_UInt64_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Char_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Byte_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_SByte_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Single_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Double_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_String_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_DateTimeKind_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Type_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_Object_Consumer.fsx")>]
    ...
    [<Theory; FileInlineData("System_TypeArray_Consumer.fsx")>]
