...
module T_System_Object =
    [<CSAttributes.System_Object(110, N1 = 110)>]
    type T1() = class end
    let t1 = (typeof<T1>.GetCustomAttributes(false) |> Array.map (fun x -> x :?> System.Attribute)).[0]
    printfn "%A" t1

    [<CSAttributes.OuterClassWithNestedAttributes.System_Object(110, N1 = 110)>]
    type T2() = class end
    ...
    type A1_System_Object(typeofResult : System.Type, typedefofResult : System.Type) =
        inherit CSAttributes.System_Object(110)
