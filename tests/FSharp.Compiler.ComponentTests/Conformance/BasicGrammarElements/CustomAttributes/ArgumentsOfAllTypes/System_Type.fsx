...
module T_System_Type =
    [<CSAttributes.System_Type(null, N1 = null)>]
    type T1() = class end
    let t1 = (typeof<T1>.GetCustomAttributes(false) |> Array.map (fun x -> x :?> System.Attribute)).[0]
    printfn "%A" t1

    [<CSAttributes.OuterClassWithNestedAttributes.System_Type(null, N1 = null)>]
    type T2() = class end
    ...
    type A1_System_Type(typeofResult : System.Type, typedefofResult : System.Type) =
        inherit CSAttributes.System_Type(null)
