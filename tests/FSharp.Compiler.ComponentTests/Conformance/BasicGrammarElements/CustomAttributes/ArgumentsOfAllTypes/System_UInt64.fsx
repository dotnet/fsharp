...
module T_System_UInt64 =
    [<CSAttributes.System_UInt64(18446744073709551615UL, N1 = 18446744073709551615UL)>]
    type T1() = class end
    let t1 = (typeof<T1>.GetCustomAttributes(false) |> Array.map (fun x -> x :?> System.Attribute)).[0]
    printfn "%A" t1

    [<CSAttributes.OuterClassWithNestedAttributes.System_UInt64(18446744073709551615UL, N1 = 18446744073709551615UL)>]
    type T2() = class end
    ...
    type A1_System_UInt64(typeofResult : System.Type, typedefofResult : System.Type) =
        inherit CSAttributes.System_UInt64(18446744073709551615UL)
