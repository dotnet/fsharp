...
module CustomAttributes_AttributeUsage =
    ...
    let ``E_AttributeTargetIsField01_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
    ...
    let ``E_AttributeTargetIsMethod02_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> withOptions ["--nowarn:25"]
        |> verifyCompile
    ...
    let ``E_AttributeTargetIsMethod03_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> withOptions ["--nowarn:25"]
        |> verifyCompile
    ...
    let ``E_AttributeTargetIsClass_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldSucceed
    ...
    let ``E_AttributeTargetIsClass01_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldSucceed
    ...
    let ``E_AttributeTargetIsField03_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldFail
    ...
    let ``E_AttributeTargetIsProperty01_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldSucceed
    ...
    let ``E_AttributeTargetIsCtor01_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldSucceed
    ...
    let ``E_AttributeTargetIsEnum01_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldSucceed
...
type InterruptibleLazy<'T> private (valueFactory: unit -> 'T) =
    ...
    let ``E_AttributeTargetIsInterface_fs 8.0`` compilation =
        compilation
        |> withLangVersion80
        |> verifyCompile
        |> shouldSucceed
