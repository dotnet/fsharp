...
module CustomAttributes_Basic =
    ...
    [<Theory; FileInlineData("ArrayParam.fs")>]
    ...
    [<Theory; FileInlineData("AttribWithEnumFlags01.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication01.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication02.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication03.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication04.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication05.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication06.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeApplication07.fs")>]
    ...
    [<Theory; FileInlineData("E_AttributeTargetSpecifications.fs")>]
    ...
    [<Theory; FileInlineData("E_StructLayout.fs")>]
    ...
    [<Theory; FileInlineData("E_StructLayoutSequentialNeg_AbstractClass.fs")>]
    ...
    [<Theory; FileInlineData("E_StructLayoutSequentialNeg_DU1.fs")>]
    ...
    [<Theory; FileInlineData("E_StructLayoutSequentialNeg_DU2.fs")>]
    ...
    [<Theory; FileInlineData("E_StructLayoutSequentialNeg_Delegate.fs")>]
    ...
    [<Theory; FileInlineData("E_StructLayoutSequentialNeg_Interface.fs")>]
    ...
    [<Theory; FileInlineData("E_UseNullAsTrueValue01.fs")>]
    ...
    [<Theory; FileInlineData("FreeTypeVariable01.fs")>]
    ...
    [<Theory; FileInlineData("Function01.fs")>]
    ...
    [<Theory; FileInlineData("FunctionArg01.fs")>]
    ...
    [<Theory; FileInlineData("InExternDecl.fs")>]
    ...
    [<Theory; FileInlineData("ParamArrayAttrUsage.fs")>]
    ...
    [<Theory; FileInlineData("ReturnType01.fs")>]
    ...
    [<Theory; FileInlineData("ReturnType02.fs")>]
    ...
    [<Theory; FileInlineData("ReturnType03.fs")>]
    ...
    [<Theory; FileInlineData("StructLayout.fs")>]
    ...
    [<Theory; FileInlineData("StructLayoutSequentialPos_Exception.fs")>]
    ...
    [<Theory; FileInlineData("TypeofTypedefofInAttribute.fs")>]
    ...
    [<Theory; FileInlineData("TypesAsAttrArgs01.fs")>]
    ...
    [<Theory; FileInlineData("W_ReturnType03b.fs")>]
    ...
    [<Theory; FileInlineData("W_StructLayoutExplicit01.fs")>]
    ...
    [<Theory; FileInlineData("W_StructLayoutSequentialPos_AbstractClass.fs")>]
    ...
    [<Theory; FileInlineData("W_StructLayoutSequentialPos_ClassnoCtr.fs")>]
    ...
    [<Theory; FileInlineData("W_StructLayoutSequentialPos_Record.fs")>]
    ...
    [<Theory; FileInlineData("EnsureValidCustomAttributeBlob.fs")>]
