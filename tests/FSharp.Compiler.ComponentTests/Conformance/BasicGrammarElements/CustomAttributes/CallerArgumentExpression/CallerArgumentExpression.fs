...
type A() =
  ...
  static member B (``ab c``, [<CallerArgumentExpression "n">]  ?n) =
    defaultArg n "no value"
        ...
        |> shouldFail
        |> withDiagnostics [
          (Warning 3892,Line 5, Col 65, Line 5, Col 66, "The [<CallerArgumentExpression>] on this parameter will have no effect because it's applied with an invalid parameter name.")
          (Warning 3891,Line 7, Col 65 , Line 7, Col 66, "The [<CallerArgumentExpression>] on this parameter will have no effect because it's self-referential.")
        ]
...
f()
        ...
        |> shouldFail
        |> withDiagnostics [
          (Warning 3893, Line 5, Col 75, Line 5, Col 76, "The [<CallerArgumentExpression>] on this parameter will have no effect because it's overridden by the [<CallerMemberName>].")
          (Warning 3893, Line 7, Col 73, Line 7, Col 74, "The [<CallerArgumentExpression>] on this parameter will have no effect because it's overridden by the [<CallerFilePath>].")
          ...
          (Warning 3893, Line 9, Col 91, Line 9, Col 92, "The [<CallerArgumentExpression>] on this parameter will have no effect because it's overridden by the [<CallerFilePath>].")
        ]
...
f "abc" |> assertEqual "no value"
        ...
        |> shouldFail
        |> withDiagnostics [
          (Information 3894, Line 12, Col 2, Line 12, Col 5, "This usage blocks passing string representations of arguments to parameters annotated with [<CallerArgumentExpression>]. The default values of these parameters will be passed. Only the usages like `Method(arguments)` can capture the string representation of arguments. You can disable this warning by using '#nowarn \"3894\"' or '--nowarn:3894'.")
          (Information 3894, Line 13, Col 10, Line 13, Col 13, "This usage blocks passing string representations of arguments to parameters annotated with [<CallerArgumentExpression>]. The default values of these parameters will be passed. Only the usages like `Method(arguments)` can capture the string representation of arguments. You can disable this warning by using '#nowarn \"3894\"' or '--nowarn:3894'.")
          (Information 3894, Line 14, Col 1, Line 14, Col 4, "This usage blocks passing string representations of arguments to parameters annotated with [<CallerArgumentExpression>]. The default values of these parameters will be passed. Only the usages like `Method(arguments)` can capture the string representation of arguments. You can disable this warning by using '#nowarn \"3894\"' or '--nowarn:3894'.")
          (Information 3894, Line 15, Col 9, Line 15, Col 12, "This usage blocks passing string representations of arguments to parameters annotated with [<CallerArgumentExpression>]. The default values of these parameters will be passed. Only the usages like `Method(arguments)` can capture the string representation of arguments. You can disable this warning by using '#nowarn \"3894\"' or '--nowarn:3894'.")
        ]
        |> ignore
