...
module NameOf =
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfIntConst.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfStringConst.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfAppliedFunction.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfIntegerAppliedFunction.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfPartiallyAppliedFunction.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfDictLookup.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfParameterAppliedFunction.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfAsAFunction.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfWithPipe.fs")>]
    ...
    [<Theory(Skip = "Language version 5.0 is out of support"); FileInlineData("E_NameOfUnresolvableName.fs")>]
