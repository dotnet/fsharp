...
//<Expects status="error" span="(12,13-12,14)" id="FS0001">The types 'unit, int' do not support the operator</Expects>
//<Expects status="error" span="(12,18-12,24)" id="FS0001">The types 'unit, int' do not support the operator</Expects>
