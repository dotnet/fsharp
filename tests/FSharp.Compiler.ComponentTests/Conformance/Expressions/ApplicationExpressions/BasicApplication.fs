...
module BasicApplication =
    ...
    [<Theory; Directory(__SOURCE_DIRECTORY__ + "/../../../resources/tests/Conformance/Expressions/ApplicationExpressions/BasicApplication", Includes=[|"PostfixType02.fs"|])>]
    ...
    [<Theory; Directory(__SOURCE_DIRECTORY__ + "/../../../resources/tests/Conformance/Expressions/ApplicationExpressions/BasicApplication", Includes=[|"E_PostfixType01.fs"|])>]
    ...
    [<Theory; Directory(__SOURCE_DIRECTORY__ + "/../../../resources/tests/Conformance/Expressions/ApplicationExpressions/BasicApplication", Includes=[|"E_PostfixType03.fs"|])>]
