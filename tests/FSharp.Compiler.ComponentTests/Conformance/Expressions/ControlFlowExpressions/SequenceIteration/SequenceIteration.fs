...
module SequenceIteration =
    ...
    let ``W_IncompleteMatchFor01_fs`` compilation =
        ...
        |> withDiagnostics [
            ...
            (Warning 25, Line 17, Col 5, Line 17, Col 6, "Incomplete pattern matches on this expression. Did you use a constant where a loop variable was expected? For example, the value '0' may indicate a case not covered by the pattern(s). Unmatched elements will be ignored.")
