...
//<Expects span="(10,10-10,11)" status="error" id="FS0800">Invalid use of a type name</Expects>
//<Expects span="(11,10-11,11)" status="error" id="FS0800">Invalid use of a type name</Expects>
type S(x:S) = struct
              end
