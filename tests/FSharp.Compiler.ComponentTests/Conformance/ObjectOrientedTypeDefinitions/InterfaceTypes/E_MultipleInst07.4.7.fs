...
//<Expects status="error" id="FS3350" span="(14,6-14,7)">Feature 'interfaces with multiple generic instantiation' is not available in F# 4.7. Please use language version 5.0 or greater.</Expects>
