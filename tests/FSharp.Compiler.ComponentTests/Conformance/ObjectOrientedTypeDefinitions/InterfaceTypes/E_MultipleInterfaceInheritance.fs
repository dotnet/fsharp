...
//<Expects id="FS0039" status="error" span="(41,7-41,9)">The type 'T' does not have a field, property, or member named 'Me'</Expects>
//<Expects id="FS0039" status="error" span="(45,7-45,9)">The type 'T' does not have a field, property, or member named 'Me'</Expects>
//<Expects id="FS0039" status="error" span="(49,7-49,11)">The type 'T' does not have a field, property, or member named 'Home'</Expects>
