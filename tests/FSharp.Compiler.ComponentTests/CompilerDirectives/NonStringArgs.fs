    ...
    square 32
        ...
        if langVersion = "8.0" then
            ...
            |> withDiagnostics [
                ...
                (Warning 3350, Line 2, Col 26, Line 2, Col 34, "Feature '# directives with non-quoted string arguments' is not available in F# 8.0. Please use language version 9.0 or greater.")
