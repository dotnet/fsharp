...
let x = { Person.Names = "Isaac" }
        ...
        |> withSingleDiagnostic (Error 39, Line 4, Col 18, Line 4, Col 23,
                                 ("The type 'Person' does not have a field, property, or member named 'Names'. Maybe you want one of the following:" + Environment.NewLine + "   Name"))
...
let x = N.MyUnion.``My Case2``
        ...
        |> withSingleDiagnostic (Error 39, Line 9, Col 19, Line 9,Col 31,
                                 ("The type 'MyUnion' does not have a field, property, or member named 'My Case2'. Maybe you want one of the following:" + Environment.NewLine + "   Case2" + Environment.NewLine + "   ``My Case1``" + Environment.NewLine + "   IsMy Case1"))
...
module Test2 =
    ...
    D.Method2()
        ...
        |> withSingleDiagnostic (Error 39, Line 9, Col 7, Line 9, Col 14,
                                 ("The type 'D' does not have a field, property, or member named 'Method2'. Maybe you want one of the following:" + Environment.NewLine + "   Method1"))
...
let x = r.ello
        ...
        |> withSingleDiagnostic (Error 39, Line 6, Col 11, Line 6, Col 15,
                                 ("The type 'MyRecord' does not have a field, property, or member named 'ello'. Maybe you want one of the following:" + Environment.NewLine + "   Hello"))
...
let u = MyUnion.AntherCase
        ...
        |> withSingleDiagnostic (Error 39, Line 6, Col 17, Line 6, Col 27,
                                 ("The type 'MyUnion' does not have a field, property, or member named 'AntherCase'. Maybe you want one of the following:" + Environment.NewLine + "   AnotherCase" + Environment.NewLine + "   IsAnotherCase"))
...
let x =
    ...
    | _ -> 2
        ...
        |> withSingleDiagnostic (Error 39, Line 11, Col 15, Line 11, Col 19,
                                 ("The type 'MyUnion' does not have a field, property, or member named 'Cas1'. Maybe you want one of the following:" + Environment.NewLine + "   Case1" + Environment.NewLine + "   Case2"))
