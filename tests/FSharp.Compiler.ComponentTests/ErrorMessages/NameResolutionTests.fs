...
"""
    ...
    let MultipleRecdTypeChoiceWarningWith1AlternativeLangPreview () =
        ...
        |> withDiagnostics [
            ...
            (Error 39, Line 22, Col 15, Line 22, Col 19, "The type 'OtherThing' does not have a field, property, or member named 'City'.")
        ]
...
"""
    ...
    let MultipleRecdTypeChoiceWarningWith2AlternativeLangPreview () =
        ...
        |> withDiagnostics [
            ...
            (Error 39, Line 33, Col 15, Line 33, Col 19, "The type 'OtherThing' does not have a field, property, or member named 'City'.")
        ]
