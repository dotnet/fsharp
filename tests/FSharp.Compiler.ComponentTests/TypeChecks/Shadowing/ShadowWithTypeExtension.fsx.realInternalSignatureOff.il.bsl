       ...
       extends [runtime]System.Object
{
  ...
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 07 00 00 00 00 00 ) 
    .method public static class assembly/Foo assembly$Foo$X(class assembly/Foo f, int32 i) cil managed
    {
  ...
  .method assembly specialname static class assembly/Foo get_f@8() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldsfld     class assembly/Foo '<StartupCode$assembly>'.$assembly$fsx::'f@8-1'
    IL_0005:  ret
  } 
...
.class private abstract auto ansi sealed '<StartupCode$assembly>'.$assembly$fsx
       extends [runtime]System.Object
{
  .field static assembly initonly class assembly/Foo f@11
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  .field static assembly initonly class assembly/Foo 'f@8-1'
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  .field static assembly initonly class assembly/Foo 'f@8-2'
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  ...
  .method private specialname rtspecialname static void  .cctor() cil managed
  {
    ...
    IL_0005:  stsfld     class assembly/Foo '<StartupCode$assembly>'.$assembly$fsx::f@11
    ...
    IL_0040:  stsfld     class assembly/Foo '<StartupCode$assembly>'.$assembly$fsx::'f@8-2'
    ...
    IL_0055:  stsfld     class assembly/Foo '<StartupCode$assembly>'.$assembly$fsx::'f@8-1'
