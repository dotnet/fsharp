       ...
       extends [runtime]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_000e:  ldc.i4.1
    IL_000f:  call       void assembly/Foo::set_X(int32)
    IL_0014:  call       int32 assembly/Foo::get_X()
    IL_0019:  ldc.i4.1
    IL_001a:  beq.s      IL_0024

    IL_001c:  ldc.i4.1
    IL_001d:  call       void [runtime]System.Environment::Exit(int32)
    IL_0022:  br.s       IL_0024

    IL_0024:  ldc.i4.4
    IL_0025:  call       void assembly/Foo::set_X(int32)
    IL_002a:  call       int32 assembly/Foo::get_X()
    IL_002f:  ldc.i4.4
    IL_0030:  beq.s      IL_003a

    IL_0032:  ldc.i4.2
    IL_0033:  call       void [runtime]System.Environment::Exit(int32)
