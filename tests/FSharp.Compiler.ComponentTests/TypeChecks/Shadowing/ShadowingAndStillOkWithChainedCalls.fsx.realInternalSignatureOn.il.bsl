       ...
       extends [runtime]System.Object
{
  ...
  .method public specialname static class assembly/Foo get_f() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldsfld     class assembly/Foo assembly::f@17
    IL_0005:  ret
  } 

  .method assembly specialname static class assembly/Foo get_f@10() cil managed
  {
    
    .maxstack  8
    IL_0000:  ldsfld     class assembly/Foo assembly::'f@10-1'
    IL_0005:  ret
  } 

  .method assembly specialname static class assembly/Foo 'get_f@10-1'() cil managed
  {
  ...
  .method assembly specialname static void staticInitialization@() cil managed
  {
    ...
    IL_0005:  stsfld     class assembly/Foo assembly::f@17
    ...
    IL_0040:  stsfld     class assembly/Foo assembly::'f@10-2'
    ...
    IL_0055:  stsfld     class assembly/Foo assembly::'f@10-1'
