...
//<Expects id="FS0086" span="(8,6-8,8)" status="warning">The '||' operator should not normally be redefined\. Consider using a different operator name\.</Expects>
//<Expects id="FS0086" span="(9,8-9,10)" status="warning">The '||' operator should not normally be redefined\. Consider using a different operator name\.</Expects>
