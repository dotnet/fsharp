...
//<Expects id="FS0023" span="(14,17-14,27)" status="error">The member 'ClashingID' can not be defined because the name 'ClashingID' clashes with the union case 'ClashingID' in this type or module</Expects>
