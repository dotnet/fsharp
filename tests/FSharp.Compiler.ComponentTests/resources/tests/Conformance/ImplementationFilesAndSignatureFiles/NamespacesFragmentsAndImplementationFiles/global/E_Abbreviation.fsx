...
//<Expects status="error" id="FS0053" span="(6,18-6,24)">Lowercase discriminated union cases are only allowed when using RequireQualifiedAccess attribute</Expects>
