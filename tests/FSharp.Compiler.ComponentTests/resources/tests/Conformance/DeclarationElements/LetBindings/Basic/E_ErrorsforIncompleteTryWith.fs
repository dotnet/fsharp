...
//<Expects status="warning" span="(10,1-10,5)" id="FS0058">Possible incorrect indentation: this token is offside of context started at position \(9:5\)\. Try indenting this token further or using standard formatting conventions\.$</Expects>
