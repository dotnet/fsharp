...
"""
        ...
        |> compile
        |> shouldFail
        |> withSingleDiagnostic (Error 39, Line 2, Col 36, Line 2, Col 47, "The type 'OuterClass' does not have a field, property, or member named 'InnerClass_'.")
...
"""
        ...
        |> compile
        |> shouldFail
        |> withSingleDiagnostic (Error 39, Line 2, Col 47, Line 2, Col 62, "The type 'InnerClass' does not have a field, property, or member named 'MoareInnerClass'.")
...
"""
        ...
        |> compile
        |> shouldFail
        |> withSingleDiagnostic ((Error 39, Line 2, Col 62, Line 2, Col 75, """The type 'MoreInnerClass' does not have a field, property, or member named 'somefunction_'. Maybe you want one of the following:
   somefunction"""))
