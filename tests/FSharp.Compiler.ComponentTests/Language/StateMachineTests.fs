...
.method public strict virtual instance void MoveNext() cil managed
{
  ...
  .try
  {
    ...
    IL_0034:  leave.s    IL_0051

    IL_0036:  leave.s    IL_0051
  ...
  catch [runtime]System.Object 
  {
    IL_0038:  stloc.s    V_4
    IL_003a:  ldloc.s    V_4
    IL_003c:  isinst     [runtime]System.Exception
    IL_0041:  dup
    IL_0042:  brtrue.s   IL_004c

    IL_0044:  pop
    IL_0045:  ldloc.s    V_4
    IL_0047:  newobj     instance void [runtime]System.Runtime.CompilerServices.RuntimeWrappedException::.ctor(object)
    IL_004c:  stloc.3
    IL_004d:  ldloc.3
    IL_004e:  stloc.1
  ...
  IL_0052:  stloc.3
  IL_0053:  ldloc.3
  IL_0054:  brtrue.s   IL_0057

  IL_0056:  ret

  IL_0057:  ldarg.0
  IL_0058:  ldflda     valuetype [FSharp.Core]Microsoft.FSharp.Control.TaskStateMachineData`1<int32> TestStateMachine/test@3::Data
  IL_005d:  ldflda     valuetype [runtime]System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1<!0> valuetype [FSharp.Core]Microsoft.FSharp.Control.TaskStateMachineData`1<int32>::MethodBuilder
  IL_0062:  ldloc.3
  IL_0063:  call       instance void valuetype [netstandard]System.Runtime.CompilerServices.AsyncTaskMethodBuilder`1<int32>::SetException(class [netstandard]System.Exception)
  IL_0068:  ret
} 
""" ]
