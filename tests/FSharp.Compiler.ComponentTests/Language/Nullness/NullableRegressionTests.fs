...
let ``Signature conformance`` langVersion checknulls =
    ...
    |> shouldFail
    |> withDiagnostics
        [Warning 3262, Line 18, Col 55, Line 18, Col 60, "Value known to be without null passed to a function meant for nullables: You can create 'Some value' directly instead of 'ofObj', or consider not using an option for this value."
