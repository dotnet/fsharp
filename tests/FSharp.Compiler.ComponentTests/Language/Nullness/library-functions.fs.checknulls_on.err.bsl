...
library-functions.fs (17,27)-(17,38) typecheck error Nullness warning: A non-nullable String was expected but this expression is nullable, which is not permitted. Consider either changing the target to be a nullable String, or use pattern matching to safely handle the null case.
library-functions.fs (18,28)-(18,39) typecheck error Nullness warning: A non-nullable String was expected but this expression is nullable, which is not permitted. Consider either changing the target to be a nullable String, or use pattern matching to safely handle the null case.
...
library-functions.fs (37,17)-(37,21) typecheck error Nullness warning: A non-nullable String was expected but this expression is nullable, which is not permitted. Consider either changing the target to be a nullable String, or use pattern matching to safely handle the null case.
