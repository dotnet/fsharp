...
module Language.RecordSpreadsTests
...
module NominalAndAnonymousRecords =
    ...
    module Parsing =
        ...
        let ``{ ...r with } → error`` () =
            ...
            |> shouldFail
            |> withDiagnostics [
                Error 3903, Line 4, Col 28, Line 4, Col 31, "The spread operator '...' is not supported in this position. Use one of the forms { ...expr1; A = expr2 } or { expr1 with A = expr2 } instead."
                Error 3903, Line 5, Col 29, Line 5, Col 32, "The spread operator '...' is not supported in this position. Use one of the forms { ...expr1; A = expr2 } or { expr1 with A = expr2 } instead."
            ]
        ...
        let ``seq {...} → error`` () =
            ...
            |> withDiagnostics [
                ...
                Error 3902, Line 7, Col 34, Line 7, Col 37, "The spread operator '...' is not supported in this construct."
            ]
        ...
        let ``custom {...} → error`` () =
            ...
            |> withDiagnostics [
                ...
                Error 3902, Line 16, Col 37, Line 16, Col 40, "The spread operator '...' is not supported in this construct."
            ]
        ...
        let ``[ ... ] → error`` () =
            ...
            |> shouldFail
            |> withDiagnostics [
                Error 3902, Line 3, Col 27, Line 3, Col 30, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 4, Col 27, Line 4, Col 30, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 5, Col 27, Line 5, Col 30, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 5, Col 34, Line 5, Col 37, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 6, Col 27, Line 6, Col 30, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 7, Col 30, Line 7, Col 33, "The spread operator '...' is not supported in this construct."
            ]
        ...
        let ``[| ... |] → error`` () =
            ...
            |> shouldFail
            |> withDiagnostics [
                Error 3902, Line 3, Col 28, Line 3, Col 31, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 4, Col 28, Line 4, Col 31, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 5, Col 28, Line 5, Col 31, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 5, Col 35, Line 5, Col 38, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 6, Col 28, Line 6, Col 31, "The spread operator '...' is not supported in this construct."
                Error 3902, Line 7, Col 31, Line 7, Col 34, "The spread operator '...' is not supported in this construct."
            ]
...
'string' "
        ...
        module BackCompat =
            ...
            let ``Inference works the same`` () =
                let src =
                    ...
                    #nowarn FS3898 // Spread shadowing explicit.
    ...
    module NominalRecordExpressionSpreads =
        ...
        module WithAndSpreads =
            [<Fact>]
            let ``With and spreads cannot be used together`` () =
                let src =
                    """
                    type R = { A : int }
        ...
        module FieldResolution =
            [<Fact>]
            let ``Fields from spreads whose names are not in scope are still resolved`` () =
                let src =
                    """
                    module M =
                        type Source = { X : int; Y : int }
                        let source = { X = 1; Y = 2 }

                    let a = { ...M.source }
                    let b : M.Source = { ...M.source }
                    let c = {| ...M.source |}
                    """
            ...
            [<Fact>]
            let ``Fields from spreads whose names are not in scope are still resolved: mixed spreads and fields`` () =
                let src =
                    """
                    module M =
                        type Source = { X : int; Y : int }
            ...
            [<Fact>]
            let ``Fields from spreads whose names are not in scope are still resolved: total shadowing`` () =
                let src =
                    """
                    module M =
                        type Source = { X : int; Y : int }
                    ...
                    let a = { ...M.source; X = 3; Y = 4 }
                    let b : M.Source = { ...M.source; X = 3; Y = 4 }
                    let c = {| ...M.source; X = 3; Y = 4 |}
                    """
