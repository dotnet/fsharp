...
module ``fsharpqa migrated tests`` =
    ...
    let [<FactForDESKTOP>] ``Conformance\Inference (E_OneTypeVariable03_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_OneTypeVariable03"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_OneTypeVariable03rec_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_OneTypeVariable03rec"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_TwoDifferentTypeVariablesGen00_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_TwoDifferentTypeVariablesGen00"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_TwoDifferentTypeVariables01_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_TwoDifferentTypeVariables01"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_TwoDifferentTypeVariables01rec_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_TwoDifferentTypeVariables01rec"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_TwoDifferentTypeVariablesGen00rec_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_TwoDifferentTypeVariablesGen00rec"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_TwoEqualTypeVariables02_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_TwoEqualTypeVariables02"
    let [<FactForDESKTOP>] ``Conformance\Inference (E_TwoEqualTypeVariables02rec_fs)`` () = singleVersionedNegTest ("conformance/inference") LangVersion.V11 "E_TwoEqualTypeVariables02rec"
...
module ``error messages using BCL``=
    ...
    let [<FactForDESKTOP>] ``neg_System_Threading_Tasks_Task_Run_OverloadList``() = singleVersionedNegTest ("typecheck/overloads") LangVersion.V11 "neg_System.Threading.Tasks.Task.Run.OverloadList"
