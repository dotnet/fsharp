...
module noframework =
    ...
    [<Theory; Directory(__SOURCE_DIRECTORY__ + "/../../resources/tests/CompilerOptions/fsc/noframework", Includes=[|"noframework01.fs"|])>]
    let ``noframework - noframework01.fs - `` compilation =
        compilation
        |> typecheck
        |> shouldSucceed
