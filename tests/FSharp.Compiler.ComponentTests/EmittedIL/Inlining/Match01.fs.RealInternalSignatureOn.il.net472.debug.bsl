                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,int32>
    {
      ...
      .method public strict virtual instance int32 Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
      {
        ...
        IL_005c:  stloc.s    V_4
        IL_005e:  ldloc.2
        IL_005f:  ldfld      int32 assembly/Test1/X11::item
        IL_0064:  stloc.s    V_5
        IL_0066:  ldloc.3
        IL_0067:  ldfld      int32 assembly/Test1/X11::item
        IL_006c:  stloc.s    V_6
        IL_006e:  ldloc.s    V_5
        IL_0070:  ldloc.s    V_6
        IL_0072:  cgt
        ...
        IL_009b:  stloc.s    V_4
        IL_009d:  ldloc.s    V_7
        IL_009f:  ldfld      int32 assembly/Test1/X12::item
        IL_00a4:  stloc.s    V_5
        IL_00a6:  ldloc.s    V_8
        ...
        IL_00dc:  stloc.s    V_4
        IL_00de:  ldloc.s    V_9
        IL_00e0:  ldfld      int32 assembly/Test1/X13::item
        IL_00e5:  stloc.s    V_5
        IL_00e7:  ldloc.s    V_10
        IL_00e9:  ldfld      int32 assembly/Test1/X13::item
        IL_00ee:  stloc.s    V_6
        IL_00f0:  ldloc.s    V_5
        IL_00f2:  ldloc.s    V_6
        IL_00f4:  cgt
        ...
        IL_0121:  ldfld      int32 assembly/Test1/X14::item
        IL_0126:  stloc.s    V_5
        IL_0128:  ldloc.s    V_12
        IL_012a:  ldfld      int32 assembly/Test1/X14::item
        IL_012f:  stloc.s    V_6
        IL_0131:  ldloc.s    V_5
        IL_0133:  ldloc.s    V_6
        IL_0135:  cgt
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,int32>
    {
      ...
      .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
      .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      .method assembly specialname rtspecialname instance void  .ctor(class assembly/Test1 this, class assembly/Test1 objTemp) cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
        .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
        ...
        IL_000d:  ldarg.0
        IL_000e:  ldarg.2
        IL_000f:  stfld      class assembly/Test1 assembly/Test1/'clo@4-1'::objTemp
        IL_0014:  ret
      } 
      ...
      .method public strict virtual instance int32 Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
      {
        ...
        .locals init (int32 V_0,
                 ...
                 class assembly/Test1/X14 V_11)
        IL_0000:  ldarg.0
        IL_0001:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::this
        IL_0006:  ldfld      int32 assembly/Test1::_tag
        IL_000b:  stloc.0
        IL_000c:  ldarg.0
        IL_000d:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::objTemp
        IL_0012:  ldfld      int32 assembly/Test1::_tag
        IL_0017:  stloc.1
        IL_0018:  ldloc.0
        IL_0019:  ldloc.1
        ...
        IL_001f:  ldarg.0
        IL_0020:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::this
        IL_0025:  call       instance int32 assembly/Test1::get_Tag()
        IL_002a:  switch     ( 
                              IL_003f,
                              IL_0075,
                              ...
                              IL_00e9)
        IL_003f:  ldarg.0
        IL_0040:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::this
        IL_0045:  castclass  assembly/Test1/X11
        IL_004a:  stloc.2
        IL_004b:  ldarg.0
        IL_004c:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::objTemp
        IL_0051:  castclass  assembly/Test1/X11
        IL_0056:  stloc.3
        IL_0057:  ldloc.2
        IL_0058:  ldfld      int32 assembly/Test1/X11::item
        IL_005d:  stloc.s    V_4
        IL_005f:  ldloc.3
        IL_0060:  ldfld      int32 assembly/Test1/X11::item
        IL_0065:  stloc.s    V_5
        IL_0067:  ldloc.s    V_4
        IL_0069:  ldloc.s    V_5
        IL_006b:  cgt
        ...
        IL_0075:  ldarg.0
        IL_0076:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::this
        IL_007b:  castclass  assembly/Test1/X12
        IL_0080:  stloc.s    V_6
        IL_0082:  ldarg.0
        IL_0083:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::objTemp
        IL_0088:  castclass  assembly/Test1/X12
        IL_008d:  stloc.s    V_7
        IL_008f:  ldloc.s    V_6
        IL_0091:  ldfld      int32 assembly/Test1/X12::item
        IL_0096:  stloc.s    V_4
        IL_0098:  ldloc.s    V_7
        IL_009a:  ldfld      int32 assembly/Test1/X12::item
        IL_009f:  stloc.s    V_5
        IL_00a1:  ldloc.s    V_4
        IL_00a3:  ldloc.s    V_5
        IL_00a5:  cgt
        ...
        IL_00af:  ldarg.0
        IL_00b0:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::this
        IL_00b5:  castclass  assembly/Test1/X13
        IL_00ba:  stloc.s    V_8
        IL_00bc:  ldarg.0
        IL_00bd:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::objTemp
        IL_00c2:  castclass  assembly/Test1/X13
        IL_00c7:  stloc.s    V_9
        IL_00c9:  ldloc.s    V_8
        IL_00cb:  ldfld      int32 assembly/Test1/X13::item
        IL_00d0:  stloc.s    V_4
        IL_00d2:  ldloc.s    V_9
        IL_00d4:  ldfld      int32 assembly/Test1/X13::item
        IL_00d9:  stloc.s    V_5
        IL_00db:  ldloc.s    V_4
        IL_00dd:  ldloc.s    V_5
        IL_00df:  cgt
        ...
        IL_00e9:  ldarg.0
        IL_00ea:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::this
        IL_00ef:  castclass  assembly/Test1/X14
        IL_00f4:  stloc.s    V_10
        IL_00f6:  ldarg.0
        IL_00f7:  ldfld      class assembly/Test1 assembly/Test1/'clo@4-1'::objTemp
        IL_00fc:  castclass  assembly/Test1/X14
        IL_0101:  stloc.s    V_11
        IL_0103:  ldloc.s    V_10
        IL_0105:  ldfld      int32 assembly/Test1/X14::item
        IL_010a:  stloc.s    V_4
        IL_010c:  ldloc.s    V_11
        IL_010e:  ldfld      int32 assembly/Test1/X14::item
        IL_0113:  stloc.s    V_5
        IL_0115:  ldloc.s    V_4
        IL_0117:  ldloc.s    V_5
        IL_0119:  cgt
    ...
    .method public hidebysig virtual final instance int32  CompareTo(object obj, class [runtime]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_000a:  ldarg.1
      IL_000b:  unbox.any  assembly/Test1
      IL_0010:  brfalse.s  IL_0024

      IL_0012:  ldarg.0
      IL_0013:  ldloc.0
      IL_0014:  newobj     instance void assembly/Test1/'clo@4-1'::.ctor(class assembly/Test1,
                                                                        class assembly/Test1)
      IL_0019:  stloc.1
      IL_001a:  ldloc.1
      IL_001b:  ldnull
      ...
      IL_0026:  ldarg.1
      IL_0027:  unbox.any  assembly/Test1
