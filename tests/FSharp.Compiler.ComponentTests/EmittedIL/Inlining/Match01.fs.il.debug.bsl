       ...
       extends [runtime]System.Object
{
                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
            ...
            instance object  __DebugDisplay() cil managed
    {
      ...
      IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfGlobalOperators::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class assembly/Test1,string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
      IL_000f:  ldarg.0
                                      ...
                                      class [runtime]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_0013:  ldloc.0
      IL_0014:  ldnull
      IL_0015:  call       int32 assembly::'CompareTo$cont@4-1'(class assembly/Test1,
                                                               class assembly/Test1,
                                                               class [FSharp.Core]Microsoft.FSharp.Core.Unit)
      IL_001a:  ret
                                                      ...
                                                      class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
  {
    ...
    IL_003d:  stloc.3
    IL_003e:  ldloc.2
    IL_003f:  ldfld      int32 assembly/Test1/X11::item
    IL_0044:  stloc.s    V_4
    IL_0046:  ldloc.3
    IL_0047:  ldfld      int32 assembly/Test1/X11::item
    IL_004c:  stloc.s    V_5
    IL_004e:  ldloc.s    V_4
    IL_0050:  ldloc.s    V_5
    IL_0052:  cgt
    ...
    IL_005c:  ldarg.0
    IL_005d:  castclass  assembly/Test1/X12
    IL_0062:  stloc.s    V_6
    IL_0064:  ldarg.1
    IL_0065:  castclass  assembly/Test1/X12
    IL_006a:  stloc.s    V_7
    IL_006c:  ldloc.s    V_6
    IL_006e:  ldfld      int32 assembly/Test1/X12::item
    IL_0073:  stloc.s    V_4
    IL_0075:  ldloc.s    V_7
    IL_0077:  ldfld      int32 assembly/Test1/X12::item
    IL_007c:  stloc.s    V_5
    IL_007e:  ldloc.s    V_4
    IL_0080:  ldloc.s    V_5
    IL_0082:  cgt
    ...
    IL_008c:  ldarg.0
    IL_008d:  castclass  assembly/Test1/X13
    IL_0092:  stloc.s    V_8
    IL_0094:  ldarg.1
    IL_0095:  castclass  assembly/Test1/X13
    IL_009a:  stloc.s    V_9
    IL_009c:  ldloc.s    V_8
    IL_009e:  ldfld      int32 assembly/Test1/X13::item
    IL_00a3:  stloc.s    V_4
    IL_00a5:  ldloc.s    V_9
    IL_00a7:  ldfld      int32 assembly/Test1/X13::item
    IL_00ac:  stloc.s    V_5
    IL_00ae:  ldloc.s    V_4
    IL_00b0:  ldloc.s    V_5
    IL_00b2:  cgt
    ...
    IL_00bc:  ldarg.0
    IL_00bd:  castclass  assembly/Test1/X14
    IL_00c2:  stloc.s    V_10
    IL_00c4:  ldarg.1
    IL_00c5:  castclass  assembly/Test1/X14
    IL_00ca:  stloc.s    V_11
    IL_00cc:  ldloc.s    V_10
    IL_00ce:  ldfld      int32 assembly/Test1/X14::item
    IL_00d3:  stloc.s    V_4
    IL_00d5:  ldloc.s    V_11
    IL_00d7:  ldfld      int32 assembly/Test1/X14::item
    IL_00dc:  stloc.s    V_5
    IL_00de:  ldloc.s    V_4
    IL_00e0:  ldloc.s    V_5
    IL_00e2:  cgt
