       ...
       extends [runtime]System.Object
{
                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,int32>
    {
      ...
      .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
      .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      .method assembly specialname rtspecialname instance void  .ctor(class assembly/Test1 this, class assembly/Test1 obj) cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
        .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      ...
      .method public strict virtual instance int32 Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldfld      class assembly/Test1 assembly/Test1/clo@4::obj
        IL_0006:  brfalse    IL_014a

        IL_000b:  ldarg.0
        IL_000c:  ldfld      class assembly/Test1 assembly/Test1/clo@4::this
        IL_0011:  ldfld      int32 assembly/Test1::_tag
        IL_0016:  stloc.0
        IL_0017:  ldarg.0
        IL_0018:  ldfld      class assembly/Test1 assembly/Test1/clo@4::obj
        IL_001d:  ldfld      int32 assembly/Test1::_tag
        IL_0022:  stloc.1
        IL_0023:  ldloc.0
        IL_0024:  ldloc.1
        IL_0025:  bne.un     IL_0146

        IL_002a:  ldarg.0
        IL_002b:  ldfld      class assembly/Test1 assembly/Test1/clo@4::this
        IL_0030:  call       instance int32 assembly/Test1::get_Tag()
        IL_0035:  switch     ( 
                              IL_004a,
                              IL_0086,
                              IL_00c6,
                              IL_0106)
        IL_004a:  ldarg.0
        IL_004b:  ldfld      class assembly/Test1 assembly/Test1/clo@4::this
        IL_0050:  castclass  assembly/Test1/X11
        IL_0055:  stloc.2
        IL_0056:  ldarg.0
        IL_0057:  ldfld      class assembly/Test1 assembly/Test1/clo@4::obj
        IL_005c:  castclass  assembly/Test1/X11
        IL_0061:  stloc.3
        IL_0062:  call       class [runtime]System.Collections.IComparer [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives::get_GenericComparer()
        IL_0067:  pop
        IL_0068:  ldloc.2
        IL_0069:  ldfld      int32 assembly/Test1/X11::item
        IL_006e:  stloc.s    V_4
        IL_0070:  ldloc.3
        IL_0071:  ldfld      int32 assembly/Test1/X11::item
        IL_0076:  stloc.s    V_5
        IL_0078:  ldloc.s    V_4
        IL_007a:  ldloc.s    V_5
        IL_007c:  cgt
        ...
        IL_0086:  ldarg.0
        IL_0087:  ldfld      class assembly/Test1 assembly/Test1/clo@4::this
        IL_008c:  castclass  assembly/Test1/X12
        IL_0091:  stloc.s    V_6
        IL_0093:  ldarg.0
        IL_0094:  ldfld      class assembly/Test1 assembly/Test1/clo@4::obj
        IL_0099:  castclass  assembly/Test1/X12
        IL_009e:  stloc.s    V_7
        IL_00a0:  call       class [runtime]System.Collections.IComparer [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives::get_GenericComparer()
        IL_00a5:  pop
        IL_00a6:  ldloc.s    V_6
        IL_00a8:  ldfld      int32 assembly/Test1/X12::item
        IL_00ad:  stloc.s    V_4
        IL_00af:  ldloc.s    V_7
        IL_00b1:  ldfld      int32 assembly/Test1/X12::item
        IL_00b6:  stloc.s    V_5
        IL_00b8:  ldloc.s    V_4
        IL_00ba:  ldloc.s    V_5
        IL_00bc:  cgt
        ...
        IL_00c6:  ldarg.0
        IL_00c7:  ldfld      class assembly/Test1 assembly/Test1/clo@4::this
        IL_00cc:  castclass  assembly/Test1/X13
        IL_00d1:  stloc.s    V_8
        IL_00d3:  ldarg.0
        IL_00d4:  ldfld      class assembly/Test1 assembly/Test1/clo@4::obj
        IL_00d9:  castclass  assembly/Test1/X13
        IL_00de:  stloc.s    V_9
        IL_00e0:  call       class [runtime]System.Collections.IComparer [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives::get_GenericComparer()
        IL_00e5:  pop
        IL_00e6:  ldloc.s    V_8
        IL_00e8:  ldfld      int32 assembly/Test1/X13::item
        IL_00ed:  stloc.s    V_4
        IL_00ef:  ldloc.s    V_9
        IL_00f1:  ldfld      int32 assembly/Test1/X13::item
        IL_00f6:  stloc.s    V_5
        IL_00f8:  ldloc.s    V_4
        IL_00fa:  ldloc.s    V_5
        IL_00fc:  cgt
        ...
        IL_0106:  ldarg.0
        IL_0107:  ldfld      class assembly/Test1 assembly/Test1/clo@4::this
        IL_010c:  castclass  assembly/Test1/X14
        IL_0111:  stloc.s    V_10
        IL_0113:  ldarg.0
        IL_0114:  ldfld      class assembly/Test1 assembly/Test1/clo@4::obj
        IL_0119:  castclass  assembly/Test1/X14
        IL_011e:  stloc.s    V_11
        IL_0120:  call       class [runtime]System.Collections.IComparer [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives::get_GenericComparer()
        IL_0125:  pop
        IL_0126:  ldloc.s    V_10
        IL_0128:  ldfld      int32 assembly/Test1/X14::item
        IL_012d:  stloc.s    V_4
        IL_012f:  ldloc.s    V_11
        IL_0131:  ldfld      int32 assembly/Test1/X14::item
        IL_0136:  stloc.s    V_5
        IL_0138:  ldloc.s    V_4
        IL_013a:  ldloc.s    V_5
        IL_013c:  cgt
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,int32>
    {
      ...
      .method assembly specialname rtspecialname 
              instance void  .ctor(class assembly/Test1 this,
                                   object obj,
                                   class assembly/Test1 objTemp) cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
        .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      ...
      .method public strict virtual instance int32 Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
      {
        ...
        IL_0066:  stloc.3
        IL_0067:  ldloc.2
        IL_0068:  ldfld      int32 assembly/Test1/X11::item
        IL_006d:  stloc.s    V_4
        IL_006f:  ldloc.3
        IL_0070:  ldfld      int32 assembly/Test1/X11::item
        IL_0075:  stloc.s    V_5
        IL_0077:  ldloc.s    V_4
        IL_0079:  ldloc.s    V_5
        IL_007b:  cgt
        ...
        IL_009d:  stloc.s    V_7
        IL_009f:  ldloc.s    V_6
        IL_00a1:  ldfld      int32 assembly/Test1/X12::item
        IL_00a6:  stloc.s    V_4
        IL_00a8:  ldloc.s    V_7
        IL_00aa:  ldfld      int32 assembly/Test1/X12::item
        IL_00af:  stloc.s    V_5
        IL_00b1:  ldloc.s    V_4
        IL_00b3:  ldloc.s    V_5
        IL_00b5:  cgt
        ...
        IL_00d7:  stloc.s    V_9
        IL_00d9:  ldloc.s    V_8
        IL_00db:  ldfld      int32 assembly/Test1/X13::item
        IL_00e0:  stloc.s    V_4
        IL_00e2:  ldloc.s    V_9
        IL_00e4:  ldfld      int32 assembly/Test1/X13::item
        IL_00e9:  stloc.s    V_5
        IL_00eb:  ldloc.s    V_4
        IL_00ed:  ldloc.s    V_5
        IL_00ef:  cgt
        ...
        IL_0115:  ldfld      int32 assembly/Test1/X14::item
        IL_011a:  stloc.s    V_4
        IL_011c:  ldloc.s    V_11
        IL_011e:  ldfld      int32 assembly/Test1/X14::item
        IL_0123:  stloc.s    V_5
        IL_0125:  ldloc.s    V_4
        IL_0127:  ldloc.s    V_5
        IL_0129:  cgt
    ...
    .method public hidebysig virtual final instance int32  CompareTo(class assembly/Test1 obj) cil managed
    {
      ...
      IL_0003:  ldarg.0
      IL_0004:  ldarg.1
      IL_0005:  newobj     instance void assembly/Test1/clo@4::.ctor(class assembly/Test1,
    ...
    .method public hidebysig virtual final instance int32  CompareTo(object obj, class [runtime]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_001d:  ldarg.1
      IL_001e:  unbox.any  assembly/Test1
