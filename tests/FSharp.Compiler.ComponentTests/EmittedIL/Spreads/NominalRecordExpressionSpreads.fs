...
[<Theory; FileInlineData("Expression_Nominal_Structness.fs", Realsig = BooleanOptions.True, Optimize = BooleanOptions.True)>]
let Expression_Nominal_Structness_fs compilation =
    compilation
    |> getCompilation
    |> verifyCompilation

[<Theory; FileInlineData("Expression_Nominal_NestedUpdates.fs", Realsig = BooleanOptions.True, Optimize = BooleanOptions.True)>]
let Expression_Nominal_NestedUpdates_fs compilation =
    compilation
    |> getCompilation
    |> verifyCompilation
