...
[<Theory; FileInlineData("Type_NoOverlap_Explicit_Spread_Generics.fs", Realsig = BooleanOptions.True, Optimize = BooleanOptions.True)>]
let Type_NoOverlap_Explicit_Spread_Generics_fs compilation =
    compilation
    |> getCompilation
    |> verifyCompilation
