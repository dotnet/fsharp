       ...
       extends [runtime]System.Object
{
                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
    ...
    .method public hidebysig virtual final instance int32  CompareTo(class assembly/R1 obj) cil managed
    {
      ...
      IL_0042:  stloc.3
      IL_0043:  ldarg.1
      IL_0044:  ldfld      int32 assembly/R1::B@
      IL_0049:  stloc.s    V_4
      IL_004b:  ldloc.3
      IL_004c:  ldloc.s    V_4
      IL_004e:  cgt
      ...
      IL_0068:  stloc.1
      IL_0069:  ldarg.0
      IL_006a:  ldfld      int32 assembly/R1::C@
      IL_006f:  stloc.3
      IL_0070:  ldarg.1
      IL_0071:  ldfld      int32 assembly/R1::C@
      IL_0076:  stloc.s    V_4
      IL_0078:  ldloc.3
      IL_0079:  ldloc.s    V_4
      IL_007b:  cgt
    ...
    .method public hidebysig virtual final instance int32  CompareTo(object obj, class [runtime]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_005d:  ldarg.0
      IL_005e:  ldfld      int32 assembly/R1::C@
      IL_0063:  stloc.3
      IL_0064:  ldloc.0
      IL_0065:  ldfld      int32 assembly/R1::C@
      IL_006a:  stloc.s    V_4
      IL_006c:  ldloc.3
      IL_006d:  ldloc.s    V_4
      IL_006f:  cgt
    ...
    .method public hidebysig virtual final instance int32  GetHashCode(class [runtime]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_0034:  ldarg.0
      IL_0035:  ldfld      int32 assembly/R1::A@
      IL_003a:  ldloc.0
      IL_003b:  ldc.i4.6
      IL_003c:  shl
      IL_003d:  ldloc.0
    ...
    .method public hidebysig instance bool Equals(class assembly/R1 obj, class [runtime]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_0022:  ldarg.0
      IL_0023:  ldfld      int32 assembly/R1::C@
      IL_0028:  ldarg.1
      IL_0029:  ldfld      int32 assembly/R1::C@
      IL_002e:  ceq
      IL_0030:  ret
                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
    ...
    .method public hidebysig virtual final instance int32  CompareTo(class assembly/R2 obj) cil managed
    {
      ...
      IL_000b:  stloc.0
      IL_000c:  ldarg.0
      IL_000d:  ldfld      int32 assembly/R2::B@
      IL_0012:  stloc.1
      IL_0013:  ldarg.1
      IL_0014:  ldfld      int32 assembly/R2::B@
      IL_0019:  stloc.2
      IL_001a:  ldloc.1
      IL_001b:  ldloc.2
      IL_001c:  cgt
    ...
    .method public hidebysig virtual final instance int32  CompareTo(object obj, class [runtime]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_0012:  ldarg.0
      IL_0013:  ldfld      int32 assembly/R2::B@
      IL_0018:  stloc.1
      IL_0019:  ldloc.0
      IL_001a:  ldfld      int32 assembly/R2::B@
      IL_001f:  stloc.2
      IL_0020:  ldloc.1
      IL_0021:  ldloc.2
      IL_0022:  cgt
    ...
    .method public hidebysig virtual final instance int32  GetHashCode(class [runtime]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_0005:  ldc.i4     0x9e3779b9
      IL_000a:  ldarg.0
      IL_000b:  ldfld      int32 assembly/R2::B@
      IL_0010:  ldloc.0
      IL_0011:  ldc.i4.6
      IL_0012:  shl
      IL_0013:  ldloc.0
    ...
    .method public hidebysig instance bool Equals(class assembly/R2 obj, class [runtime]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_0006:  ldarg.0
      IL_0007:  ldfld      int32 assembly/R2::B@
      IL_000c:  ldarg.1
      IL_000d:  ldfld      int32 assembly/R2::B@
      IL_0012:  ceq
      IL_0014:  ret
  ...
  .method assembly specialname static void staticInitialization@() cil managed
  {
    ...
    IL_0003:  newobj     instance void assembly/R1::.ctor(int32,
                                                                                          int32,
                                                                                          int32)
    IL_0008:  stsfld     class assembly/R1 assembly::r1@4
    ...
    IL_001c:  stsfld     class assembly/R2 assembly::r2@5
    IL_0021:  ret
  } 
