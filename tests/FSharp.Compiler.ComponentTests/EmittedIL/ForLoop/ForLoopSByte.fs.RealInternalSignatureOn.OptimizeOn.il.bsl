       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
    ...
    .method public static void  constFinish(int8 start) cil managed
    {
    ...
    .method public static void  constStart(int8 finish) cil managed
    {
    ...
    .method public static void  annotatedStart(int8 start,
    ...
    .method public static void  annotatedFinish(int8 start,
                                                int8 finish) cil managed
    {
      .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationArgumentCountsAttribute::.ctor(int32[]) = ( 01 00 02 00 00 00 01 00 00 00 01 00 00 00 00 00 ) 
    ...
    .method public static void  inferredStartAndFinish(int8 start,
                                                       int8 finish) cil managed
    {
      .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationArgumentCountsAttribute::.ctor(int32[]) = ( 01 00 02 00 00 00 01 00 00 00 01 00 00 00 00 00 ) 
