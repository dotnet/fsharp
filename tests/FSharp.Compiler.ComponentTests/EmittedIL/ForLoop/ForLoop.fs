...
module ForLoop =
    ...
    [<Theory; FileInlineData("NonTrivialBranchingBindingInEnd01.fs", Realsig=BooleanOptions.Both, Optimize=BooleanOptions.True)>]
    ...
    [<Theory; FileInlineData("NonTrivialBranchingBindingInEnd02.fs", Realsig=BooleanOptions.Both, Optimize=BooleanOptions.True)>]
    ...
    [<Theory; FileInlineData("NonTrivialBranchingBindingInEnd03.fs", Realsig=BooleanOptions.Both, Optimize=BooleanOptions.True)>]
    ...
    [<Theory; FileInlineData("NonTrivialBranchingBindingInEnd04.fs", Realsig=BooleanOptions.Both, Optimize=BooleanOptions.True)>]
    ...
    [<Theory; FileInlineData("NonTrivialBranchingBindingInEnd05.fs", Realsig=BooleanOptions.Both, Optimize=BooleanOptions.True)>]
