       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  f2y(int8 start) cil managed
  {
    ...
    IL_0019:  ldloc.2
    IL_001a:  call       void assembly::set_c(int8)
    IL_001f:  ldloc.2
    IL_0020:  ldc.i4.1
    IL_0021:  add
    IL_0022:  stloc.2
  ...
  .method public static void  f3y(int8 finish) cil managed
  {
    ...
    IL_0017:  ldloc.2
    IL_0018:  call       void assembly::set_c(int8)
    IL_001d:  ldloc.2
    IL_001e:  ldc.i4.1
    IL_001f:  add
    IL_0020:  stloc.2
  ...
  .method public static void  f4y(int8 start,
  ...
  .method public static void  f7y(int8 start) cil managed
  {
    ...
    IL_001b:  ldloc.2
    IL_001c:  call       void assembly::set_c(int8)
    IL_0021:  ldloc.2
    IL_0022:  ldc.i4.2
    IL_0023:  add
    IL_0024:  stloc.2
  ...
  .method public static void  f8y(int8 step) cil managed
  {
    ...
    IL_002b:  ldloc.2
    IL_002c:  call       void assembly::set_c(int8)
    IL_0031:  ldloc.2
    IL_0032:  ldarg.0
    IL_0033:  add
    IL_0034:  stloc.2
  ...
  .method public static void  f9y(int8 finish) cil managed
  {
  ...
  .method public static void  f10y(int8 start,
                                   int8 step,
                                   int8 finish) cil managed
  {
    ...
    IL_0045:  ldloc.2
    IL_0046:  call       void assembly::set_c(int8)
    IL_004b:  ldloc.2
    IL_004c:  ldarg.1
    IL_004d:  add
    IL_004e:  stloc.2
  ...
  .method public static void  f11y(int8 start,
                                   int8 finish) cil managed
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationArgumentCountsAttribute::.ctor(int32[]) = ( 01 00 02 00 00 00 01 00 00 00 01 00 00 00 00 00 ) 
    ...
    IL_0016:  ldc.i4.0
    IL_0017:  ldarg.1
    IL_0018:  call       class [runtime]System.Collections.Generic.IEnumerable`1<int8> [FSharp.Core]Microsoft.FSharp.Core.Operators/OperatorIntrinsics::RangeSByte(int8,
                                                                                                                                                                          int8,
                                                                                                                                                                          int8)
    IL_001d:  pop
    IL_001e:  ldc.i4.m1
  ...
  .method public static void  f12() cil managed
  {
    ...
    IL_0016:  ldc.i4.0
    IL_0017:  ldc.i4.s   10
    IL_0019:  call       class [runtime]System.Collections.Generic.IEnumerable`1<int8> [FSharp.Core]Microsoft.FSharp.Core.Operators/OperatorIntrinsics::RangeSByte(int8,
                                                                                                                                                                          int8,
                                                                                                                                                                          int8)
    IL_001e:  pop
    IL_001f:  ldc.i4.m1
