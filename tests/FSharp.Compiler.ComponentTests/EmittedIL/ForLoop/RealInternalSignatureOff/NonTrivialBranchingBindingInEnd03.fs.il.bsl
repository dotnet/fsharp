       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  main@() cil managed
  {
    ...
    IL_001f:  ldlen
    IL_0020:  conv.i4
    IL_0021:  stsfld     int32 '<StartupCode$assembly>'.$assembly::e1@1
    IL_0026:  call       int32[] assembly::get_w()
    IL_002b:  ldlen
    IL_002c:  conv.i4
    IL_002d:  stsfld     int32 '<StartupCode$assembly>'.$assembly::e2@1
    IL_0032:  call       int32 assembly::get_e1@1()
    IL_0037:  call       int32 assembly::get_e2@1()
    IL_003c:  bge.s      IL_0046

    IL_003e:  call       int32 assembly::get_e1@1()
    IL_0043:  nop
    IL_0044:  br.s       IL_004c

    IL_0046:  call       int32 assembly::get_e2@1()
    IL_004b:  nop
    IL_004c:  ldc.i4.1
    IL_004d:  sub
