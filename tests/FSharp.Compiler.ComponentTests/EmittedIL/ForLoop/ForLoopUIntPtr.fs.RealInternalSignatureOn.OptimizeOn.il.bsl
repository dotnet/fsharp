       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
    ...
    .method public static void  constFinish(native uint start) cil managed
    {
    ...
    .method public static void  constStart(native uint finish) cil managed
    {
    ...
    .method public static void  annotatedStart(native uint start,
    ...
    .method public static void  annotatedFinish(native uint start,
                                                native uint finish) cil managed
    {
      .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationArgumentCountsAttribute::.ctor(int32[]) = ( 01 00 02 00 00 00 01 00 00 00 01 00 00 00 00 00 ) 
    ...
    .method public static void  inferredStartAndFinish(native uint start,
                                                       native uint finish) cil managed
    {
      .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationArgumentCountsAttribute::.ctor(int32[]) = ( 01 00 02 00 00 00 01 00 00 00 01 00 00 00 00 00 ) 
