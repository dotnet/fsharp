       ...
       extends [runtime]System.Object
{
                                  ...
                                  int64 finish) cil managed
  {
    ...
    IL_0046:  ldarg.2
    IL_0047:  stloc.3
    IL_0048:  br.s       IL_005f

    IL_004a:  ldloc.3
    IL_004b:  call       void assembly::set_c(int64)
    IL_0050:  ldloc.3
    IL_0051:  ldarg.1
    IL_0052:  add
    IL_0053:  stloc.3
    ...
    IL_0064:  conv.i8
    IL_0065:  ldarg.1
    IL_0066:  bge.s      IL_007c

    IL_0068:  ldarg.2
    IL_0069:  ldarg.2
    IL_006a:  bge.s      IL_0071

    IL_006c:  ldc.i4.0
    IL_006d:  conv.i8
    IL_006e:  nop
    IL_006f:  br.s       IL_0094
    ...
    IL_009d:  ldloc.3
    IL_009e:  call       void assembly::set_c(int64)
    IL_00a3:  ldloc.3
    IL_00a4:  ldarg.1
    IL_00a5:  add
    IL_00a6:  stloc.3
