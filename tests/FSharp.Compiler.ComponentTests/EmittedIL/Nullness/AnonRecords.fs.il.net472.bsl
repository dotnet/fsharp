       ...
       extends [runtime]System.Object
{
          ...
          get_maybeListOfMaybeString() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldsfld     class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<string> '<StartupCode$assembly>'.$MyTestModule::maybeListOfMaybeString@5
    IL_0005:  ret
  } 

  .method public static class '<>f__AnonymousType2430756162`3'<string,class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<string>,int32> 
          giveMeA() cil managed
  {
    .param [0]
    .custom instance void System.Runtime.CompilerServices.NullableAttribute::.ctor(class [runtime]System.Array<uint8>) = ( 01 00 04 00 00 00 01 02 02 02 00 00 ) 
  ...
  .method public static class '<>f__AnonymousType2430756162`3'<int32,int32,int32> 
          giveMeB() cil managed
  {
  ...
  .method public static class '<>f__AnonymousType2430756162`3'<string,string,string> 
          giveMeC() cil managed
  {
    .param [0]
    .custom instance void System.Runtime.CompilerServices.NullableAttribute::.ctor(class [runtime]System.Array<uint8>) = ( 01 00 04 00 00 00 01 02 02 02 00 00 ) 
...
{
  .custom instance void System.Runtime.CompilerServices.NullableContextAttribute::.ctor(uint8) = ( 01 00 01 00 00 ) 
  .field static assembly initonly class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<string> maybeListOfMaybeString@5
          ...
          void  .cctor() cil managed
  {
    ...
    IL_000f:  stsfld     class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<string> '<StartupCode$assembly>'.$MyTestModule::maybeListOfMaybeString@5
    IL_0014:  ret
  } 
                  ...
                  class [runtime]System.IEquatable`1<class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>>
{
  ...
  .method public hidebysig virtual final 
          instance int32  CompareTo(class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'> obj) cil managed
  {
    .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
                                ...
                                class [runtime]System.Collections.IEqualityComparer comp) cil managed
  {
    ...
    IL_0003:  ldarg.1
    IL_0004:  isinst     class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>
    IL_0009:  stloc.0
    IL_000a:  ldloc.0
    ...
    IL_000f:  ldarg.2
    IL_0010:  ldarg.0
    IL_0011:  ldfld      !0 class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>::A@
    IL_0016:  ldloc.1
    IL_0017:  ldfld      !0 class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>::A@
    ...
    IL_0023:  ldarg.2
    IL_0024:  ldarg.0
    IL_0025:  ldfld      !1 class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>::B@
    IL_002a:  ldloc.1
    IL_002b:  ldfld      !1 class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>::B@
    IL_0030:  call       bool [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives::GenericEqualityWithComparer<!'<B>j__TPar'>(class [runtime]System.Collections.IEqualityComparer,
                                                                                                                                !!0,
                                                                                                                                !!0)
    ...
    IL_0037:  ldarg.2
    IL_0038:  ldarg.0
    IL_0039:  ldfld      !2 class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>::C@
    IL_003e:  ldloc.1
    IL_003f:  ldfld      !2 class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'>::C@
    IL_0044:  tail.
    IL_0046:  call       bool [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives::GenericEqualityWithComparer<!'<C>j__TPar'>(class [runtime]System.Collections.IEqualityComparer,
                                                                                                                                !!0,
                                                                                                                                !!0)
    IL_004b:  ret
  ...
  .method public hidebysig virtual final 
          instance bool  Equals(class '<>f__AnonymousType2430756162`3'<!'<A>j__TPar',!'<B>j__TPar',!'<C>j__TPar'> obj) cil managed
  {
    .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
