...
.class private abstract auto ansi sealed '<StartupCode$assembly>'.$CCtorDUWithMember02
       extends [runtime]System.Object
{
       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
            ...
            get_x() cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldsfld     int32 '<StartupCode$assembly>'.$assembly::x@7
      IL_0005:  ret
    } 
            ...
            set_x(int32 'value') cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  stsfld     int32 '<StartupCode$assembly>'.$assembly::x@7
      IL_0006:  ret
    } 
    ...
    .property int32 x()
    {
      ...
      .set void assembly/M::set_x(int32)
          ...
          get_y() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldsfld     int32 '<StartupCode$assembly>'.$assembly::y@9
    IL_0005:  ret
  } 
       ...
       extends [runtime]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_002a:  stsfld     int32 '<StartupCode$assembly>'.$assembly::x@7
    IL_002f:  nop
    ...
    IL_003a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfGlobalOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
    IL_003f:  pop
    IL_0040:  call       int32 assembly/M::get_x()
    IL_0045:  dup
    IL_0046:  stsfld     int32 '<StartupCode$assembly>'.$assembly::y@9
    IL_004b:  stloc.0
    IL_004c:  ret
  } 
