       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
    ...
    .method public specialname static int32 get_x() cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldsfld     int32 assembly/M::x@7
      IL_0005:  ret
    } 
    ...
    .method public specialname static void set_x(int32 'value') cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  stsfld     int32 assembly/M::x@7
      IL_0006:  ret
    } 
    ...
    .method assembly specialname static void staticInitialization@() cil managed
    {
      ...
      IL_001a:  stsfld     int32 assembly/M::x@7
      IL_001f:  ret
    } 
  ...
  .field static assembly int32 y@9
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  .method public specialname static int32 get_y() cil managed
  {
    
    .maxstack  8
    IL_0000:  ldsfld     int32 assembly::y@9
    IL_0005:  ret
  } 
  ...
  .method assembly specialname static void staticInitialization@() cil managed
  {
    ...
    IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
    IL_000f:  pop
    IL_0010:  call       void assembly/M::staticInitialization@()
    IL_0015:  nop
    IL_0016:  ldstr      "hello3"
    ...
    IL_0025:  pop
    IL_0026:  call       int32 assembly/M::get_x()
    IL_002b:  stsfld     int32 assembly::y@9
    IL_0030:  ret
  } 
