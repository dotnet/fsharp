...
// MVID: {624BD804-E1E5-4DA9-A745-038304D84B62}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x000001C8774C0000
       ...
       extends [System.Runtime]System.Object
{
          ...
          f<a>() cil managed
  {
    ...
    IL_001c:  ldnull
    IL_001d:  unbox.any  class [System.Runtime]System.Collections.Generic.IEnumerable`1<!!a>
    IL_0022:  br.s       IL_002b

    IL_0024:  ldloc.1
    IL_0025:  call       class [System.Runtime]System.Exception [FSharp.Core]Microsoft.FSharp.Core.Operators::Failure(string)
    IL_002a:  throw

    IL_002b:  call       instance void valuetype [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.ListCollector`1<!!a>::AddMany(class [System.Runtime]System.Collections.Generic.IEnumerable`1<!0>)
    IL_0030:  nop
    IL_0031:  nop
  ...
  .method public static void  testSimpleForEachSeqLoopWithOneStatement(class [System.Runtime]System.Collections.Generic.IEnumerable`1<object[]> inp) cil managed
  {
    // Code size       59 (0x3b)
    .maxstack  4
    .locals init (class [System.Runtime]System.Collections.Generic.IEnumerable`1<object[]> V_0,
             class [System.Runtime]System.Collections.Generic.IEnumerator`1<object[]> V_1,
             object[] V_2,
             class [System.Runtime]System.IDisposable V_3)
    IL_0000:  ldarg.0
    IL_0001:  stloc.0
    IL_0002:  ldloc.0
    IL_0003:  callvirt   instance class [System.Runtime]System.Collections.Generic.IEnumerator`1<!0> class [System.Runtime]System.Collections.Generic.IEnumerable`1<object[]>::GetEnumerator()
    IL_0008:  stloc.1
    .try
    {
      IL_0009:  ldloc.1
      IL_000a:  callvirt   instance bool [System.Runtime]System.Collections.IEnumerator::MoveNext()
      IL_000f:  brfalse.s  IL_0026

      IL_0011:  ldloc.1
      IL_0012:  callvirt   instance !0 class [System.Runtime]System.Collections.Generic.IEnumerator`1<object[]>::get_Current()
      IL_0017:  stloc.2
      IL_0018:  ldstr      "{0}"
      IL_001d:  ldloc.2
  ...
  .method public static void  testSimpleForEachSeqLoopWithTwoStatements(class [System.Runtime]System.Collections.Generic.IEnumerable`1<object[]> inp) cil managed
  {
    // Code size       70 (0x46)
    .maxstack  4
    .locals init (class [System.Runtime]System.Collections.Generic.IEnumerable`1<object[]> V_0,
  ...
  .method public static void  testSimpleForEachArrayLoopWithOneStatement(int32[] inp) cil managed
  {
    ...
    IL_0006:  ldloc.0
    IL_0007:  ldloc.1
    IL_0008:  ldelem     [System.Runtime]System.Int32
    IL_000d:  stloc.2
    IL_000e:  ldstr      "{0}"
    IL_0013:  ldloc.2
  ...
  .method public static void  testSimpleForEachArrayLoopWithTwoStatements(int32[] inp) cil managed
  {
    ...
    IL_001e:  ldstr      "{0}"
    IL_0023:  ldloc.2
    IL_0024:  box        [System.Runtime]System.Int32
    IL_0029:  call       void [System.Console]System.Console::WriteLine(string,
                                                                        object)
    IL_002e:  ldloc.1
    IL_002f:  ldc.i4.1
                                                                                ...
                                                                                int32 stop) cil managed
  {
    ...
    {
      IL_0034:  ldloc.1
      IL_0035:  isinst     [System.Runtime]System.IDisposable
      IL_003a:  stloc.3
      IL_003b:  ldloc.3
                                                                                 ...
                                                                                 int32 stop) cil managed
  {
    ...
    {
      IL_0044:  ldloc.1
      IL_0045:  isinst     [System.Runtime]System.IDisposable
      IL_004a:  stloc.3
      IL_004b:  ldloc.3
      IL_004c:  brfalse.s  IL_0055

      IL_004e:  ldloc.3
      IL_004f:  callvirt   instance void [System.Runtime]System.IDisposable::Dispose()
      IL_0054:  endfinally
      IL_0055:  endfinally
    }  // end handler
    IL_0056:  ret
          ...
          ListExpressionSteppingTest7() cil managed
  {
    ...
    {
      IL_000f:  ldloc.1
      IL_0010:  callvirt   instance bool [System.Runtime]System.Collections.IEnumerator::MoveNext()
      IL_0015:  brfalse.s  IL_003a

      IL_0017:  ldloc.1
      IL_0018:  callvirt   instance !0 class [System.Runtime]System.Collections.Generic.IEnumerator`1<int32>::get_Current()
      IL_001d:  stloc.3
      IL_001e:  ldstr      "hello"
      IL_0023:  newobj     instance void class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`5<class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [System.Runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>::.ctor(string)
      IL_0028:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [System.Runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_002d:  pop
    ...
    {
      IL_003e:  ldloc.1
      IL_003f:  isinst     [System.Runtime]System.IDisposable
      IL_0044:  stloc.s    V_4
      IL_0046:  ldloc.s    V_4
      IL_0048:  brfalse.s  IL_0052

      IL_004a:  ldloc.s    V_4
      IL_004c:  callvirt   instance void [System.Runtime]System.IDisposable::Dispose()
      IL_0051:  endfinally
      IL_0052:  endfinally
    }  // end handler
    IL_0053:  ldloc.2
       ...
       extends [System.Runtime]System.Object
{
  ...
  .method public static void  main@() cil managed
  {
    ...
    IL_0001:  stsfld     int32 '<StartupCode$SeqExpressionSteppingTest07>'.$SeqExpressionSteppingTest7::r@4
    IL_0006:  ldstr      "res = %A"
    IL_000b:  newobj     instance void class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`5<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32>,class [FSharp.Core]Microsoft.FSharp.Core.Unit>,class [System.Runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32>>::.ctor(string)
    IL_0010:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32>,class [FSharp.Core]Microsoft.FSharp.Core.Unit>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [System.Runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
    IL_0015:  stloc.0
    .try
    {
    ...
    {
      IL_001e:  castclass  [System.Runtime]System.Exception
      IL_0023:  stloc.2
      IL_0024:  ldloc.2
      IL_0025:  call       class [FSharp.Core]Microsoft.FSharp.Core.FSharpOption`1<string> [FSharp.Core]Microsoft.FSharp.Core.Operators::FailurePattern(class [System.Runtime]System.Exception)
      IL_002a:  stloc.3
      IL_002b:  ldloc.3
...
// WARNING: Created Win32 resource file C:\kevinransom\fsharp\artifacts\bin\FSharp.Compiler.ComponentTests\Debug\net6.0\tests\EmittedIL\SeqExpressionStepping\SeqExpressionSteppingTest07_fs\SeqExpressionSteppingTest07.res
