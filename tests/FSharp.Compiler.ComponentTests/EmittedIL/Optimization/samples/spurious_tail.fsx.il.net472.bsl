       ...
       extends [runtime]System.Object
{
  ...
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 03 00 00 00 00 00 ) 
    .field assembly class [runtime]System.Collections.Generic.List`1<string> messages
    .method public specialname rtspecialname instance void  .ctor() cil managed
    {
      ...
      IL_000e:  newobj     instance void class [runtime]System.Collections.Generic.List`1<string>::.ctor(int32)
      IL_0013:  stfld      class [runtime]System.Collections.Generic.List`1<string> Spurious_tail/Logger::messages
      IL_0018:  ret
    } 
                ...
                string msg) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class [runtime]System.Collections.Generic.List`1<string> Spurious_tail/Logger::messages
      IL_0006:  ldarg.2
      IL_0007:  callvirt   instance void class [runtime]System.Collections.Generic.List`1<string>::Add(!0)
      IL_000c:  ldarg.0
                   ...
                   !!a obj) cil managed
    {
      ...
      IL_0015:  callvirt   instance void class [runtime]System.Collections.Generic.List`1<string>::Add(!0)
      IL_001a:  ldarg.0
         ...
         extends [runtime]System.Object
  {
    ...
    .method public specialname rtspecialname instance void  .ctor() cil managed
    {
      ...
      IL_0009:  ldc.i4     0x2710
      IL_000e:  newobj     instance void class [runtime]System.Collections.Generic.List`1<string>::.ctor(int32)
      IL_0013:  stfld      class [runtime]System.Collections.Generic.List`1<string> Spurious_tail/TailLogger::messages
      IL_0018:  ret
    } 
                ...
                string msg) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class [runtime]System.Collections.Generic.List`1<string> Spurious_tail/TailLogger::messages
      IL_0006:  ldarg.2
      IL_0007:  tail.
      IL_0009:  callvirt   instance void class [runtime]System.Collections.Generic.List`1<string>::Add(!0)
      IL_000e:  ret
    } 
                   ...
                   !!a obj) cil managed
    {
      ...
      IL_0010:  callvirt   instance string [runtime]System.Object::ToString()
      IL_0015:  tail.
      IL_0017:  callvirt   instance void class [runtime]System.Collections.Generic.List`1<string>::Add(!0)
      IL_001c:  ret
    } 
