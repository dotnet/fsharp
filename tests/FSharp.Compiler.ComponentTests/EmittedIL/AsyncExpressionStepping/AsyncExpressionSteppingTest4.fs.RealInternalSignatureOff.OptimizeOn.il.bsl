       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
    ...
    {
      .field static assembly initonly class assembly/assembly/'f4@5-1' @_instance
      .method private specialname rtspecialname static void  .cctor() cil managed
      {
        
        .maxstack  10
        IL_0000:  newobj     instance void assembly/assembly/'f4@5-1'::.ctor()
        IL_0005:  stsfld     class assembly/assembly/'f4@5-1' assembly/assembly/'f4@5-1'::@_instance
        IL_000a:  ret
      } 
      ...
      .method public strict virtual instance class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
      {
        ...
        IL_000c:  ldloc.0
        IL_000d:  newobj     instance void assembly/assembly/'f4@7-2'::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>)
        ...
        IL_0017:  stloc.1
        IL_0018:  ldloc.0
        IL_0019:  newobj     instance void assembly/assembly/'f4@12-4'::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>)
        IL_001e:  stloc.2
        IL_001f:  ldloc.1
        IL_0020:  ldloc.2
        IL_0021:  newobj     instance void assembly/assembly/'f4@6-5'::.ctor(class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32>,
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32>>
    {
      ...
      .method assembly specialname rtspecialname instance void  .ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> x) cil managed
      {
        ...
        IL_0006:  ldarg.0
        IL_0007:  ldarg.1
        IL_0008:  stfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> assembly/assembly/'f4@7-2'::x
        IL_000d:  ret
      } 
      ...
      .method public strict virtual instance class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
      {
        ...
        IL_0014:  ldarg.0
        IL_0015:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> assembly/assembly/'f4@7-2'::x
        ...
        IL_0026:  stloc.1
        IL_0027:  ldloc.1
        IL_0028:  newobj     instance void assembly/assembly/'f4@10-3'::.ctor(int32)
        IL_002d:  tail.
        IL_002f:  call       class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<!!0> [FSharp.Core]Microsoft.FSharp.Control.AsyncPrimitives::MakeAsync<int32>(class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<valuetype [FSharp.Core]Microsoft.FSharp.Control.AsyncActivation`1<!!0>,class [FSharp.Core]Microsoft.FSharp.Control.AsyncReturn>)
        IL_0034:  ret
      } 
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<valuetype [FSharp.Core]Microsoft.FSharp.Control.AsyncActivation`1<int32>,class [FSharp.Core]Microsoft.FSharp.Control.AsyncReturn>
    {
      ...
      .method assembly specialname rtspecialname instance void  .ctor(int32 z) cil managed
      {
        ...
        IL_0006:  ldarg.0
        IL_0007:  ldarg.1
        IL_0008:  stfld      int32 assembly/assembly/'f4@10-3'::z
        IL_000d:  ret
      } 
      ...
      .method public strict virtual instance class [FSharp.Core]Microsoft.FSharp.Control.AsyncReturn Invoke(valuetype [FSharp.Core]Microsoft.FSharp.Control.AsyncActivation`1<int32> ctxt) cil managed
      {
        ...
        IL_0000:  ldarg.1
        IL_0001:  ldarg.0
        IL_0002:  ldfld      int32 assembly/assembly/'f4@10-3'::z
        IL_0007:  tail.
    ...
    .method public static class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> f4() cil managed
    {
      ...
      IL_0005:  ldsfld     class assembly/assembly/'f4@5-1' assembly/assembly/'f4@5-1'::@_instance
      IL_000a:  tail.
    ...
    .method assembly specialname static class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> get_arg@1() cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldsfld     class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> '<StartupCode$assembly>'.$assembly::arg@1
      IL_0005:  ret
    } 
    ...
    .method assembly specialname static class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> get_computation@15() cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldsfld     class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> '<StartupCode$assembly>'.$assembly::computation@15
      IL_0005:  ret
    } 
...
.class private abstract auto ansi sealed '<StartupCode$assembly>'.$assembly
       extends [runtime]System.Object
{
  .field static assembly initonly class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> arg@1
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  .field static assembly initonly class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> computation@15
  .custom instance void [runtime]System.Diagnostics.DebuggerBrowsableAttribute::.ctor(valuetype [runtime]System.Diagnostics.DebuggerBrowsableState) = ( 01 00 00 00 00 00 00 00 ) 
  ...
  .method private specialname rtspecialname static void  .cctor() cil managed
  {
    ...
    IL_0005:  stsfld     class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> '<StartupCode$assembly>'.$assembly::arg@1
    IL_000a:  call       class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> assembly/assembly::get_arg@1()
    IL_000f:  stsfld     class [FSharp.Core]Microsoft.FSharp.Control.FSharpAsync`1<int32> '<StartupCode$assembly>'.$assembly::computation@15
