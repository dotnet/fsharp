...
module Misc =
    ...
    [<Theory; FileInlineData("AbstractClass.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("CodeGenRenamings01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("ArgumentNamesInClosures01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Decimal01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("EntryPoint01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("IfThenElse01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("LetIfThenElse01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Lock01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("ModuleWithExpression01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Seq_for_all01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("StructsAsArrayElements01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TryWith_NoFilterBlocks01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("MethodImplNoInline02.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("CustomAttributeGenericParameter01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("GeneralizationOnUnions01.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
