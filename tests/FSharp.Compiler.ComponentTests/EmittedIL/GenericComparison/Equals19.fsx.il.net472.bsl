         ...
         extends [runtime]System.Object
  {
                      ...
                      [runtime]System.Collections.IStructuralComparable
    {
                                    ...
                                    class [runtime]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0017:  ldfld      int32 assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct::v
        IL_001c:  ceq
        IL_001e:  ret
      ...
      .method public hidebysig virtual final instance bool  Equals(object obj) cil managed
      {
        ...
        .maxstack  4
        .locals init (valuetype assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct V_0,
                 valuetype assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct V_1)
        IL_0000:  ldarg.1
        IL_0001:  isinst     assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct
        ...
        IL_0010:  stloc.1
        IL_0011:  ldarg.0
        IL_0012:  ldfld      int32 assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct::v
        IL_0017:  ldloca.s   V_1
        IL_0019:  ldfld      int32 assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct::v
        IL_001e:  ceq
        IL_0020:  ret
                                     ...
                                     int32 y) cil managed
    {
      ...
      .locals init (valuetype assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct V_0,
               valuetype assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct V_1)
      IL_0000:  ldarg.0
      IL_0001:  newobj     instance void assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct::.ctor(int32)
      IL_0006:  stloc.0
      IL_0007:  ldarg.1
      IL_0008:  newobj     instance void assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct::.ctor(int32)
      IL_000d:  stloc.1
      IL_000e:  ldloca.s   V_0
      IL_0010:  ldfld      int32 assembly/EqualsMicroPerfAndCodeGenerationTests/SomeStruct::v
