...
{
  // Offset: 0x00000000 Length: 0x000008B4
  // WARNING: managed resource file FSharpSignatureData.Hash09 created
}
.mresource public FSharpOptimizationData.Hash09
{
  // Offset: 0x000008B8 Length: 0x000006BB
  // WARNING: managed resource file FSharpOptimizationData.Hash09 created
}
.module Hash09.exe
// MVID: {63DBF1DE-07FA-5B1B-A745-0383DEF1DB63}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x0000029656630000
       ...
       extends [System.Runtime]System.Object
{
         ...
         extends [System.Runtime]System.Object
  {
    ...
    .class auto autochar serializable sealed nested public beforefieldinit GenericKey`1<a>
           extends [System.Runtime]System.Object
           implements class [System.Runtime]System.IEquatable`1<class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>>,
                      [System.Runtime]System.Collections.IStructuralEquatable,
                      class [System.Runtime]System.IComparable`1<class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>>,
                      ...
                      [System.Runtime]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        IL_0011:  stloc.3
        IL_0012:  ldloc.0
        IL_0013:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0018:  stloc.s    V_4
        IL_001a:  ldloc.1
        ...
        IL_003e:  stloc.3
        IL_003f:  ldloc.0
        IL_0040:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0045:  stloc.s    V_4
        IL_0047:  ldloc.1
        IL_0048:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_004d:  stloc.s    V_5
        IL_004f:  ldloc.3
        IL_0050:  ldloc.s    V_4
        IL_0052:  ldloc.s    V_5
                                        ...
                                        class [System.Runtime]System.Collections.IComparer comp) cil managed
      {
        ...
        IL_000a:  ldarg.1
        IL_000b:  unbox.any  class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>
        ...
        IL_001e:  stloc.s    V_4
        IL_0020:  ldloc.2
        IL_0021:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0026:  stloc.s    V_5
        IL_0028:  ldarg.2
        IL_0029:  ldloc.s    V_4
        IL_002b:  ldloc.s    V_5
        ...
        IL_005e:  ldarg.1
        IL_005f:  unbox.any  class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>
              ...
              instance int32  GetHashCode(class [System.Runtime]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0010:  ldloc.1
        IL_0011:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0016:  stloc.2
        IL_0017:  ldarg.1
        IL_0018:  ldloc.2
        ...
        IL_002d:  ldloc.1
        IL_002e:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0033:  stloc.2
        IL_0034:  ldarg.1
        IL_0035:  ldloc.2
              ...
              instance int32  GetHashCode() cil managed
      {
        ...
        IL_0006:  callvirt   instance int32 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::GetHashCode(class [System.Runtime]System.Collections.IEqualityComparer)
        IL_000b:  ret
      } // end of method GenericKey`1::GetHashCode
                                    ...
                                    class [System.Runtime]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0003:  ldarg.1
        IL_0004:  isinst     class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>
        IL_0009:  stloc.0
        IL_000a:  ldloc.0
        ...
        IL_002d:  ldloc.1
        IL_002e:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0033:  stloc.3
        IL_0034:  ldloc.2
        IL_0035:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_003a:  stloc.s    V_4
        IL_003c:  ldarg.2
        IL_003d:  ldloc.3
        IL_003e:  ldloc.s    V_4
              ...
              instance bool  Equals(class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        IL_000b:  stloc.1
        IL_000c:  ldloc.0
        IL_000d:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0012:  stloc.2
        IL_0013:  ldloc.1
        IL_0014:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0019:  stloc.3
        ...
        IL_0023:  ldloc.0
        IL_0024:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0029:  stloc.2
        IL_002a:  ldloc.1
    ...
    .method public static void  f6() cil managed
    {
      ...
      IL_0011:  callvirt   instance int32 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<int32>::GetHashCode(class [System.Runtime]System.Collections.IEqualityComparer)
      IL_0016:  stloc.1
      IL_0017:  ldloc.0
      IL_0018:  ldc.i4.1
      IL_0019:  add
