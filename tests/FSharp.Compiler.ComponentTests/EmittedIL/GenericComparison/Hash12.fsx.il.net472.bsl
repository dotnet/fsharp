       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
                      ...
                      [runtime]System.Collections.IStructuralComparable
    {
      ...
      .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
      .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      .method public static class assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys 
              NewKeyWithInnerKeys(class assembly/HashMicroPerfAndCodeGenerationTests/Key item1,
                                  class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key> item2) cil managed
      {
        .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags,
                                                                                                    int32) = ( 01 00 08 00 00 00 00 00 00 00 00 00 ) 
      ...
      .method assembly specialname rtspecialname 
              instance void  .ctor(class assembly/HashMicroPerfAndCodeGenerationTests/Key item1,
                                   class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key> item2) cil managed
      {
        .custom instance void System.Diagnostics.CodeAnalysis.DynamicDependencyAttribute::.ctor(valuetype System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes,
      ...
      .method public hidebysig instance class assembly/HashMicroPerfAndCodeGenerationTests/Key 
              get_Item1() cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
        .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      ...
      .method public hidebysig instance class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key> 
              get_Item2() cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
        .custom instance void [runtime]System.Diagnostics.DebuggerNonUserCodeAttribute::.ctor() = ( 01 00 00 00 ) 
      ...
      .method public hidebysig virtual final 
              instance int32  CompareTo(class assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys obj) cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
                                    ...
                                    class [runtime]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0006:  ldarg.1
        IL_0007:  isinst     assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys
        IL_000c:  stloc.0
        IL_000d:  ldloc.0
        ...
        IL_0015:  stloc.2
        IL_0016:  ldloc.1
        IL_0017:  ldfld      class assembly/HashMicroPerfAndCodeGenerationTests/Key assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys::item1
        IL_001c:  stloc.3
        IL_001d:  ldloc.2
        IL_001e:  ldfld      class assembly/HashMicroPerfAndCodeGenerationTests/Key assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys::item1
        IL_0023:  stloc.s    V_4
        IL_0025:  ldloc.3
        IL_0026:  ldloc.s    V_4
        IL_0028:  ldarg.2
        IL_0029:  callvirt   instance bool assembly/HashMicroPerfAndCodeGenerationTests/Key::Equals(object,
                                                                                                  class [runtime]System.Collections.IEqualityComparer)
        IL_002e:  brfalse.s  IL_007b

        IL_0030:  ldloc.1
        IL_0031:  ldfld      class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key> assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys::item2
        IL_0036:  stloc.s    V_5
        IL_0038:  ldloc.2
        IL_0039:  ldfld      class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key> assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys::item2
        IL_003e:  stloc.s    V_6
        IL_0040:  ldloc.s    V_5
        IL_0042:  call       instance !0 class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key>::get_Item1()
        IL_0047:  stloc.3
        IL_0048:  ldloc.s    V_5
        IL_004a:  call       instance !1 class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key>::get_Item2()
        IL_004f:  stloc.s    V_4
        IL_0051:  ldloc.s    V_6
        IL_0053:  call       instance !0 class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key>::get_Item1()
        IL_0058:  stloc.s    V_7
        IL_005a:  ldloc.s    V_6
        IL_005c:  call       instance !1 class [runtime]System.Tuple`2<class assembly/HashMicroPerfAndCodeGenerationTests/Key,class assembly/HashMicroPerfAndCodeGenerationTests/Key>::get_Item2()
        IL_0061:  stloc.s    V_8
        IL_0063:  ldloc.3
        IL_0064:  ldloc.s    V_7
        IL_0066:  ldarg.2
        IL_0067:  callvirt   instance bool assembly/HashMicroPerfAndCodeGenerationTests/Key::Equals(object,
                                                                                                  class [runtime]System.Collections.IEqualityComparer)
        ...
        IL_0070:  ldloc.s    V_8
        IL_0072:  ldarg.2
        IL_0073:  callvirt   instance bool assembly/HashMicroPerfAndCodeGenerationTests/Key::Equals(object,
                                                                                                  class [runtime]System.Collections.IEqualityComparer)
        IL_0078:  ret
      ...
      .method public hidebysig virtual final 
              instance bool  Equals(class assembly/HashMicroPerfAndCodeGenerationTests/KeyWithInnerKeys obj) cil managed
      {
        .custom instance void [runtime]System.Runtime.CompilerServices.CompilerGeneratedAttribute::.ctor() = ( 01 00 00 00 ) 
