       ...
       extends [runtime]System.Object
{
  ...
  .method public specialname static class [ComputationExprLibrary]Library.Eventually`1<int32> get_res5() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldsfld     class [ComputationExprLibrary]Library.Eventually`1<int32> Program::res5@7
    IL_0005:  ret
  } 
  ...
  .method assembly specialname static void staticInitialization@() cil managed
  {
    ...
    IL_0012:  stsfld     class [ComputationExprLibrary]Library.Eventually`1<int32> Program::res5@7
    IL_0017:  call       class [ComputationExprLibrary]Library.Eventually`1<int32> Program::get_res5()
    IL_001c:  stloc.1
    IL_001d:  ldloc.1
