       ...
       extends [runtime]System.Object
{
         ...
         extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [ComputationExprLibrary]Library.Eventually`1<class [FSharp.Core]Microsoft.FSharp.Core.Unit>>
  {
    ...
    .method public strict virtual instance class [ComputationExprLibrary]Library.Eventually`1<class [FSharp.Core]Microsoft.FSharp.Core.Unit> Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar) cil managed
    {
      ...
      IL_002a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_002f:  pop
      IL_0030:  ldstr      "hello"
      ...
      IL_003a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_003f:  pop
      IL_0040:  ldstr      "hello"
      ...
      IL_004a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_004f:  pop
      IL_0050:  ldarg.0
  ...
  .method public specialname static class [ComputationExprLibrary]Library.Eventually`1<int32> get_res6() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldsfld     class [ComputationExprLibrary]Library.Eventually`1<int32> Program::res6@7
    IL_0005:  ret
  } 
  ...
  .method assembly specialname static void staticInitialization@() cil managed
  {
    ...
    .maxstack  4
    .locals init (class [ComputationExprLibrary]Library.EventuallyBuilder V_0,
    ...
    IL_0012:  stsfld     class [ComputationExprLibrary]Library.Eventually`1<int32> Program::res6@7
    IL_0017:  call       class [ComputationExprLibrary]Library.Eventually`1<int32> Program::get_res6()
    IL_001c:  stloc.1
    IL_001d:  ldloc.1
