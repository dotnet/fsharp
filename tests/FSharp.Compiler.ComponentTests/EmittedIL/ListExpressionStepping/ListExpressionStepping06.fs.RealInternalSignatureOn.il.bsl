       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
    ...
    .method public specialname static class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> get_es() cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldsfld     class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> ListExpressionSteppingTest6/ListExpressionSteppingTest6::es@5
      IL_0005:  ret
    } 
    ...
    .method public static class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> f7() cil managed
    {
      ...
      .locals init (valuetype [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.ListCollector`1<int32> V_0,
               ...
               class [runtime]System.Collections.Generic.IEnumerator`1<int32> V_4,
               int32 V_5,
      ...
      .try
      {
        ...
        IL_0037:  leave.s    IL_004b

      }  
      finally
      {
        IL_0039:  ldloc.1
        IL_003a:  isinst     [runtime]System.IDisposable
        IL_003f:  stloc.3
        IL_0040:  ldloc.3
      ...
      IL_004b:  nop
      IL_004c:  call       class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> ListExpressionSteppingTest6/ListExpressionSteppingTest6::get_es()
      IL_0051:  callvirt   instance class [runtime]System.Collections.Generic.IEnumerator`1<!0> class [runtime]System.Collections.Generic.IEnumerable`1<int32>::GetEnumerator()
      IL_0056:  stloc.s    V_4
      .try
      {
        IL_0058:  br.s       IL_007d

        IL_005a:  ldloc.s    V_4
        IL_005c:  callvirt   instance !0 class [runtime]System.Collections.Generic.IEnumerator`1<int32>::get_Current()
        IL_0061:  stloc.s    V_5
        IL_0063:  ldstr      "goodbye"
        ...
        IL_0075:  ldloc.s    V_5
        IL_0077:  call       instance void valuetype [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.ListCollector`1<int32>::Add(!0)
        IL_007c:  nop
        IL_007d:  ldloc.s    V_4
        IL_007f:  callvirt   instance bool [runtime]System.Collections.IEnumerator::MoveNext()
        IL_0084:  brtrue.s   IL_005a

        IL_0086:  leave.s    IL_009e

      }  
      finally
      {
        IL_0088:  ldloc.s    V_4
        IL_008a:  isinst     [runtime]System.IDisposable
        IL_008f:  stloc.s    V_6
        IL_0091:  ldloc.s    V_6
        IL_0093:  brfalse.s  IL_009d

        IL_0095:  ldloc.s    V_6
        IL_0097:  callvirt   instance void [runtime]System.IDisposable::Dispose()
        IL_009c:  endfinally
        IL_009d:  endfinally
      }  
      IL_009e:  ldloca.s   V_0
      IL_00a0:  call       instance class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<!0> valuetype [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.ListCollector`1<int32>::Close()
      IL_00a5:  ret
    } 
    ...
    .method assembly static void  staticInitialization@() cil managed
    {
      ...
      IL_0012:  call       class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<!0> class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32>::Cons(!0,
                                                                                                                                                                      class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<!0>)
      IL_0017:  stsfld     class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> ListExpressionSteppingTest6/ListExpressionSteppingTest6::es@5
      IL_001c:  call       class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> ListExpressionSteppingTest6/ListExpressionSteppingTest6::f7()
      IL_0021:  pop
      IL_0022:  ret
    } 
  ...
  .method assembly static void  staticInitialization@() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  call       void ListExpressionSteppingTest6/ListExpressionSteppingTest6::staticInitialization@()
    IL_0005:  ret
  } 
       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  main@() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  call       void ListExpressionSteppingTest6::staticInitialization@()
    IL_0005:  ret
  } 
