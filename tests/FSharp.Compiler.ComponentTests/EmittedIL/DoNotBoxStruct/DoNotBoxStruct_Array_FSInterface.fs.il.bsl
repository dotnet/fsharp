       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  F<(class [FSharp.Core]Microsoft.FSharp.Control.IEvent`2<class [FSharp.Core]Microsoft.FSharp.Control.FSharpHandler`1<int32>,int32>) T>(!!T[] x) cil managed
  {
    ...
    IL_0002:  ldelem     !!T
    IL_0007:  box        !!T
    IL_000c:  unbox.any  class [runtime]System.IObservable`1<int32>
    IL_0011:  ldsfld     class Program/F@6 Program/F@6::@_instance
    IL_0016:  tail.
    IL_0018:  call       void [FSharp.Core]Microsoft.FSharp.Control.CommonExtensions::AddToObservable<int32>(class [runtime]System.IObservable`1<!!0>,
