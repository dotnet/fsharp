...
.mresource public FSharpSignatureData.DoNotBoxStruct_NoArray_FSInterface
{
  ...
  // WARNING: managed resource file FSharpSignatureData.DoNotBoxStruct_NoArray_FSInterface created
}
.mresource public FSharpOptimizationData.DoNotBoxStruct_NoArray_FSInterface
{
  // Offset: 0x000002B0 Length: 0x00000081
  // WARNING: managed resource file FSharpOptimizationData.DoNotBoxStruct_NoArray_FSInterface created
}
.module DoNotBoxStruct_NoArray_FSInterface.exe
// MVID: {622FB631-3F8A-B9D0-A745-038331B62F62}
       ...
       extends [mscorlib]System.Object
{
  ...
  .method public static void  F<(class [FSharp.Core]Microsoft.FSharp.Control.IEvent`2<class [FSharp.Core]Microsoft.FSharp.Control.FSharpHandler`1<int32>,int32>) T>(!!T x) cil managed
  {
    ...
    IL_000b:  ldsfld     class Program/F@6 Program/F@6::@_instance
    IL_0010:  tail.
...
.class private abstract auto ansi sealed '<StartupCode$DoNotBoxStruct_NoArray_FSInterface>'.$Program
       extends [mscorlib]System.Object
{
...
} // end of class '<StartupCode$DoNotBoxStruct_NoArray_FSInterface>'.$Program


// =============================================================

// *********** DISASSEMBLY COMPLETE ***********************
// WARNING: Created Win32 resource file C:\kevinransom\fsharp\artifacts\bin\FSharp.Compiler.ComponentTests\Debug\net472\tests\EmittedIL\DoNotBoxStruct\DoNotBoxStruct_NoArray_FSInterface_fs\DoNotBoxStruct_NoArray_FSInterface.res
