       ...
       extends [runtime]System.Object
{
         ...
         extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit>
  {
    ...
    .method public strict virtual instance class [FSharp.Core]Microsoft.FSharp.Core.Unit Invoke(int32 x) cil managed
    {
  ...
  .method public static void  F<(class [FSharp.Core]Microsoft.FSharp.Control.IEvent`2<class [FSharp.Core]Microsoft.FSharp.Control.FSharpHandler`1<int32>,int32>) T>(!!T x) cil managed
  {
    ...
    IL_0000:  ldarg.0
    IL_0001:  box        !!T
    IL_0006:  unbox.any  class [runtime]System.IObservable`1<int32>
    IL_000b:  ldsfld     class Program/F@6 Program/F@6::@_instance
    IL_0010:  tail.
    IL_0012:  call       void [FSharp.Core]Microsoft.FSharp.Control.CommonExtensions::AddToObservable<int32>(class [runtime]System.IObservable`1<!!0>,
