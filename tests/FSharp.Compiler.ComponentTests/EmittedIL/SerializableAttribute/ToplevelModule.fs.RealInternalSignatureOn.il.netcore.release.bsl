       ...
       extends [runtime]System.Object
{
                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
    ...
    .method assembly hidebysig specialname instance object  __DebugDisplay() cil managed
    {
      ...
      IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class ABC/Expr,string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
      IL_000f:  ldarg.0
         ...
         implements [runtime]System.Collections.IStructuralEquatable
  {
    ...
    .method public strict virtual instance string get_Message() cil managed
    {
      ...
      IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class ABC/MyExn,string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
      IL_000f:  ldarg.0
         ...
         extends [runtime]System.Object
  {
                      ...
                      [runtime]System.Collections.IStructuralComparable
    {
      ...
      .method assembly hidebysig specialname instance object  __DebugDisplay() cil managed
      {
        ...
        IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class ABC/ABC/Expr,string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
        IL_000f:  ldarg.0
           ...
           implements [runtime]System.Collections.IStructuralEquatable
    {
      ...
      .method public strict virtual instance string get_Message() cil managed
      {
        ...
        IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class ABC/ABC/MyExn,string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
        IL_000f:  ldarg.0
