...
.mresource public FSharpSignatureData.TestFunction06
{
  // Offset: 0x00000000 Length: 0x00000241
  // WARNING: managed resource file FSharpSignatureData.TestFunction06 created
}
.mresource public FSharpOptimizationData.TestFunction06
{
  // Offset: 0x00000248 Length: 0x00000098
  // WARNING: managed resource file FSharpOptimizationData.TestFunction06 created
}
.module TestFunction06.exe
// MVID: {624E2CBA-A705-45C5-A745-0383BA2C4E62}
...
.class public abstract auto ansi sealed TestFunction06
       extends [mscorlib]System.Object
{
  ...
  {
    .field static assembly initonly class TestFunction06/f@11 @_instance
            ...
            Invoke(class [FSharp.Core]Microsoft.FSharp.Core.Unit unitVar0) cil managed
    {
      ...
      IL_0000:  call       int32 TestFunction06::TestFunction1()
      IL_0005:  stloc.0
      IL_0006:  ldstr      "Hello"
            ...
            void  .cctor() cil managed
    {
      // Code size       11 (0xb)
      .maxstack  10
      IL_0000:  newobj     instance void TestFunction06/f@11::.ctor()
      IL_0005:  stsfld     class TestFunction06/f@11 TestFunction06/f@11::@_instance
      IL_000a:  ret
  ...
  .method public static int32  TestFunction1() cil managed
  {
    ...
    IL_0022:  add
    IL_0023:  ret
  } // end of method TestFunction06::TestFunction1
  ...
  .method public static int32  TestFunction6() cil managed
  {
    ...
    IL_0000:  ldsfld     class TestFunction06/f@11 TestFunction06/f@11::@_instance
    IL_0005:  stloc.0
    IL_0006:  ldloc.0
    IL_0007:  ldnull
    ...
    IL_0014:  add
    IL_0015:  ret
  } // end of method TestFunction06::TestFunction6

} // end of class TestFunction06

.class private abstract auto ansi sealed '<StartupCode$TestFunction06>'.$TestFunction06
       extends [mscorlib]System.Object
{
  .method public static void  main@() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ret
  } // end of method $TestFunction06::main@

} // end of class '<StartupCode$TestFunction06>'.$TestFunction06


// =============================================================

// *********** DISASSEMBLY COMPLETE ***********************
// WARNING: Created Win32 resource file C:\kevinransom\fsharp\artifacts\bin\FSharp.Compiler.ComponentTests\Debug\net472\tests\EmittedIL\TestFunctions\TestFunction06_fs\TestFunction06.res
