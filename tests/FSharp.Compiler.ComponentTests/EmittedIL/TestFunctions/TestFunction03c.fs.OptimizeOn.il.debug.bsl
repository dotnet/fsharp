       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  TestFunction3c() cil managed
  {
    ...
    catch [runtime]System.Object 
    {
      ...
      IL_0033:  stloc.1
      IL_0034:  ldloc.1
      IL_0035:  call       class [FSharp.Core]Microsoft.FSharp.Core.FSharpOption`1<string> [FSharp.Core]Microsoft.FSharp.Core.Operators::FailurePattern(class [runtime]System.Exception)
      IL_003a:  stloc.2
      IL_003b:  ldloc.2
      IL_003c:  brfalse.s  IL_0069

      IL_003e:  ldloc.2
      IL_003f:  call       instance !0 class [FSharp.Core]Microsoft.FSharp.Core.FSharpOption`1<string>::get_Value()
      IL_0044:  ldstr      "hello"
      IL_0049:  call       bool [netstandard]System.String::Equals(string,
                                                                   string)
      IL_004e:  brfalse.s  IL_0069

      IL_0050:  ldloc.2
      IL_0051:  call       instance !0 class [FSharp.Core]Microsoft.FSharp.Core.FSharpOption`1<string>::get_Value()
      IL_0056:  stloc.3
      IL_0057:  ldstr      "World"
      IL_005c:  newobj     instance void class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`5<class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>::.ctor(string)
      IL_0061:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_0066:  pop
      IL_0067:  leave.s    IL_0074

      IL_0069:  rethrow
      IL_006b:  ldnull
      IL_006c:  unbox.any  [FSharp.Core]Microsoft.FSharp.Core.Unit
      IL_0071:  pop
