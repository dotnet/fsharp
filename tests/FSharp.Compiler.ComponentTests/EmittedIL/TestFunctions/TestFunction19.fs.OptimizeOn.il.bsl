       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  assembly(int32 inp) cil managed
  {
    ...
    IL_0026:  stloc.2
    IL_0027:  ldloc.2
    IL_0028:  newobj     instance void assembly/assembly@11::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class assembly/C,class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class assembly/C,class [FSharp.Core]Microsoft.FSharp.Core.Unit>>)
    IL_002d:  ldloc.0
    IL_002e:  ldloc.1
