...
.mresource public FSharpSignatureData.TestFunction09b3
{
  // Offset: 0x00000000 Length: 0x00000240
  // WARNING: managed resource file FSharpSignatureData.TestFunction09b3 created
}
.mresource public FSharpOptimizationData.TestFunction09b3
{
  // Offset: 0x00000248 Length: 0x00000085
  // WARNING: managed resource file FSharpOptimizationData.TestFunction09b3 created
}
.module TestFunction09b3.exe
// MVID: {624E2CBA-CE7E-2928-A745-0383BA2C4E62}
...
.class public abstract auto ansi sealed TestFunction09b3
       extends [mscorlib]System.Object
{
  ...
  .method public static string  TestFunction9b(class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> x) cil managed
  {
    ...
    IL_0193:  ldstr      "big"
    IL_0198:  ret
  } // end of method TestFunction09b3::TestFunction9b

} // end of class TestFunction09b3

.class private abstract auto ansi sealed '<StartupCode$TestFunction09b3>'.$TestFunction09b3
       extends [mscorlib]System.Object
{
  .method public static void  main@() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ret
  } // end of method $TestFunction09b3::main@

} // end of class '<StartupCode$TestFunction09b3>'.$TestFunction09b3


// =============================================================

// *********** DISASSEMBLY COMPLETE ***********************
// WARNING: Created Win32 resource file C:\kevinransom\fsharp\artifacts\bin\FSharp.Compiler.ComponentTests\Debug\net472\tests\EmittedIL\TestFunctions\TestFunction09b3_fs\TestFunction09b3.res
