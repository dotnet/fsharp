       ...
       extends [runtime]System.Object
{
                    ...
                    [runtime]System.Collections.IStructuralComparable
  {
    ...
    .method public strict virtual instance string ToString() cil managed
    {
      ...
      IL_000a:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.PrintfExtensions::PrintFormatToString<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class assembly/R,string>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [FSharp.Core]Microsoft.FSharp.Core.Unit,string,string>)
      IL_000f:  ldarg.0
