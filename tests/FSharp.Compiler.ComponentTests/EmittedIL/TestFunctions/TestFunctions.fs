...
module TestFunctions =
    ...
    [<Theory; FileInlineData("TestFunction01.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction02.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction03.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction03b.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction03c.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction04.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction05.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction06.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction07.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction08.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction09.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction09b.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction09b1.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction09b2.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction09b3.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction09b4.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction10.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction11.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction12.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction13.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction14.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction15.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction16.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction17.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction18.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction19.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction20.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction21.fs")>]
    ...
    [<Theory; FileInlineData("TestFunction22.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22b.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22c.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22d.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22e.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22f.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22g.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction22h.fs", Realsig=BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TestFunction24.fs")>]
    ...
    // Verify Execution 13043 run it built not optimized with debug
    [<Theory; FileInlineData("Verify13043.fs", Realsig=BooleanOptions.Both, Optimize=BooleanOptions.Both)>]
    let ``Verify13043_Baselines`` compilation =
        compilation
        |> getCompilation
        |> withDebug
        |> withRealInternalSignatureOff
