       ...
       extends [runtime]System.Object
{
  ...
  .class auto autochar serializable sealed nested assembly beforefieldinit specialname extensionEta@18
         extends [runtime]System.Object
  {
    ...
    .method public specialname rtspecialname instance void  .ctor(class assembly/Holder h) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  stfld      class assembly/Holder assembly/extensionEta@18::h
      IL_0007:  ldarg.0
    ...
    .method assembly hidebysig instance int32 Invoke(int32 a, int32 b) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class assembly/Holder assembly/extensionEta@18::h
      IL_0006:  ldarg.1
      IL_0007:  ldarg.2
  ...
  .method public static class [runtime]System.Func`3<int32,int32,int32> extensionEta(class assembly/Holder h) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldarg.0
    IL_0001:  newobj     instance void assembly/extensionEta@18::.ctor(class assembly/Holder)
    IL_0006:  ldftn      instance int32 assembly/extensionEta@18::Invoke(int32,
                                                                                        int32)
