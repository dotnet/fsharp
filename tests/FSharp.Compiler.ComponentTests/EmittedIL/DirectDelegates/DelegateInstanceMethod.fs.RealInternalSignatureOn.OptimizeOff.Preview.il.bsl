       ...
       extends [runtime]System.Object
{
  ...
  .class auto autochar serializable sealed nested assembly beforefieldinit specialname case10_nonEta@12
         extends [runtime]System.Object
  {
    ...
    .method public specialname rtspecialname instance void  .ctor(class assembly/C o) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  stfld      class assembly/C assembly/case10_nonEta@12::o
      IL_0007:  ldarg.0
    ...
    .method assembly hidebysig instance void Invoke(int32 delegateArg0, int32 delegateArg1) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class assembly/C assembly/case10_nonEta@12::o
      IL_0006:  ldarg.1
      IL_0007:  ldarg.2
  ...
  .class auto autochar serializable sealed nested assembly beforefieldinit specialname case11_etaCurried@15
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
    .field public class assembly/C o
    .method public specialname rtspecialname instance void  .ctor(class assembly/C o) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  stfld      class assembly/C assembly/case11_etaCurried@15::o
      IL_0007:  ldarg.0
      IL_0008:  call       instance void [runtime]System.Object::.ctor()
      IL_000d:  ret
    } 
    ...
    .method assembly hidebysig instance void Invoke(int32 a, int32 b) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class assembly/C assembly/case11_etaCurried@15::o
      IL_0006:  ldarg.1
      IL_0007:  ldarg.2
      IL_0008:  callvirt   instance void assembly/C::AddC(int32,
                                                                        int32)
  ...
  .class auto autochar serializable sealed nested assembly beforefieldinit specialname case12_etaTupled@18
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
    .field public class assembly/C o
    .method public specialname rtspecialname instance void  .ctor(class assembly/C o) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  stfld      class assembly/C assembly/case12_etaTupled@18::o
      IL_0007:  ldarg.0
      IL_0008:  call       instance void [runtime]System.Object::.ctor()
      IL_000d:  ret
    } 
    ...
    .method assembly hidebysig instance void Invoke(int32 a, int32 b) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class assembly/C assembly/case12_etaTupled@18::o
      IL_0006:  ldarg.1
      IL_0007:  ldarg.2
  ...
  .method public static class [runtime]System.Action`2<int32,int32> case10_nonEta(class assembly/C o) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldarg.0
    IL_0001:  newobj     instance void assembly/case10_nonEta@12::.ctor(class assembly/C)
    IL_0006:  ldftn      instance void assembly/case10_nonEta@12::Invoke(int32,
                                                                                       int32)
  ...
  .method public static class [runtime]System.Action`2<int32,int32> case11_etaCurried(class assembly/C o) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldarg.0
    IL_0001:  newobj     instance void assembly/case11_etaCurried@15::.ctor(class assembly/C)
    IL_0006:  ldftn      instance void assembly/case11_etaCurried@15::Invoke(int32,
                                                                                           int32)
    IL_000c:  newobj     instance void class [runtime]System.Action`2<int32,int32>::.ctor(object,
                                                                                                 native int)
    IL_0011:  ret
  ...
  .method public static class [runtime]System.Action`2<int32,int32> case12_etaTupled(class assembly/C o) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldarg.0
    IL_0001:  newobj     instance void assembly/case12_etaTupled@18::.ctor(class assembly/C)
    IL_0006:  ldftn      instance void assembly/case12_etaTupled@18::Invoke(int32,
                                                                                          int32)
    IL_000c:  newobj     instance void class [runtime]System.Action`2<int32,int32>::.ctor(object,
                                                                                                 native int)
    IL_0011:  ret
