       ...
       extends [runtime]System.Object
{
         ...
         extends [runtime]System.Object
  {
                                         ...
                                         int32 b) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  call       void class assembly/G`1<string>::SMc<int32>(!!0,
                                                                                          !!0)
      IL_0007:  nop
      IL_0008:  ret
    } 
         ...
         extends [runtime]System.Object
  {
                                         ...
                                         int32 b) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  call       void class assembly/G`1<string>::SMt<int32>(!!0,
                                                                                          !!0)
      IL_0007:  nop
      IL_0008:  ret
    } 
  ...
  .method public static class [runtime]System.Action`2<int32,int32> case19_nonEta() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldnull
    IL_0001:  ldftn      void class assembly/G`1<string>::SMc<int32>(!!0,
                                                                                        !!0)
