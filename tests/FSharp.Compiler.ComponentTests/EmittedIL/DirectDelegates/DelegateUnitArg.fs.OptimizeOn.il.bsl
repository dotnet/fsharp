       ...
       extends [runtime]System.Object
{
  ...
  .class abstract auto autochar serializable sealed nested assembly beforefieldinit specialname caseUnitInstanceNonEta@17
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
    .method assembly static void  Invoke() cil managed
  ...
  .class abstract auto autochar serializable sealed nested assembly beforefieldinit specialname caseUnitInstanceEta@20
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
    .method assembly static void  Invoke() cil managed
  ...
  .method public static class [runtime]System.Action caseUnitInstanceNonEta(class assembly/C c) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldnull
    IL_0001:  ldftn      void assembly/caseUnitInstanceNonEta@17::Invoke()
    IL_0007:  newobj     instance void [runtime]System.Action::.ctor(object,
                                                                            native int)
    IL_000c:  ret
  } 
  ...
  .method public static class [runtime]System.Action caseUnitInstanceEta(class assembly/C c) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldnull
    IL_0001:  ldftn      void assembly/caseUnitInstanceEta@20::Invoke()
    IL_0007:  newobj     instance void [runtime]System.Action::.ctor(object,
                                                                            native int)
    IL_000c:  ret
  } 
