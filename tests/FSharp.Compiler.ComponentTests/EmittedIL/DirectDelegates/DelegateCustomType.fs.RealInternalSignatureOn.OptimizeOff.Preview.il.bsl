       ...
       extends [runtime]System.Object
{
  ...
  .class abstract auto autochar serializable sealed nested assembly beforefieldinit specialname tupledEta@28
         extends [runtime]System.Object
  {
  ...
  .class auto autochar serializable sealed nested assembly beforefieldinit specialname instanceEta@32
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
    ...
    .method public specialname rtspecialname instance void  .ctor(class assembly/C c) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  stfld      class assembly/C assembly/instanceEta@32::c
      IL_0007:  ldarg.0
    ...
    .method assembly hidebysig instance int32 Invoke(int32 a, int32 b) cil managed
    {
      ...
      .maxstack  8
      IL_0000:  ldarg.0
      IL_0001:  ldfld      class assembly/C assembly/instanceEta@32::c
      IL_0006:  ldarg.1
      IL_0007:  ldarg.2
  ...
  .class abstract auto autochar serializable sealed nested assembly beforefieldinit specialname genEta@36
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
  ...
  .class abstract auto autochar serializable sealed nested assembly beforefieldinit specialname byrefMutate@40
         extends [runtime]System.Object
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 06 00 00 00 00 00 ) 
  ...
  .method public static class assembly/DTupled tupledEta() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldnull
    IL_0001:  ldftn      int32 assembly/tupledEta@28::Invoke(int32,
                                                                       int32)
    IL_0007:  newobj     instance void assembly/DTupled::.ctor(object,
                                                                         native int)
    IL_000c:  ret
  ...
  .method public static class assembly/DTupled instanceEta(class assembly/C c) cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldarg.0
    IL_0001:  newobj     instance void assembly/instanceEta@32::.ctor(class assembly/C)
    IL_0006:  ldftn      instance int32 assembly/instanceEta@32::Invoke(int32,
                                                                                  int32)
  ...
  .method public static class assembly/DGen`1<int32> genEta() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldnull
    IL_0001:  ldftn      int32 assembly/genEta@36::Invoke(int32)
    IL_0007:  newobj     instance void class assembly/DGen`1<int32>::.ctor(object,
                                                                                     native int)
    IL_000c:  ret
  } 
  ...
  .method public static class assembly/DByref byrefMutate() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  ldnull
    IL_0001:  ldftn      void assembly/byrefMutate@40::Invoke(int32&)
