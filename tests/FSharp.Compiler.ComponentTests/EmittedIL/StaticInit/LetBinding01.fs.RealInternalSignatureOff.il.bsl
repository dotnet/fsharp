       ...
       extends [runtime]System.Object
{
  ...
  .method public static void  main@() cil managed
  {
    ...
    .maxstack  8
    IL_0000:  call       class [FSharp.Core]Microsoft.FSharp.Core.Unit assembly::get_x()
    IL_0005:  pop
    IL_0006:  ldstr      "x = %A"
    ...
    IL_0010:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [runtime]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
    IL_0015:  call       class [FSharp.Core]Microsoft.FSharp.Core.Unit assembly::get_x()
