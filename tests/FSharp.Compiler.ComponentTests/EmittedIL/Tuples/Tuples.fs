...
module Tuples =
    ...
    [<Theory; FileInlineData("Tuple01.fs", Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple02.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple03.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple04.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple05.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple06.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple07.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("Tuple08.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("OptionalArg01.fs", Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TupleMonster.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("TupleElimination.fs", Optimize = BooleanOptions.Both)>]
    ...
    [<Theory; FileInlineData("ValueTupleAliasConstructor.fs", Realsig = BooleanOptions.Both, Optimize = BooleanOptions.Both)>]
