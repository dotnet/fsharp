...
let testPatterns handler source =
    ...
    let checker =
        FSharpChecker.Create(documentSource = DocumentSource.Custom documentSource, keepAssemblyContents = true, useTransparentCompiler = CompilerAssert.UseTransparentCompiler)
