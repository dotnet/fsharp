...
"""
    ...
    |> shouldEqual
        [|("LiteralAttribute", (3, 10, 3, 17))
          ...
          ("member .ctor", (3, 11, 3, 17)) // Also registered as Item.Value
          ...
          ("member .ctor", (11, 11, 11, 17)) // Also registered as Item.Value
          ("val ClassValue", (11, 20, 11, 30))
          ("LiteralAttribute", (12, 17, 12, 24))
          ("member .ctor", (12, 17, 12, 24))
          ("member .ctor", (12, 18, 12, 24)) // Also registered as Item.Value
