...
let ``Test Unoptimized Declarations Project1`` () =
    ...
    let expected =
        ["type M"; "type IntAbbrev"; "let boolEx1 = True @ (6,14--6,18)";
         ...
         "member TestCallingToString(this) (unitVar1) = this.ToString() @ (60,45--60,55)";
         ...
         "member get_InstanceEvent(x) (unitVar1) = x.ev.get_Publish(()) @ (94,32--94,39)";
         "member get_StaticEvent(x) (unitVar1) = sev.get_Publish(()) @ (95,31--95,38)";
         "let c = new ClassWithEventsAndProperties(()) @ (97,8--97,38)";
         "let v = M.c ().get_InstanceProperty(()) @ (98,10--98,26)";
         ...
         "let testFunctionThatUsesStructs1(dt) = dt.AddDays(3) @ (139,60--139,72)";
