...
let ``Test Unoptimized Declarations Project1`` () =
    ...
    let expected =
        ["type M"; "type IntAbbrev"; "let boolEx1 = True @ (6,14--6,18)";
         ...
         "member System$Console$WriteTwoLines$Static(unitVar0) = (Console.WriteLine (); Console.WriteLine ()) @ (170,36--170,90)";
         "member System$DateTime$get_TwoMinute(x) (unitVar1) = Operators.op_Addition<Microsoft.FSharp.Core.int,Microsoft.FSharp.Core.int,Microsoft.FSharp.Core.int> (fun arg0_0 -> fun arg1_0 -> LanguagePrimitives.AdditionDynamic<Microsoft.FSharp.Core.int,Microsoft.FSharp.Core.int,Microsoft.FSharp.Core.int> (arg0_0,arg1_0),x.get_Minute(),x.get_Minute()) @ (173,25--173,44)";
         "let testFunctionThatUsesExtensionMembers(unitVar0) = (M.System$Console$WriteTwoLines$Static (()); let v: Microsoft.FSharp.Core.int = DateTime.get_Now ().System$DateTime$get_TwoMinute(()) in M.System$Console$WriteTwoLines$Static (())) @ (176,3--178,33)";
