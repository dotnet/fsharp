...
""" } |]
    [| { Name = "TType_tuple - record with same type param in both tuple positions"
         Source = """
module M

type TupleRecord<'a> = { Pair: 'a * string; Extra: 'a * 'a }
""" } |]
    [| { Name = "TType_tuple - DU with generic param at both tuple nesting levels"
         Source = """
module M
...
""" } |]
    [| { Name = "TType_fun - DU with NoComparison NoEquality and self-referencing function field"
         Source = """
module M
...
""" } |]
    [| { Name = "generic record with list field and actual compare usage"
         Source = """
module M
