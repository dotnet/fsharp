...
FSharp.Compiler.CodeAnalysis.FSharpChecker: Microsoft.FSharp.Control.FSharpAsync`1[Microsoft.FSharp.Core.Unit] UpdateDocuments(FSharp.Compiler.CodeAnalysis.FSharpProjectOptions, System.Collections.Generic.IEnumerable`1[FSharp.Compiler.CodeAnalysis.FSharpDocument])
