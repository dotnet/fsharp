...
// MVID: {4DAC30CE-665B-8929-A745-0383CE30AC4D}
       ...
       extends [mscorlib]System.Object
{
  ...
  .method public static void  TestFunction4() cil managed
  {
    ...
    .try
    {
      IL_0001:  nop
      .line 11,11 : 8,31 
      IL_0002:  call       int32 TestFunction4::TestFunction1()
      IL_0007:  stloc.1
      .line 12,12 : 8,23 
      IL_0008:  ldstr      "Hello"
    ...
    finally
    {
      ...
      .line 14,14 : 8,23 
      IL_001b:  ldstr      "World"
      IL_0020:  newobj     instance void class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`5<class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [mscorlib]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>::.ctor(string)
      IL_0025:  call       !!0 [FSharp.Core]Microsoft.FSharp.Core.ExtraTopLevelOperators::PrintFormatLine<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.PrintfFormat`4<!!0,class [mscorlib]System.IO.TextWriter,class [FSharp.Core]Microsoft.FSharp.Core.Unit,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_002a:  pop
      IL_002b:  endfinally
