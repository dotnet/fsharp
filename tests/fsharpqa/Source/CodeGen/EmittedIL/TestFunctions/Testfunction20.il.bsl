...
{
  // Offset: 0x000003B0 Length: 0x00000100
}
.module TestFunction20.exe
// MVID: {4BEB28FC-A643-44FB-A745-0383FC28EB4B}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x01ED0000
       ...
       extends [mscorlib]System.Object
{
         ...
         extends [mscorlib]System.Object
  {
                                 ...
                                 int32 y) cil managed
    {
      ...
      IL_0025:  ldarg.0
      IL_0026:  ldloc.0
      IL_0027:  call       instance int32 TestFunction20/D::f(int32)
      IL_002c:  ldloc.0
      IL_002d:  add
      IL_002e:  stloc.1
      .line 4,4 : 6,7 
    ...
    .method assembly instance int32  f(int32 a) cil managed
    {
