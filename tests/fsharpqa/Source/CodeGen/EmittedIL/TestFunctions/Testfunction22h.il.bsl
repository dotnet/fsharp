...
// MVID: {620E3B70-0266-39F6-A745-0383703B0E62}
       ...
       extends [mscorlib]System.Object
{
  ...
  .method public static void  test5() cil managed
  {
    ...
    .locals init ([0] class [mscorlib]System.Exception V_0,
             [1] class [mscorlib]System.ArgumentException V_1,
             [2] class [mscorlib]System.ArgumentException a,
             [3] class [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException V_3,
             [4] string msg,
             [5] class [mscorlib]System.Exception V_5,
             [6] class [mscorlib]System.ArgumentException V_6,
             [7] class [mscorlib]System.ArgumentException V_7,
             [8] class [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException V_8,
             [9] string V_9)
    .line 32,32 : 4,7 ''
    .try
    {
    ...
    filter
    {
      ...
      IL_0010:  stloc.0
      IL_0011:  ldloc.0
      IL_0012:  isinst     [mscorlib]System.ArgumentException
      IL_0017:  stloc.1
      .line 100001,100001 : 0,0 ''
      IL_0018:  ldloc.1
      ...
      .line 100001,100001 : 0,0 ''
      IL_002f:  ldloc.0
      IL_0030:  castclass  [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException
      IL_0035:  call       instance string [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException::get_Data0()
      IL_003a:  stloc.s    msg
      .line 37,37 : 9,76 ''
      IL_003c:  ldc.i4.1
      .line 100001,100001 : 0,0 ''
    ...
    {  // handler
      IL_0044:  castclass  [mscorlib]System.Exception
      IL_0049:  stloc.s    V_5
      IL_004b:  ldloc.s    V_5
      IL_004d:  isinst     [mscorlib]System.ArgumentException
      IL_0052:  stloc.s    V_6
      .line 100001,100001 : 0,0 ''
      IL_0054:  ldloc.s    V_6
      ...
      IL_005a:  ldloc.s    V_5
      IL_005c:  isinst     [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException
      IL_0061:  stloc.s    V_8
      .line 100001,100001 : 0,0 ''
      IL_0063:  ldloc.s    V_8
      ...
      .line 36,36 : 45,80 ''
      IL_006d:  ldloc.s    V_7
      IL_006f:  callvirt   instance string [mscorlib]System.Exception::get_Message()
      IL_0074:  call       void [mscorlib]System.Console::WriteLine(string)
      IL_0079:  leave.s    IL_009d

      .line 100001,100001 : 0,0 ''
      IL_007b:  ldloc.s    V_5
      IL_007d:  castclass  [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException
      IL_0082:  call       instance string [FSharp.Core]Microsoft.FSharp.Core.MatchFailureException::get_Data0()
      IL_0087:  stloc.s    V_9
      .line 37,37 : 47,76 ''
      IL_0089:  ldloc.s    V_9
      IL_008b:  call       void [mscorlib]System.Console::WriteLine(string)
      IL_0090:  leave.s    IL_009d

      .line 100001,100001 : 0,0 ''
      IL_0092:  rethrow
      IL_0094:  ldnull
      IL_0095:  unbox.any  [FSharp.Core]Microsoft.FSharp.Core.Unit
      IL_009a:  pop
