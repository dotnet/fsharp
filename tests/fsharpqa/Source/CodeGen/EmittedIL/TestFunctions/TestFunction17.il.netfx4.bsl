...
{
  // Offset: 0x00000000 Length: 0x0000069A
}
.mresource public FSharpOptimizationData.TestFunction17
{
  // Offset: 0x000006A0 Length: 0x000001CD
}
.module TestFunction17.exe
// MVID: {4F20E3AA-A624-45A8-A745-0383AAE3204F}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x000000A07DB30000
       ...
       extends [mscorlib]System.Object
{
                    ...
                    [mscorlib]System.Collections.IStructuralComparable
  {
            ...
            instance int32  CompareTo(object obj) cil managed
    {
      ...
      IL_0008:  callvirt   instance int32 TestFunction17/R::CompareTo(class TestFunction17/R)
      IL_000d:  ret
    } // end of method R::CompareTo
            ...
            instance int32  GetHashCode() cil managed
    {
      ...
      IL_0007:  callvirt   instance int32 TestFunction17/R::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
      IL_000c:  ret
    } // end of method R::GetHashCode
            ...
            instance bool  Equals(object obj) cil managed
    {
      ...
      IL_000f:  ldarg.0
      IL_0010:  ldloc.0
      IL_0011:  callvirt   instance bool TestFunction17/R::Equals(class TestFunction17/R)
      IL_0016:  ret
