...
// MVID: {4BEB2902-A643-45E6-A745-03830229EB4B}
       ...
       extends [mscorlib]System.Object
{
                    ...
                    [mscorlib]System.Collections.IStructuralComparable
  {
            ...
            instance int32  CompareTo(class TestFunction21/U obj) cil managed
    {
      ...
      IL_0026:  stloc.3
      IL_0027:  ldloc.0
      IL_0028:  ldfld      int32 TestFunction21/U::item1
      IL_002d:  stloc.s    V_4
      IL_002f:  ldloc.1
      ...
      IL_0066:  stloc.s    V_6
      IL_0068:  ldloc.0
      IL_0069:  ldfld      int32 TestFunction21/U::item2
      IL_006e:  stloc.s    V_7
      IL_0070:  ldloc.1
      IL_0071:  ldfld      int32 TestFunction21/U::item2
      IL_0076:  stloc.s    V_8
      IL_0078:  ldloc.s    V_7
      IL_007a:  ldloc.s    V_8
            ...
            instance int32  CompareTo(object obj) cil managed
    {
      ...
      IL_0001:  ldarg.0
      IL_0002:  ldarg.1
      IL_0003:  unbox.any  TestFunction21/U
      IL_0008:  call       instance int32 TestFunction21/U::CompareTo(class TestFunction21/U)
      IL_000d:  ret
    } // end of method U::CompareTo
                                      ...
                                      class [mscorlib]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_0015:  ldarg.1
      IL_0016:  unbox.any  TestFunction21/U
      IL_001b:  ldnull
      IL_001c:  cgt.un
      ...
      IL_0036:  stloc.s    V_5
      IL_0038:  ldloc.2
      IL_0039:  ldfld      int32 TestFunction21/U::item1
      IL_003e:  stloc.s    V_6
      IL_0040:  ldloc.s    V_5
      IL_0042:  ldloc.s    V_6
      ...
      IL_006b:  stloc.s    V_7
      IL_006d:  ldloc.1
      IL_006e:  ldfld      int32 TestFunction21/U::item2
      IL_0073:  stloc.s    V_8
      IL_0075:  ldloc.2
      IL_0076:  ldfld      int32 TestFunction21/U::item2
      IL_007b:  stloc.s    V_9
      IL_007d:  ldloc.s    V_8
      IL_007f:  ldloc.s    V_9
      ...
      .line 100001,100001 : 0,0 
      IL_0092:  ldarg.1
      IL_0093:  unbox.any  TestFunction21/U
      IL_0098:  ldnull
      IL_0099:  cgt.un
            ...
            instance int32  GetHashCode(class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_0030:  stloc.3
      IL_0031:  ldloc.1
      IL_0032:  ldfld      int32 TestFunction21/U::item1
      IL_0037:  ldloc.0
      IL_0038:  ldc.i4.6
      IL_0039:  shl
      IL_003a:  ldloc.0
            ...
            instance int32  GetHashCode() cil managed
    {
      ...
      IL_0007:  call       instance int32 TestFunction21/U::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
      IL_000c:  ret
    } // end of method U::GetHashCode
                                  ...
                                  class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_000b:  ldarg.1
      IL_000c:  isinst     TestFunction21/U
      IL_0011:  stloc.0
      IL_0012:  ldloc.0
      ...
      IL_0022:  stloc.s    V_4
      IL_0024:  ldloc.2
      IL_0025:  ldfld      int32 TestFunction21/U::item1
      IL_002a:  ldloc.3
      IL_002b:  ldfld      int32 TestFunction21/U::item1
      IL_0030:  ceq
      ...
      IL_0039:  stloc.s    V_5
      IL_003b:  ldloc.2
      IL_003c:  ldfld      int32 TestFunction21/U::item2
      IL_0041:  ldloc.3
      IL_0042:  ldfld      int32 TestFunction21/U::item2
      IL_0047:  ceq
      IL_0049:  ret
            ...
            instance bool  Equals(class TestFunction21/U obj) cil managed
    {
      ...
      IL_002d:  ldloc.0
      IL_002e:  ldfld      int32 TestFunction21/U::item2
      IL_0033:  ldloc.1
      IL_0034:  ldfld      int32 TestFunction21/U::item2
      IL_0039:  ceq
      IL_003b:  ret
            ...
            instance bool  Equals(object obj) cil managed
    {
      ...
      IL_0000:  nop
      IL_0001:  ldarg.1
      IL_0002:  isinst     TestFunction21/U
      IL_0007:  stloc.0
      IL_0008:  ldloc.0
      ...
      IL_000f:  ldarg.0
      IL_0010:  ldloc.0
      IL_0011:  call       instance bool TestFunction21/U::Equals(class TestFunction21/U)
      IL_0016:  ret
         ...
         extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit>
  {
            ...
            Invoke(int32 arg20) cil managed
    {
      ...
      IL_0000:  nop
      IL_0001:  ldarg.0
      IL_0002:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit> TestFunction21/'TestFunction21@7-1'::clo2
      IL_0007:  ldarg.1
      IL_0008:  tail.
      IL_000a:  callvirt   instance !1 class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit>::Invoke(!0)
      IL_000f:  ret
         ...
         extends class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit>>
  {
            ...
            Invoke(int32 arg10) cil managed
    {
      ...
      IL_000d:  nop
      IL_000e:  ldloc.0
      IL_000f:  newobj     instance void TestFunction21/'TestFunction21@7-1'::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit>)
      IL_0014:  ret
    } // end of method TestFunction21@7::Invoke

  } // end of class TestFunction21@7

  .method public static void  TestFunction21(class TestFunction21/U _arg5) cil managed
  {
    // Code size       48 (0x30)
    .maxstack  5
    .locals init ([0] class TestFunction21/U V_0,
    ...
    IL_0020:  nop
    IL_0021:  ldloc.3
    IL_0022:  newobj     instance void TestFunction21/TestFunction21@7::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,class [FSharp.Core]Microsoft.FSharp.Core.Unit>>)
    IL_0027:  ldloc.2
    IL_0028:  ldloc.1
    IL_0029:  call       !!0 class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<int32,int32>::InvokeFast<class [FSharp.Core]Microsoft.FSharp.Core.Unit>(class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<!0,class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<!1,!!0>>,
                                                                                                                                                           !0,
                                                                                                                                                           !1)
    IL_002e:  pop
    IL_002f:  ret
