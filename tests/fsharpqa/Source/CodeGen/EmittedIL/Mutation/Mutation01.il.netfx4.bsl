...
{
  // Offset: 0x00000000 Length: 0x00000729
}
.mresource public FSharpOptimizationData.Mutation01
{
  // Offset: 0x00000730 Length: 0x00000220
}
.module Mutation01.exe
// MVID: {4F20E159-8C6A-2EAE-A745-038359E1204F}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x000000DAECEF0000
       ...
       extends [mscorlib]System.Object
{
                    ...
                    [mscorlib]System.Collections.IStructuralComparable
  {
            ...
            instance int32  CompareTo(valuetype Mutation01/Test obj) cil managed
    {
      ...
      IL_0009:  stloc.1
      IL_000a:  ldarg.0
      IL_000b:  ldfld      int32 Mutation01/Test::v
      IL_0010:  stloc.2
      IL_0011:  ldloc.0
      IL_0012:  ldfld      int32 Mutation01/Test::v
      IL_0017:  stloc.3
      IL_0018:  ldloc.2
      IL_0019:  ldloc.3
            ...
            instance int32  CompareTo(object obj) cil managed
    {
      ...
      IL_0001:  ldarg.0
      IL_0002:  ldarg.1
      IL_0003:  unbox.any  Mutation01/Test
      IL_0008:  call       instance int32 Mutation01/Test::CompareTo(valuetype Mutation01/Test)
      IL_000d:  ret
    } // end of method Test::CompareTo
                                      ...
                                      class [mscorlib]System.Collections.IComparer comp) cil managed
    {
      ...
      IL_000c:  stloc.2
      IL_000d:  ldarg.0
      IL_000e:  ldfld      int32 Mutation01/Test::v
      IL_0013:  stloc.3
      IL_0014:  ldloc.1
      IL_0015:  ldfld      int32 Mutation01/Test::v
      IL_001a:  stloc.s    V_4
      IL_001c:  ldloc.3
      IL_001d:  ldloc.s    V_4
            ...
            instance int32  GetHashCode() cil managed
    {
      ...
      IL_0007:  call       instance int32 Mutation01/Test::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
      IL_000c:  ret
    } // end of method Test::GetHashCode
                                  ...
                                  class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      .locals init (valuetype Mutation01/Test V_0,
               valuetype Mutation01/Test& V_1,
               class [mscorlib]System.Collections.IEqualityComparer V_2)
      IL_0000:  nop
      IL_0001:  ldarg.1
      IL_0002:  call       bool [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives/IntrinsicFunctions::TypeTestGeneric<valuetype Mutation01/Test>(object)
      IL_0007:  brtrue.s   IL_000b

      IL_0009:  br.s       IL_0026

      IL_000b:  ldarg.1
      IL_000c:  unbox.any  Mutation01/Test
      IL_0011:  stloc.0
      ...
      IL_0016:  stloc.2
      IL_0017:  ldarg.0
      IL_0018:  ldfld      int32 Mutation01/Test::v
      IL_001d:  ldloc.1
      IL_001e:  ldfld      int32 Mutation01/Test::v
      IL_0023:  ceq
      IL_0025:  ret
            ...
            setV<a>(!!a v) cil managed
    {
      ...
      IL_0001:  ldarg.0
      IL_0002:  ldc.i4.0
      IL_0003:  stfld      int32 Mutation01/Test::v
      IL_0008:  ret
            ...
            instance bool  Equals(valuetype Mutation01/Test obj) cil managed
    {
      ...
      IL_0003:  stloc.0
      IL_0004:  ldarg.0
      IL_0005:  ldfld      int32 Mutation01/Test::v
      IL_000a:  ldloc.0
      IL_000b:  ldfld      int32 Mutation01/Test::v
      IL_0010:  ceq
      IL_0012:  ret
            ...
            instance bool  Equals(object obj) cil managed
    {
      ...
      IL_0012:  ldarg.0
      IL_0013:  ldloc.0
      IL_0014:  call       instance bool Mutation01/Test::Equals(valuetype Mutation01/Test)
      IL_0019:  ret
