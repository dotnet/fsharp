       ...
       extends [mscorlib]System.Object
{
         ...
         extends class [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.GeneratedSequenceBase`1<int32>
  {
                                 ...
                                 int32 current) cil managed
    {
      ...
      IL_0000:  ldarg.0
      IL_0001:  ldarg.1
      IL_0002:  stfld      int32 GenIter04/squaresOfOneToTenD@4::x
      IL_0007:  ldarg.0
      IL_0008:  ldarg.2
      IL_0009:  stfld      class [mscorlib]System.Collections.Generic.IEnumerator`1<int32> GenIter04/squaresOfOneToTenD@4::'enum'
      IL_000e:  ldarg.0
      IL_000f:  ldarg.3
      IL_0010:  stfld      int32 GenIter04/squaresOfOneToTenD@4::pc
      IL_0015:  ldarg.0
      IL_0016:  ldarg.s    current
      IL_0018:  stfld      int32 GenIter04/squaresOfOneToTenD@4::current
      IL_001d:  ldarg.0
            ...
            GenerateNext(class [mscorlib]System.Collections.Generic.IEnumerable`1<int32>& next) cil managed
    {
      ...
      IL_003d:  stfld      class [mscorlib]System.Collections.Generic.IEnumerator`1<int32> GenIter04/squaresOfOneToTenD@4::'enum'
      IL_0042:  ldarg.0
      IL_0043:  ldc.i4.1
      ...
      IL_0056:  ldarg.0
      IL_0057:  ldarg.0
      IL_0058:  ldfld      class [mscorlib]System.Collections.Generic.IEnumerator`1<int32> GenIter04/squaresOfOneToTenD@4::'enum'
      IL_005d:  callvirt   instance !0 class [mscorlib]System.Collections.Generic.IEnumerator`1<int32>::get_Current()
      IL_0062:  stfld      int32 GenIter04/squaresOfOneToTenD@4::x
      IL_0067:  ldarg.0
      IL_0068:  ldc.i4.2
      IL_0069:  stfld      int32 GenIter04/squaresOfOneToTenD@4::pc
      .line 4,4 : 48,53 
      IL_006e:  ldarg.0
      IL_006f:  ldarg.0
      IL_0070:  ldfld      int32 GenIter04/squaresOfOneToTenD@4::x
      IL_0075:  ldarg.0
      IL_0076:  ldfld      int32 GenIter04/squaresOfOneToTenD@4::x
      IL_007b:  mul
      IL_007c:  stfld      int32 GenIter04/squaresOfOneToTenD@4::current
      IL_0081:  ldc.i4.1
      IL_0082:  ret
      ...
      IL_0083:  ldarg.0
      IL_0084:  ldc.i4.0
      IL_0085:  stfld      int32 GenIter04/squaresOfOneToTenD@4::x
      .line 100001,100001 : 0,0 
      IL_008a:  nop
      ...
      IL_008d:  ldarg.0
      IL_008e:  ldc.i4.3
      IL_008f:  stfld      int32 GenIter04/squaresOfOneToTenD@4::pc
      .line 4,4 : 28,53 
      IL_0094:  ldarg.0
      IL_0095:  ldfld      class [mscorlib]System.Collections.Generic.IEnumerator`1<int32> GenIter04/squaresOfOneToTenD@4::'enum'
      ...
      IL_00a0:  ldarg.0
      IL_00a1:  ldnull
      IL_00a2:  stfld      class [mscorlib]System.Collections.Generic.IEnumerator`1<int32> GenIter04/squaresOfOneToTenD@4::'enum'
      IL_00a7:  ldarg.0
      IL_00a8:  ldc.i4.3
      IL_00a9:  stfld      int32 GenIter04/squaresOfOneToTenD@4::pc
      IL_00ae:  ldarg.0
      IL_00af:  ldc.i4.0
      IL_00b0:  stfld      int32 GenIter04/squaresOfOneToTenD@4::current
      IL_00b5:  ldc.i4.0
      IL_00b6:  ret
            ...
            Close() cil managed
    {
      ...
      IL_0001:  stloc.0
      IL_0002:  ldarg.0
      IL_0003:  ldfld      int32 GenIter04/squaresOfOneToTenD@4::pc
      IL_0008:  ldc.i4.3
      IL_0009:  sub
      IL_000a:  switch     ( 
                            IL_0015)
      ...
      {
        IL_001c:  ldarg.0
        IL_001d:  ldfld      int32 GenIter04/squaresOfOneToTenD@4::pc
        IL_0022:  switch     ( 
                              IL_0039,
                              IL_003b,
                              IL_003d,
        ...
        IL_004f:  ldarg.0
        IL_0050:  ldc.i4.3
        IL_0051:  stfld      int32 GenIter04/squaresOfOneToTenD@4::pc
        IL_0056:  ldarg.0
        IL_0057:  ldfld      class [mscorlib]System.Collections.Generic.IEnumerator`1<int32> GenIter04/squaresOfOneToTenD@4::'enum'
        ...
        IL_0063:  ldarg.0
        IL_0064:  ldc.i4.3
        IL_0065:  stfld      int32 GenIter04/squaresOfOneToTenD@4::pc
        IL_006a:  ldarg.0
        IL_006b:  ldc.i4.0
        IL_006c:  stfld      int32 GenIter04/squaresOfOneToTenD@4::current
        IL_0071:  ldnull
        IL_0072:  stloc.1
            ...
            get_CheckClose() cil managed
    {
      ...
      IL_0000:  nop
      IL_0001:  ldarg.0
      IL_0002:  ldfld      int32 GenIter04/squaresOfOneToTenD@4::pc
      IL_0007:  switch     ( 
                            IL_001e,
                            IL_0020,
                            IL_0022,
            ...
            get_LastGenerated() cil managed
    {
      ...
      IL_0000:  nop
      IL_0001:  ldarg.0
      IL_0002:  ldfld      int32 GenIter04/squaresOfOneToTenD@4::current
      IL_0007:  ret
            ...
            GetFreshEnumerator() cil managed
    {
      ...
      IL_0003:  ldc.i4.0
      IL_0004:  ldc.i4.0
      IL_0005:  newobj     instance void GenIter04/squaresOfOneToTenD@4::.ctor(int32,
       ...
       extends [mscorlib]System.Object
{
  ...
  .method public static void  main@() cil managed
  {
    ...
    IL_000f:  dup
    IL_0010:  stsfld     class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> '<StartupCode$GenIter04>'.$GenIter04::squaresOfOneToTenD@4
    IL_0015:  stloc.0
    IL_0016:  ret
