...
// MVID: {621F7967-37F5-C118-A745-038367791F62}
       ...
       extends [mscorlib]System.Object
{
         ...
         implements [mscorlib]System.Collections.IStructuralEquatable
  {
                   ...
                   class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
    {
      ...
      IL_002c:  ldloc.1
      IL_002d:  castclass  ABC/MyExn
      IL_0032:  call       instance int32 ABC/MyExn::get_Data0()
      IL_0037:  ceq
      IL_0039:  ret
            ...
            Equals(class [mscorlib]System.Exception obj) cil managed
    {
      ...
      .line 100001,100001 : 0,0 ''
      IL_0019:  ldarg.0
      IL_001a:  castclass  ABC/MyExn
      IL_001f:  call       instance int32 ABC/MyExn::get_Data0()
      IL_0024:  ldarg.1
      IL_0025:  castclass  ABC/MyExn
      IL_002a:  call       instance int32 ABC/MyExn::get_Data0()
      IL_002f:  ceq
      IL_0031:  ret
         ...
         extends [mscorlib]System.Object
  {
           ...
           implements [mscorlib]System.Collections.IStructuralEquatable
    {
                     ...
                     class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_002c:  ldloc.1
        IL_002d:  castclass  ABC/ABC/MyExn
        IL_0032:  call       instance int32 ABC/ABC/MyExn::get_Data0()
        IL_0037:  ceq
        IL_0039:  ret
              ...
              Equals(class [mscorlib]System.Exception obj) cil managed
      {
        ...
        .line 100001,100001 : 0,0 ''
        IL_0019:  ldarg.0
        IL_001a:  castclass  ABC/ABC/MyExn
        IL_001f:  call       instance int32 ABC/ABC/MyExn::get_Data0()
        IL_0024:  ldarg.1
        IL_0025:  castclass  ABC/ABC/MyExn
        IL_002a:  call       instance int32 ABC/ABC/MyExn::get_Data0()
        IL_002f:  ceq
        IL_0031:  ret
