...
.module SeqExpressionSteppingTest2.dll
// MVID: {4D94A77B-241E-09B2-A745-03837BA7944D}
       ...
       extends [mscorlib]System.Object
{
  ...
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 07 00 00 00 00 00 ) 
    .class auto autochar serializable sealed nested assembly beforefieldinit specialname f1@4
           extends class [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.GeneratedSequenceBase`1<int32>
    {
                                   ...
                                   int32 current) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldarg.1
        IL_0002:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        IL_0007:  ldarg.0
        IL_0008:  ldarg.2
        IL_0009:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::current
        IL_000e:  ldarg.0
        IL_000f:  call       instance void class [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.GeneratedSequenceBase`1<int32>::.ctor()
        IL_0014:  ret
      } // end of method f1@4::.ctor
              ...
              GenerateNext(class [mscorlib]System.Collections.Generic.IEnumerable`1<int32>& next) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        IL_0006:  ldc.i4.1
        IL_0007:  sub
        IL_0008:  switch     ( 
                              IL_001b,
        ...
        IL_003b:  ldarg.0
        IL_003c:  ldc.i4.1
        IL_003d:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        .line 5,5 : 15,22 
        IL_0042:  ldarg.0
        IL_0043:  ldc.i4.1
        IL_0044:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::current
        IL_0049:  ldc.i4.1
        IL_004a:  ret
        ...
        IL_005b:  ldarg.0
        IL_005c:  ldc.i4.2
        IL_005d:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        .line 7,7 : 15,22 
        IL_0062:  ldarg.0
        IL_0063:  ldc.i4.2
        IL_0064:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::current
        IL_0069:  ldc.i4.1
        IL_006a:  ret

        IL_006b:  ldarg.0
        IL_006c:  ldc.i4.3
        IL_006d:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        IL_0072:  ldarg.0
        IL_0073:  ldc.i4.0
        IL_0074:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::current
        IL_0079:  ldc.i4.0
        IL_007a:  ret
      } // end of method f1@4::GenerateNext
              ...
              Close() cil managed
      {
        ...
        IL_0001:  ldarg.0
        IL_0002:  ldc.i4.3
        IL_0003:  stfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        IL_0008:  ret
      } // end of method f1@4::Close
              ...
              get_CheckClose() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::pc
        IL_0007:  switch     ( 
                              IL_001e,
                              IL_0020,
                              IL_0022,
        ...
        IL_0037:  ldc.i4.0
        IL_0038:  ret
      } // end of method f1@4::get_CheckClose
              ...
              get_LastGenerated() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      int32 SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::current
        IL_0007:  ret
      } // end of method f1@4::get_LastGenerated
              ...
              GetFreshEnumerator() cil managed
      {
        ...
        IL_0001:  ldc.i4.0
        IL_0002:  ldc.i4.0
        IL_0003:  newobj     instance void SeqExpressionSteppingTest2/SeqExpressionSteppingTest2/f1@4::.ctor(int32,
                                                                                                             int32)
        IL_0008:  ret
      } // end of method f1@4::GetFreshEnumerator
       ...
       extends [mscorlib]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_000b:  pop
    IL_000c:  ret
  } // end of method $SeqExpressionSteppingTest2::.cctor
