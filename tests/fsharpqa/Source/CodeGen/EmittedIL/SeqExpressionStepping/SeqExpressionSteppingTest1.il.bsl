...
.module SeqExpressionSteppingTest1.dll
// MVID: {4D94A755-241E-090F-A745-038355A7944D}
         ...
         extends [mscorlib]System.Object
  {
           ...
           extends class [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.GeneratedSequenceBase`1<int32>
    {
                                   ...
                                   int32 current) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldarg.1
        IL_0002:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::pc
        IL_0007:  ldarg.0
        IL_0008:  ldarg.2
        IL_0009:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::current
        IL_000e:  ldarg.0
              ...
              GenerateNext(class [mscorlib]System.Collections.Generic.IEnumerable`1<int32>& next) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::pc
        IL_0006:  ldc.i4.1
        IL_0007:  sub
        IL_0008:  switch     ( 
                              IL_0017,
        ...
        IL_0022:  ldarg.0
        IL_0023:  ldc.i4.1
        IL_0024:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::pc
        .line 5,5 : 15,22 
        IL_0029:  ldarg.0
        IL_002a:  ldc.i4.1
        IL_002b:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::current
        IL_0030:  ldc.i4.1
        IL_0031:  ret

        IL_0032:  ldarg.0
        IL_0033:  ldc.i4.2
        IL_0034:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::pc
        IL_0039:  ldarg.0
        IL_003a:  ldc.i4.0
        IL_003b:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::current
        IL_0040:  ldc.i4.0
        IL_0041:  ret
              ...
              Close() cil managed
      {
        ...
        IL_0001:  ldarg.0
        IL_0002:  ldc.i4.2
        IL_0003:  stfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::pc
        IL_0008:  ret
              ...
              get_CheckClose() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::pc
        IL_0007:  switch     ( 
                              IL_001a,
                              IL_001c,
                              IL_001e)
              ...
              get_LastGenerated() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      int32 SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::current
        IL_0007:  ret
              ...
              GetFreshEnumerator() cil managed
      {
        ...
        IL_0001:  ldc.i4.0
        IL_0002:  ldc.i4.0
        IL_0003:  newobj     instance void SeqExpressionSteppingTest1/SeqExpressionSteppingTest1/f0@5::.ctor(int32,
                                                                                                             int32)
        IL_0008:  ret
       ...
       extends [mscorlib]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_000b:  pop
    IL_000c:  ret
  } // end of method $SeqExpressionSteppingTest1::.cctor
