...
{
  // Offset: 0x00000260 Length: 0x000000AD
}
.module SeqExpressionSteppingTest3.dll
// MVID: {4D94A7A4-241E-08D1-A745-0383A4A7944D}
       ...
       extends [mscorlib]System.Object
{
  ...
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 07 00 00 00 00 00 ) 
    .class auto autochar serializable sealed nested assembly beforefieldinit specialname f2@5
           extends class [FSharp.Core]Microsoft.FSharp.Core.CompilerServices.GeneratedSequenceBase`1<class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>>
    {
                                   ...
                                   class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> current) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldarg.1
        IL_0002:  stfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::x
        IL_0007:  ldarg.0
        IL_0008:  ldarg.2
        IL_0009:  stfld      int32 SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::pc
        IL_000e:  ldarg.0
        IL_000f:  ldarg.3
        IL_0010:  stfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::current
        IL_0015:  ldarg.0
              ...
              GenerateNext(class [mscorlib]System.Collections.Generic.IEnumerable`1<class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>>& next) cil managed
      {
        ...
        IL_0000:  ldarg.0
        IL_0001:  ldfld      int32 SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::pc
        IL_0006:  ldc.i4.1
        IL_0007:  sub
        IL_0008:  switch     ( 
                              IL_0017,
        ...
        .line 5,5 : 21,27 
        IL_0022:  ldarg.0
        IL_0023:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::x
        ...
        .line 6,6 : 18,24 
        IL_0030:  ldarg.0
        IL_0031:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::x
        ...
        IL_004c:  ldarg.0
        IL_004d:  ldc.i4.1
        IL_004e:  stfld      int32 SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::pc
        .line 8,8 : 18,25 
        IL_0053:  ldarg.0
        IL_0054:  ldarg.0
        IL_0055:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::x
        IL_005a:  stfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::current
        IL_005f:  ldc.i4.1
        IL_0060:  ret
        ...
        IL_0064:  ldarg.0
        IL_0065:  ldc.i4.2
        IL_0066:  stfld      int32 SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::pc
        IL_006b:  ldarg.0
        IL_006c:  ldnull
        IL_006d:  stfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::current
        IL_0072:  ldc.i4.0
        IL_0073:  ret
      } // end of method f2@5::GenerateNext
              ...
              Close() cil managed
      {
        ...
        IL_0001:  ldarg.0
        IL_0002:  ldc.i4.2
        IL_0003:  stfld      int32 SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::pc
        IL_0008:  ret
      } // end of method f2@5::Close
              ...
              get_CheckClose() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      int32 SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::pc
        IL_0007:  switch     ( 
                              IL_001a,
                              IL_001c,
                              IL_001e)
        ...
        IL_002c:  ldc.i4.0
        IL_002d:  ret
      } // end of method f2@5::get_CheckClose
              ...
              get_LastGenerated() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::current
        IL_0007:  ret
      } // end of method f2@5::get_LastGenerated
              ...
              GetFreshEnumerator() cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldfld      class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32> SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::x
        IL_0007:  ldc.i4.0
        IL_0008:  ldnull
        IL_0009:  newobj     instance void SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>,
                                                                                                             int32,
                                                                                                             class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>)
        IL_000e:  ret
      } // end of method f2@5::GetFreshEnumerator
            ...
            f2() cil managed
    {
      ...
      IL_0009:  ldc.i4.0
      IL_000a:  ldnull
      IL_000b:  newobj     instance void SeqExpressionSteppingTest3/SeqExpressionSteppingTest3/f2@5::.ctor(class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>,
                                                                                                           int32,
                                                                                                           class [FSharp.Core]Microsoft.FSharp.Core.FSharpRef`1<int32>)
      IL_0010:  ret
       ...
       extends [mscorlib]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_000b:  pop
    IL_000c:  ret
  } // end of method $SeqExpressionSteppingTest3::.cctor
