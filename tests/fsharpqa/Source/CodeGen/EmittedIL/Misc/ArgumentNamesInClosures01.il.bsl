...
{
  // Offset: 0x00000000 Length: 0x000003B3
}
.mresource public FSharpOptimizationData.ArgumentNamesInClosures01
{
  // Offset: 0x000003B8 Length: 0x0000010D
}
.module ArgumentNamesInClosures01.dll
// MVID: {4BEB284F-39CA-41B5-A745-03834F28EB4B}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x00510000
       ...
       extends [mscorlib]System.Object
{
         ...
         extends [mscorlib]System.Object
  {
    ...
    .method public instance int32  F(object o) cil managed
    {
      // Code size       10 (0xa)
      .maxstack  3
         ...
         extends [mscorlib]System.Object
  {
    ...
    .method public specialname instance class [FSharp.Core]Microsoft.FSharp.Core.FSharpFunc`2<class M/C,int32> 
            get_F() cil managed
    {
      // Code size       7 (0x7)
      .maxstack  3
  ...
  .method public static int32  I(class M/C i_want_to_see_this_identifier) cil managed
  {
    ...
    IL_0002:  ldnull
    IL_0003:  tail.
    IL_0005:  call       instance int32 M/C::F(object)
    IL_000a:  ret
  } // end of method M::I
