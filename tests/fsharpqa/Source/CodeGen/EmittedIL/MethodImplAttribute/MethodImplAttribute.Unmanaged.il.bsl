...
{
  // Offset: 0x00000360 Length: 0x0000007C
}
.module MethodImplAttribute.Unmanaged.dll
// MVID: {4E66F6DC-FF34-309C-A745-0383DCF6664E}
...
.class private abstract auto ansi sealed '<StartupCode$MethodImplAttribute-Unmanaged>'.$M
       extends [mscorlib]System.Object
{
} // end of class '<StartupCode$MethodImplAttribute-Unmanaged>'.$M
