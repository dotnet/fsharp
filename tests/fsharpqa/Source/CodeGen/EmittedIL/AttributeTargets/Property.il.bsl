...
{
  // Offset: 0x00000000 Length: 0x00000441
}
.mresource public FSharpOptimizationData.Property
{
  // Offset: 0x00000448 Length: 0x000000BB
}
.module Property.dll
// MVID: {4F1D091D-9B5C-7949-A745-03831D091D4F}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x0000009CA3180000
       ...
       extends [mscorlib]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_0012:  ldc.i4.1
    IL_0013:  dup
    IL_0014:  stsfld     int32 '<StartupCode$Property>'.$M::T@12
    IL_0019:  stloc.0
    IL_001a:  ret
