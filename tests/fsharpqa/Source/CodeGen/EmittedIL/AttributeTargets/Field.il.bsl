...
{
  // Offset: 0x00000000 Length: 0x00000438
}
.mresource public FSharpOptimizationData.Field
{
  // Offset: 0x00000440 Length: 0x000000B8
}
.module Field.dll
// MVID: {4F1D091A-96F8-CD6E-A745-03831A091D4F}
.imagebase 0x00400000
.file alignment 0x00000200
.stackreserve 0x00100000
.subsystem 0x0003       // WINDOWS_CUI
.corflags 0x00000001    //  ILONLY
// Image base: 0x00000017868C0000
       ...
       extends [mscorlib]System.Object
{
          ...
          void  .cctor() cil managed
  {
    ...
    IL_0012:  ldc.i4.1
    IL_0013:  dup
    IL_0014:  stsfld     int32 '<StartupCode$Field>'.$M::T@12
    IL_0019:  stloc.0
    IL_001a:  ret
  } // end of method $M::.cctor

} // end of class '<StartupCode$Field>'.$M
