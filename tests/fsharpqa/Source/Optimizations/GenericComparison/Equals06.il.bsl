...
{
  // Offset: 0x00000000 Length: 0x00000874
}
.mresource public FSharpOptimizationData.Equals06
{
  // Offset: 0x00000878 Length: 0x0000067F
}
.module Equals06.dll
// MVID: {5EDEB166-0759-31EC-A745-038366B1DE5E}
         ...
         extends [mscorlib]System.Object
  {
                      ...
                      [mscorlib]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Equals06/EqualsMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        .line 16707566,16707566 : 0,0 'C:\\src\\fsharp\\tests\\fsharpqa\\source\\Optimizations\\GenericComparison\\Equals06.fsx'
        IL_0000:  ldarg.0
        IL_0001:  ldnull
        IL_0002:  cgt.un
              ...
              instance bool  Equals(class Equals06/EqualsMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        IL_001f:  stloc.3
        IL_0020:  call       class [mscorlib]System.Collections.Generic.EqualityComparer`1<!0> class [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives/HashCompare/FSharpEqualityComparer_ER`1<!a>::get_EqualityComparer()
        IL_0025:  ldloc.2
        IL_0026:  ldloc.3
        IL_0027:  callvirt   instance bool class [mscorlib]System.Collections.Generic.EqualityComparer`1<!a>::Equals(!0,
                                                                                                                     !0)
        IL_002c:  brfalse.s  IL_004b

        .line 16707566,16707566 : 0,0 ''
        IL_002e:  ldloc.0
        IL_002f:  ldfld      !0 class Equals06/EqualsMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0034:  stloc.2
        IL_0035:  ldloc.1
        IL_0036:  ldfld      !0 class Equals06/EqualsMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_003b:  stloc.3
        IL_003c:  call       class [mscorlib]System.Collections.Generic.EqualityComparer`1<!0> class [FSharp.Core]Microsoft.FSharp.Core.LanguagePrimitives/HashCompare/FSharpEqualityComparer_ER`1<!a>::get_EqualityComparer()
        IL_0041:  ldloc.2
        IL_0042:  ldloc.3
        IL_0043:  tail.
        IL_0045:  callvirt   instance bool class [mscorlib]System.Collections.Generic.EqualityComparer`1<!a>::Equals(!0,
                                                                                                                     !0)
        IL_004a:  ret
