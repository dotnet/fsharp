...
{
  // Offset: 0x000006F0 Length: 0x000003B1
}
.module Hash05.dll
// MVID: {4BEB2A1C-9642-7857-A745-03831C2AEB4B}
       ...
       extends [mscorlib]System.Object
{
  ...
  {
    .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 07 00 00 00 00 00 ) 
    .class auto autochar serializable nested public sealed beforefieldinit Key
           extends [mscorlib]System.Object
                      ...
                      [mscorlib]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Hash05/HashMicroPerfAndCodeGenerationTests/Key obj) cil managed
      {
        ...
        IL_001f:  stloc.s    V_4
        IL_0021:  ldloc.1
        IL_0022:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_0027:  stloc.s    V_5
        IL_0029:  ldloc.s    V_4
        IL_002b:  ldloc.s    V_5
        ...
        IL_004c:  stloc.3
        IL_004d:  ldloc.0
        IL_004e:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_0053:  stloc.s    V_4
        IL_0055:  ldloc.1
        IL_0056:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_005b:  stloc.s    V_5
        IL_005d:  ldloc.s    V_4
        IL_005f:  ldloc.s    V_5
              ...
              instance int32  CompareTo(object obj) cil managed
      {
        ...
        IL_0001:  ldarg.0
        IL_0002:  ldarg.1
        IL_0003:  unbox.any  Hash05/HashMicroPerfAndCodeGenerationTests/Key
        IL_0008:  call       instance int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::CompareTo(class Hash05/HashMicroPerfAndCodeGenerationTests/Key)
        IL_000d:  ret
      } // end of method Key::CompareTo
                                        ...
                                        class [mscorlib]System.Collections.IComparer comp) cil managed
      {
        ...
        // Code size       125 (0x7d)
        .maxstack  4
        .locals init ([0] class Hash05/HashMicroPerfAndCodeGenerationTests/Key V_0,
                 [1] class Hash05/HashMicroPerfAndCodeGenerationTests/Key V_1,
                 [2] class Hash05/HashMicroPerfAndCodeGenerationTests/Key V_2,
                 [3] int32 V_3,
                 [4] int32 V_4,
                 [5] int32 V_5)
        .line 5,5 : 10,13 
        ...
        IL_000e:  ldarg.1
        IL_000f:  unbox.any  Hash05/HashMicroPerfAndCodeGenerationTests/Key
        IL_0014:  ldnull
        IL_0015:  cgt.un
        ...
        IL_001e:  stloc.2
        IL_001f:  ldloc.1
        IL_0020:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_0025:  stloc.s    V_4
        IL_0027:  ldloc.2
        IL_0028:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_002d:  stloc.s    V_5
        IL_002f:  ldloc.s    V_4
        IL_0031:  ldloc.s    V_5
        ...
        IL_006e:  ldarg.1
        IL_006f:  unbox.any  Hash05/HashMicroPerfAndCodeGenerationTests/Key
        IL_0074:  ldnull
        IL_0075:  cgt.un
              ...
              instance int32  GetHashCode(class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0014:  ldloc.1
        IL_0015:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_001a:  ldloc.0
        IL_001b:  ldc.i4.6
        IL_001c:  shl
        IL_001d:  ldloc.0
        ...
        IL_0029:  ldloc.1
        IL_002a:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_002f:  ldloc.0
        IL_0030:  ldc.i4.6
        IL_0031:  shl
        IL_0032:  ldloc.0
              ...
              instance int32  GetHashCode() cil managed
      {
        ...
        IL_0007:  call       instance int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
        IL_000c:  ret
      } // end of method Key::GetHashCode
                                    ...
                                    class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0007:  ldarg.1
        IL_0008:  isinst     Hash05/HashMicroPerfAndCodeGenerationTests/Key
        IL_000d:  stloc.0
        IL_000e:  ldloc.0
        ...
        IL_0016:  stloc.2
        IL_0017:  ldloc.1
        IL_0018:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_001d:  ldloc.2
        IL_001e:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_0023:  bne.un.s   IL_0034

        IL_0025:  ldloc.1
        IL_0026:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_002b:  ldloc.2
        IL_002c:  ldfld      int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_0031:  ceq
        IL_0033:  ret
              ...
              instance bool  Equals(object obj) cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.1
        IL_0002:  isinst     Hash05/HashMicroPerfAndCodeGenerationTests/Key
        IL_0007:  stloc.0
        IL_0008:  ldloc.0
        ...
        IL_000b:  ldarg.0
        IL_000c:  ldloc.0
        IL_000d:  call       instance bool Hash05/HashMicroPerfAndCodeGenerationTests/Key::Equals(class Hash05/HashMicroPerfAndCodeGenerationTests/Key)
        IL_0012:  ret
    ...
    .method public static void  f5() cil managed
    {
      ...
      IL_0011:  call       instance int32 Hash05/HashMicroPerfAndCodeGenerationTests/Key::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
      IL_0016:  stloc.1
      IL_0017:  ldloc.0
      IL_0018:  ldc.i4.1
      IL_0019:  add
