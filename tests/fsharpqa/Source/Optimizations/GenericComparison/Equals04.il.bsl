...
{
  // Offset: 0x000006E0 Length: 0x000003B7
}
.module Equals04.dll
// MVID: {60BE1F16-0759-EA8A-A745-0383161FBE60}
         ...
         extends [mscorlib]System.Object
  {
                      ...
                      [mscorlib]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Equals04/EqualsMicroPerfAndCodeGenerationTests/Key obj) cil managed
      {
        ...
        IL_004b:  stloc.3
        IL_004c:  ldloc.0
        IL_004d:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item2
        IL_0052:  stloc.s    V_4
        IL_0054:  ldloc.1
        IL_0055:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item2
        IL_005a:  stloc.s    V_5
        IL_005c:  ldloc.s    V_4
        IL_005e:  ldloc.s    V_5
                                        ...
                                        class [mscorlib]System.Collections.IComparer comp) cil managed
      {
        ...
        .line 16707566,16707566 : 0,0 ''
        IL_000d:  ldarg.1
        IL_000e:  unbox.any  Equals04/EqualsMicroPerfAndCodeGenerationTests/Key
        IL_0013:  ldnull
        IL_0014:  cgt.un
        ...
        IL_001d:  stloc.2
        IL_001e:  ldloc.1
        IL_001f:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item1
        IL_0024:  stloc.s    V_4
        IL_0026:  ldloc.2
        IL_0027:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item1
        IL_002c:  stloc.s    V_5
        IL_002e:  ldloc.s    V_4
        IL_0030:  ldloc.s    V_5
        ...
        .line 16707566,16707566 : 0,0 ''
        IL_006d:  ldarg.1
        IL_006e:  unbox.any  Equals04/EqualsMicroPerfAndCodeGenerationTests/Key
        IL_0073:  ldnull
        IL_0074:  cgt.un
              ...
              instance int32  GetHashCode(class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0013:  ldloc.1
        IL_0014:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item2
        IL_0019:  ldloc.0
        IL_001a:  ldc.i4.6
        IL_001b:  shl
        IL_001c:  ldloc.0
        ...
        IL_0028:  ldloc.1
        IL_0029:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item1
        IL_002e:  ldloc.0
        IL_002f:  ldc.i4.6
        IL_0030:  shl
        IL_0031:  ldloc.0
                                    ...
                                    class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        .line 16707566,16707566 : 0,0 ''
        IL_0006:  ldarg.1
        IL_0007:  isinst     Equals04/EqualsMicroPerfAndCodeGenerationTests/Key
        IL_000c:  stloc.0
        IL_000d:  ldloc.0
        ...
        IL_0015:  stloc.2
        IL_0016:  ldloc.1
        IL_0017:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item1
        IL_001c:  ldloc.2
        IL_001d:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item1
        IL_0022:  bne.un.s   IL_0033

        .line 16707566,16707566 : 0,0 ''
        IL_0024:  ldloc.1
        IL_0025:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item2
        IL_002a:  ldloc.2
        IL_002b:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item2
        IL_0030:  ceq
        IL_0032:  ret
              ...
              instance bool  Equals(class Equals04/EqualsMicroPerfAndCodeGenerationTests/Key obj) cil managed
      {
        ...
        IL_0026:  ldloc.1
        IL_0027:  ldfld      int32 Equals04/EqualsMicroPerfAndCodeGenerationTests/Key::item2
        IL_002c:  ceq
        IL_002e:  ret
