...
.module Hash06.dll
// MVID: {5772F676-9642-78F2-A745-038376F67257}
         ...
         extends [mscorlib]System.Object
  {
                      ...
                      [mscorlib]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Hash06/HashMicroPerfAndCodeGenerationTests/Key obj) cil managed
      {
        ...
        IL_001f:  stloc.s    V_4
        IL_0021:  ldloc.1
        IL_0022:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_0027:  stloc.s    V_5
        IL_0029:  ldloc.s    V_4
        IL_002b:  ldloc.s    V_5
        ...
        IL_004c:  stloc.3
        IL_004d:  ldloc.0
        IL_004e:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_0053:  stloc.s    V_4
        IL_0055:  ldloc.1
        IL_0056:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_005b:  stloc.s    V_5
        IL_005d:  ldloc.s    V_4
        IL_005f:  ldloc.s    V_5
              ...
              instance int32  CompareTo(object obj) cil managed
      {
        ...
        .line 4,4 : 10,13 'C:\\GitHub\\dsyme\\visualfsharp\\tests\\fsharpqa\\Source\\Optimizations\\GenericComparison\\Hash06.fsx'
        IL_0000:  nop
        IL_0001:  ldarg.0
        IL_0002:  ldarg.1
        IL_0003:  unbox.any  Hash06/HashMicroPerfAndCodeGenerationTests/Key
        IL_0008:  callvirt   instance int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::CompareTo(class Hash06/HashMicroPerfAndCodeGenerationTests/Key)
        IL_000d:  ret
      } // end of method Key::CompareTo
                                        ...
                                        class [mscorlib]System.Collections.IComparer comp) cil managed
      {
        ...
        IL_000e:  ldarg.1
        IL_000f:  unbox.any  Hash06/HashMicroPerfAndCodeGenerationTests/Key
        IL_0014:  ldnull
        IL_0015:  cgt.un
        ...
        IL_001e:  stloc.2
        IL_001f:  ldloc.1
        IL_0020:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_0025:  stloc.s    V_4
        IL_0027:  ldloc.2
        IL_0028:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_002d:  stloc.s    V_5
        IL_002f:  ldloc.s    V_4
        IL_0031:  ldloc.s    V_5
        ...
        IL_006e:  ldarg.1
        IL_006f:  unbox.any  Hash06/HashMicroPerfAndCodeGenerationTests/Key
        IL_0074:  ldnull
        IL_0075:  cgt.un
              ...
              instance int32  GetHashCode(class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0014:  ldloc.1
        IL_0015:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_001a:  ldloc.0
        IL_001b:  ldc.i4.6
        IL_001c:  shl
        IL_001d:  ldloc.0
        ...
        IL_0029:  ldloc.1
        IL_002a:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_002f:  ldloc.0
        IL_0030:  ldc.i4.6
        IL_0031:  shl
        IL_0032:  ldloc.0
              ...
              instance int32  GetHashCode() cil managed
      {
        ...
        IL_0007:  callvirt   instance int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
        IL_000c:  ret
      } // end of method Key::GetHashCode
                                    ...
                                    class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0007:  ldarg.1
        IL_0008:  isinst     Hash06/HashMicroPerfAndCodeGenerationTests/Key
        IL_000d:  stloc.0
        IL_000e:  ldloc.0
        ...
        IL_0016:  stloc.2
        IL_0017:  ldloc.1
        IL_0018:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_001d:  ldloc.2
        IL_001e:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item1
        IL_0023:  bne.un.s   IL_0034

        IL_0025:  ldloc.1
        IL_0026:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_002b:  ldloc.2
        IL_002c:  ldfld      int32 Hash06/HashMicroPerfAndCodeGenerationTests/Key::item2
        IL_0031:  ceq
        IL_0033:  ret
              ...
              instance bool  Equals(object obj) cil managed
      {
        ...
        IL_0000:  nop
        IL_0001:  ldarg.1
        IL_0002:  isinst     Hash06/HashMicroPerfAndCodeGenerationTests/Key
        IL_0007:  stloc.0
        IL_0008:  ldloc.0
        ...
        IL_000b:  ldarg.0
        IL_000c:  ldloc.0
        IL_000d:  callvirt   instance bool Hash06/HashMicroPerfAndCodeGenerationTests/Key::Equals(class Hash06/HashMicroPerfAndCodeGenerationTests/Key)
        IL_0012:  ret
