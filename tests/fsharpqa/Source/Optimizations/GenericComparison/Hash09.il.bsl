...
{
  // Offset: 0x00000000 Length: 0x00000892
}
.mresource public FSharpOptimizationData.Hash09
{
  // Offset: 0x00000898 Length: 0x0000068E
}
.module Hash09.dll
// MVID: {5B1B6346-9642-77DB-A745-038346631B5B}
         ...
         extends [mscorlib]System.Object
  {
                      ...
                      [mscorlib]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        .line 16707566,16707566 : 0,0 'C:\\src\\manofstick\\visualfsharp-nobox\\tests\\fsharpqa\\Source\\Optimizations\\GenericComparison\\Hash09.fsx'
        IL_0000:  ldarg.0
        IL_0001:  ldnull
        IL_0002:  cgt.un
              ...
              instance int32  GetHashCode(class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0013:  ldloc.1
        IL_0014:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0019:  stloc.2
        IL_001a:  ldarg.1
        IL_001b:  ldloc.2
        ...
        IL_0030:  ldloc.1
        IL_0031:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0036:  stloc.2
        IL_0037:  ldarg.1
        IL_0038:  ldloc.2
              ...
              instance bool  Equals(class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        .line 16707566,16707566 : 0,0 ''
        IL_0029:  ldloc.0
        IL_002a:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_002f:  stloc.2
        IL_0030:  ldloc.1
        IL_0031:  ldfld      !0 class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0036:  stloc.3
              ...
              instance bool  Equals(object obj) cil managed
      {
        ...
        IL_000a:  ldarg.0
        IL_000b:  ldloc.0
        IL_000c:  callvirt   instance bool class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::Equals(class Hash09/HashMicroPerfAndCodeGenerationTests/GenericKey`1<!0>)
        IL_0011:  ret
