...
// MVID: {56DBF219-05DE-F88E-A745-038319F2DB56}
                      ...
                      [mscorlib]System.Collections.IStructuralComparable
    {
              ...
              instance int32  CompareTo(class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a> obj) cil managed
      {
        ...
        .locals init (class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a> V_0,
                 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a> V_1,
                 int32 V_2,
        ...
        IL_0018:  stloc.3
        IL_0019:  ldloc.0
        IL_001a:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_001f:  stloc.s    V_4
        IL_0021:  ldloc.1
        IL_0022:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0027:  stloc.s    V_5
        IL_0029:  ldloc.3
        IL_002a:  ldloc.s    V_4
        IL_002c:  ldloc.s    V_5
        ...
        IL_0045:  stloc.3
        IL_0046:  ldloc.0
        IL_0047:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_004c:  stloc.s    V_4
        IL_004e:  ldloc.1
        IL_004f:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0054:  stloc.s    V_5
        IL_0056:  ldloc.3
        IL_0057:  ldloc.s    V_4
        IL_0059:  ldloc.s    V_5
                                        ...
                                        class [mscorlib]System.Collections.IComparer comp) cil managed
      {
        ...
        IL_000e:  ldarg.1
        IL_000f:  unbox.any  class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>
        IL_0014:  ldnull
        IL_0015:  cgt.un
        ...
        IL_001e:  stloc.2
        IL_001f:  ldloc.1
        IL_0020:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0025:  stloc.s    V_4
        IL_0027:  ldloc.2
        IL_0028:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_002d:  stloc.s    V_5
        IL_002f:  ldarg.2
        IL_0030:  ldloc.s    V_4
        IL_0032:  ldloc.s    V_5
        ...
        IL_0065:  ldarg.1
        IL_0066:  unbox.any  class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>
        IL_006b:  ldnull
        IL_006c:  cgt.un
              ...
              instance int32  GetHashCode(class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        IL_0014:  ldloc.1
        IL_0015:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_001a:  stloc.2
        IL_001b:  ldarg.1
        IL_001c:  ldloc.2
        ...
        IL_0031:  ldloc.1
        IL_0032:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0037:  stloc.2
        IL_0038:  ldarg.1
        IL_0039:  ldloc.2
              ...
              instance int32  GetHashCode() cil managed
      {
        ...
        IL_0007:  callvirt   instance int32 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::GetHashCode(class [mscorlib]System.Collections.IEqualityComparer)
        IL_000c:  ret
      } // end of method GenericKey`1::GetHashCode
                                    ...
                                    class [mscorlib]System.Collections.IEqualityComparer comp) cil managed
      {
        ...
        .locals init (class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a> V_0,
                 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a> V_1,
                 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a> V_2,
                 !a V_3,
                 !a V_4)
        IL_0000:  nop
        IL_0001:  ldarg.0
        ...
        IL_0007:  ldarg.1
        IL_0008:  isinst     class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>
        IL_000d:  stloc.0
        IL_000e:  ldloc.0
        ...
        IL_0016:  stloc.2
        IL_0017:  ldloc.1
        IL_0018:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_001d:  stloc.3
        IL_001e:  ldloc.2
        IL_001f:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item1
        IL_0024:  stloc.s    V_4
        IL_0026:  ldarg.2
        IL_0027:  ldloc.3
        IL_0028:  ldloc.s    V_4
        ...
        IL_0031:  ldloc.1
        IL_0032:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_0037:  stloc.3
        IL_0038:  ldloc.2
        IL_0039:  ldfld      !0 class Compare07/CompareMicroPerfAndCodeGenerationTests/GenericKey`1<!a>::item2
        IL_003e:  stloc.s    V_4
        IL_0040:  ldarg.2
        IL_0041:  ldloc.3
        IL_0042:  ldloc.s    V_4
