...
//<Expects status="error" span="(21,6-21,8)" id="FS0054">Classes cannot contain abstract members\. If this is intentional then provide a default member implementation or add the '\[<AbstractClass>\]' attribute to your type\.$</Expects>
