...
//<Expects status="error" span="(21,6-21,8)" id="FS0365">No implementation was given for those members:'CSLib5\.B0\.M\(c: char, a: int\) : int'$</Expects>
//<Expects status="error" span="(21,6-21,8)" id="FS0365">'CSLib5\.B0\.M\(c: char, a: int\) : int'</Expects>
//<Expects status="error" span="(21,6-21,8)" id="FS0365">'CSLib5\.B0\.N\(c: char, a: int\) : int'</Expects>
