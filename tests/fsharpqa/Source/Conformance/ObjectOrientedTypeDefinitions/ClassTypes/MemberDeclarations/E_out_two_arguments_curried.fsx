...
//<Expects status="error" span="(7,19-7,20)" id="FS0440">Methods with curried arguments cannot declare 'out', 'ParamArray', 'optional', 'ReflectedDefinition', 'byref', 'CallerLineNumber', or 'CallerFilePath' arguments</Expects>
type Misc2() =
