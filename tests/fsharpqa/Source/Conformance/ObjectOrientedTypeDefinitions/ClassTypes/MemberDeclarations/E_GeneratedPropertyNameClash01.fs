...
//<Expects status="error" id="FS0023" span="(6,19-6,24)">The member 'Item1' can not be defined because the name 'Item1' clashes with the generated property 'Item1' in this type or module</Expects>
