...
//<Expects id="FS0054" status="error" span="(12,6)">Classes cannot contain abstract members\. If this is intentional then provide a default member implementation or add the '\[<AbstractClass>\]' attribute to your type</Expects>
