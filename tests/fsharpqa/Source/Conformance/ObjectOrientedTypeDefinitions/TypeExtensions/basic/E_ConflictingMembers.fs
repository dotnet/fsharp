...
//<Expects id="FS0438" span="(12,27-12,34)" status="error">Duplicate method\. The method 'get_DoStuff' has the same name and signature as another method in this type</Expects>
