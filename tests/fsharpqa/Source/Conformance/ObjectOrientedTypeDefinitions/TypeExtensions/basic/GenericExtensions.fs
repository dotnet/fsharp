...
module UseCSharpExtensionsMethodsWithVariableThisTy = 
    ...
    let x6 : int = tup3.Item1()
    let x7 : int = tup4.Item1()
    let x8 : int = tup5.Item1()
    let x9 : int = tup6.Item1()
    let x10 : int = tup7.Item1()
    let x11 : int = tup8.Item1()
    let x12 : int = tup9.Item1()
...
module UseFSharpDefinedILExtensionsMethods = 
    ...
    type CSharpStyleExtensionMethodsInFSharp () = 
        ...
        [<Extension>] static member Item1((a,b,c,d,e,f,g,h,i)) = a
