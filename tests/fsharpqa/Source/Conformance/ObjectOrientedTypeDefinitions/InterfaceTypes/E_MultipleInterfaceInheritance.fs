...
//<Expects id="FS0366" status="error" span="(60,6-62,8)">No implementation was given for those members:</Expects>
//<Expects id="FS0366" status="error" span="(60,6-62,8)">'abstract member I_002\.Me : 'a -> int'\.</Expects>
//<Expects id="FS0366" status="error" span="(60,6-62,8)">'abstract member I_002\.Me : 'a -> int'\.</Expects>
//<Expects id="FS0366" status="error" span="(60,6-62,8)">Note that all interface members must be implemented and listed under an appropriate 'interface' declaration, e\.g\. 'interface \.\.\. with member \.\.\.'\.</Expects>
