...
//<Expects status="error" id="FS0443" span="(12,6-12,8)">This type implements the same interface at different generic instantiations 'IA<int>' and 'IA<'b>'. This is not permitted in this version of F#.</Expects>
