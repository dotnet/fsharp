...
// interface twice
//<Expects status="error" span="(11,6-11,9)" id="FS0443">This type implements the same interface at different generic instantiations 'IFoo<int64>' and 'IFoo<string>'. This is not permitted in this version of F#.</Expects>
