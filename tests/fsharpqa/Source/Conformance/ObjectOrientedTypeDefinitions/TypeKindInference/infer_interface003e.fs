...
//<Expects status="error" span="(15,6)" id="FS0365">No implementation was given for 'abstract member TK_I_005\.M : unit -> unit'$</Expects>
...
//<Expects status="error" span="(19,6)" id="FS0365">No implementation was given for 'abstract member TK_C_000\.M : int -> int'$</Expects>
