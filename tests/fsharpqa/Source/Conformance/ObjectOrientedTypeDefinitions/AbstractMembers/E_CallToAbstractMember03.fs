...
//<Expects status="error" span="(11,5-11,6)" id="FS0054">Non-abstract classes cannot contain abstract members\. If this is intentional then provide a default member implementation or add the '\[<AbstractClass>\]' attribute to your type\.$</Expects>
[<AbstractClass>]
type B() = 
