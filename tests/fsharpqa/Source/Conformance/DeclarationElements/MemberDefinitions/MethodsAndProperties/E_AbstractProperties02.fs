...
//<Expects id="FS0435" span="(7,13-7,14)" status="error">The property 'A' has a getter and a setter that do not match\. If one is abstract then the other must be as well</Expects>
type T =
   abstract A : int
