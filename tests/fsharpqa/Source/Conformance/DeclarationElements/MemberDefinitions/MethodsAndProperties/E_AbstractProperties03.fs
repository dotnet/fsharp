...
//<Expects id="FS0435" span="(8,25-8,28)" status="error">The property 'State' has a getter and a setter that do not match\. If one is abstract then the other must be as well</Expects>
