...
//<Expects id="FS0435" span="(8,14-8,19)" status="error">The property 'State' has a getter and a setter that do not match\. If one is abstract then the other must be as well</Expects>
