...
//<Expects span="(7,17-7,20)" id="FS0438" status="error">Duplicate method\. The method 'Foo' has the same name and signature as another method in this type once tuples, functions, units of measure and/or provided types are erased\.</Expects>
