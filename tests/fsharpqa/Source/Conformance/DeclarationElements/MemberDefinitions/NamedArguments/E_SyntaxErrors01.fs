...
//<Expects id="FS0003" span="(12,1-12,8)" status="error">This value is of type 'int * int', which is not a function type. A value is being passed to it as an argument as if it were a function</Expects>
