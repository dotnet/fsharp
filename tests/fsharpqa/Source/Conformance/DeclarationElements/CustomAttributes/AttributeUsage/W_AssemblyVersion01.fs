...
//<Expects id="FS2003" status="warning" span="(4,46-4,59)">An AssemblyVersionAttribute specified version '1\.2\.3\.4\.5\.6', but this value is invalid and has been ignored</Expects>
