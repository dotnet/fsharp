...
//<Expects id="FS2003" status="warning" span="(4,46-4,55)">An AssemblyVersionAttribute specified version '1\.2\.\*\.4', but this value is invalid and has been ignored</Expects>
