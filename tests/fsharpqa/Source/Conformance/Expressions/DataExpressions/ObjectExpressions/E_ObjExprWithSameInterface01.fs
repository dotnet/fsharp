...
//<Expects status="error" span="(13,5-16,31)" id="FS3302">You cannot implement the interface 'IQueue<_>' with the two instantiations 'IQueue<'T>' and 'IQueue<obj>' because they may unify.</Expects>
