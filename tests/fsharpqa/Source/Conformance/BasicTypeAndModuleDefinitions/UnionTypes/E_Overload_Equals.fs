...
//<Expects status="error" span="(7,23-7,29)" id="FS0438">Duplicate method\. The method 'Equals' has the same name and signature as another method in this type\.$</Expects>
type DU = | A
