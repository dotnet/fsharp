...
//<Expects status="error" span="(8,25-8,36)" id="FS0438">Duplicate method\. The method 'GetHashCode' has the same name and signature as another method in this type\.$</Expects>
