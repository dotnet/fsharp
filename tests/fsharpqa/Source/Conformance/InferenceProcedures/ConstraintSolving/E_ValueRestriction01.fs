...
//<Expects>- Define it as a simple data term like a string literal or a union case</Expects>
//<Expects>- Add an explicit type annotation</Expects>
//<Expects>- Use the value as a non-generic type in later code for type inference,</Expects>
//<Expects>or if you still want type-dependent results, you can define 'x' as a function instead by doing either:</Expects>
//<Expects>- Add a unit parameter</Expects>
