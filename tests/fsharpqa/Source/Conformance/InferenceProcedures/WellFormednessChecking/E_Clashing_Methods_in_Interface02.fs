...
//<Expects status="error" span="(7,14-7,21)" id="FS0438">Duplicate method\. The method 'DoStuff' has the same name and signature as another method in this type\.$</Expects>
