...
//<Expects id="FS0086" span="(8,6-8,7)" status="warning">The '=' operator should not normally be redefined\. To define equality semantics for a type, override the 'Object.Equals' member in the definition of that type\.</Expects>
//<Expects id="FS0086" span="(9,8-9,9)" status="warning">The '=' operator should not normally be redefined\. To define equality semantics for a type, override the 'Object.Equals' member in the definition of that type\.</Expects>
