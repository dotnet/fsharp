...
//<Expects id="FS0433" status="error" span="(9,5-9,9)">A function labeled with the 'EntryPointAttribute' attribute must be the last declaration in the last file in the compilation sequence.</Expects>
module TestModule
