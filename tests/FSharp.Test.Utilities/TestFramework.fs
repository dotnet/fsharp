...
let config configurationName envVars =
    ...
    let fsc_flags = "-r:System.Core.dll --nowarn:20 --langversion:preview --define:COMPILED"
    let fsi_flags = "-r:System.Core.dll --nowarn:20 --langversion:preview --define:INTERACTIVE --maxerrors:1 --abortonerror"
